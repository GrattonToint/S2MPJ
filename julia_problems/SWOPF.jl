function SWOPF(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling SWOPF.")
    end
    ...
    if action == "setup"
        ...
        push!(irA,ig)
        push!(icA,ix_["VE0001"])
        push!(valA,Float64(-5.299))
        push!(irA,ig)
        push!(icA,ix_["VF0001"])
        push!(valA,Float64(-66.243))
        push!(irA,ig)
        push!(icA,ix_["VE0002"])
        push!(valA,Float64(5.299))
        push!(irA,ig)
        ...
        push!(irA,ig)
        push!(icA,ix_["VE0002"])
        push!(valA,Float64(-1.175))
        push!(irA,ig)
        push!(icA,ix_["VF0002"])
        push!(valA,Float64(-6.915))
        push!(irA,ig)
        push!(icA,ix_["VE0006"])
        push!(valA,Float64(1.175))
        push!(irA,ig)
        push!(icA,ix_["VF0006"])
        push!(valA,Float64(7.051))
        ig,ig_,_ = s2mpj_ii("GFI0002",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"GFI0002")
        push!(irA,ig)
        ...
        push!(irA,ig)
        push!(icA,ix_["VE0002"])
        push!(valA,Float64(-1.726))
        push!(irA,ig)
        push!(icA,ix_["VF0002"])
        push!(valA,Float64(-10.498))
        push!(irA,ig)
        push!(icA,ix_["VE0004"])
        push!(valA,Float64(1.726))
        push!(irA,ig)
        push!(icA,ix_["VF0004"])
        push!(valA,Float64(10.588))
        ig,ig_,_ = s2mpj_ii("GFI0003",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"GFI0003")
        push!(irA,ig)
        ...
        push!(irA,ig)
        push!(icA,ix_["VE0003"])
        push!(valA,Float64(-6.897))
        push!(irA,ig)
        push!(icA,ix_["VF0003"])
        push!(valA,Float64(-82.759))
        push!(irA,ig)
        push!(icA,ix_["VE0004"])
        push!(valA,Float64(6.897))
        push!(irA,ig)
        ...
        push!(irA,ig)
        push!(icA,ix_["VE0005"])
        push!(valA,Float64(-3.448))
        push!(irA,ig)
        push!(icA,ix_["VF0005"])
        push!(valA,Float64(-41.379))
        push!(irA,ig)
        push!(icA,ix_["VE0006"])
        push!(valA,Float64(3.448))
        push!(irA,ig)
