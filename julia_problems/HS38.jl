function HS38(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS38.")
    end
    ...
    if action == "setup"
        ...
        arrset(gtype,ig,"<>")
        arrset(pbm.gscale,ig,Float64(v_["1/P1"]))
        ...
        push!(icA,ix_["X4"])
        push!(valA,Float64(1.0))
        arrset(pbm.gscale,ig,Float64(v_["1/P2"]))
