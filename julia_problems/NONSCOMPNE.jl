function NONSCOMPNE(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling NONSCOMPNE.")
    end
...
# IE N                   10000          $-PARAMETER
        ...
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"SQ"*string(Int64(v_["1"])))
        push!(irA,ig)
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            if haskey(ix_,"X"*string(I))
                ...
                pb.y0[findfirst(x->x==ig_["X"*string(I)],pbm.congrps)] = Float64(3.0)
            end
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
