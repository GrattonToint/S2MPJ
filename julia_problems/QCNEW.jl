...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        gtype    = String[]
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["1"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["F1"]
        pbm.A[ig,iv] += Float64(-1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["2"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["F1"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["3"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["F2"]
        pbm.A[ig,iv] += Float64(-1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["4"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["F2"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["5"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBUBG"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["6"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PUBGB"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["7"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["F1"]
        pbm.A[ig,iv] += Float64(1.0)
        iv = ix_["F2"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["8"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PGBGB"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["9"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBGBG"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["10"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBBBB"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["11"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PGBGB"]
        pbm.A[ig,iv] += Float64(-1.0)
        iv = ix_["PUBGB"]
        pbm.A[ig,iv] += Float64(-1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["12"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBGBG"]
        pbm.A[ig,iv] += Float64(-1.0)
        iv = ix_["PBUBG"]
        pbm.A[ig,iv] += Float64(-1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["13"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBBBB"]
        pbm.A[ig,iv] += Float64(-1.0)
        iv = ix_["PUBBB"]
        ...
        iv = ix_["PBUBB"]
        pbm.A[ig,iv] += Float64(-1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["14"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBUBG"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["15"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PBUBB"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["16"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PUBGB"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("OBJ"*string(Int64(v_["17"])),ig_)
        arrset(gtype,ig,"<>")
        iv = ix_["PUBBB"]
        pbm.A[ig,iv] += Float64(1.0)
        ...
        ie,ie_,_  = s2x_ii(ename,ie_)
        vname = "F1"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,1.0,0.0)
