...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        ig,ig_,_ = s2x_ii("c25",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c25")
        ig,ig_,_ = s2x_ii("c26",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c26")
        ig,ig_,_ = s2x_ii("c27",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c27")
        ig,ig_,_ = s2x_ii("c28",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c28")
        ig,ig_,_ = s2x_ii("c29",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c29")
        ig,ig_,_ = s2x_ii("c30",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c30")
        ig,ig_,_ = s2x_ii("c31",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c31")
        ig,ig_,_ = s2x_ii("c32",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c32")
        ig,ig_,_ = s2x_ii("c33",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c33")
        ig,ig_,_ = s2x_ii("c34",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c34")
        ig,ig_,_ = s2x_ii("c35",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c35")
        ig,ig_,_ = s2x_ii("c36",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c36")
        ig,ig_,_ = s2x_ii("c37",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c37")
        ig,ig_,_ = s2x_ii("c38",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c38")
        ig,ig_,_ = s2x_ii("c39",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c39")
        ig,ig_,_ = s2x_ii("c40",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c40")
        ig,ig_,_ = s2x_ii("c41",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c41")
        ig,ig_,_ = s2x_ii("c42",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c42")
        ig,ig_,_ = s2x_ii("c43",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c43")
        ig,ig_,_ = s2x_ii("c44",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c44")
        ig,ig_,_ = s2x_ii("c45",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c45")
        ig,ig_,_ = s2x_ii("c46",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c46")
        ig,ig_,_ = s2x_ii("c47",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c47")
        ig,ig_,_ = s2x_ii("c48",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c48")
        ig,ig_,_ = s2x_ii("c49",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c49")
        ig,ig_,_ = s2x_ii("c50",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c50")
        ig,ig_,_ = s2x_ii("c51",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c51")
        ig,ig_,_ = s2x_ii("c52",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c52")
        ig,ig_,_ = s2x_ii("c53",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c53")
        ig,ig_,_ = s2x_ii("c54",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c54")
        ig,ig_,_ = s2x_ii("c55",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c55")
        ig,ig_,_ = s2x_ii("c56",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c56")
        ig,ig_,_ = s2x_ii("c57",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c57")
        ig,ig_,_ = s2x_ii("c58",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c58")
        ig,ig_,_ = s2x_ii("c59",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c59")
        ig,ig_,_ = s2x_ii("c60",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c60")
        ig,ig_,_ = s2x_ii("c61",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c61")
        ig,ig_,_ = s2x_ii("c62",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c62")
        ig,ig_,_ = s2x_ii("c63",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c63")
        ig,ig_,_ = s2x_ii("c64",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c64")
        ig,ig_,_ = s2x_ii("c65",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c65")
        ig,ig_,_ = s2x_ii("c66",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c66")
        ig,ig_,_ = s2x_ii("c67",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c67")
        ig,ig_,_ = s2x_ii("c68",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c68")
        ig,ig_,_ = s2x_ii("c69",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c69")
        ig,ig_,_ = s2x_ii("c70",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c70")
        ig,ig_,_ = s2x_ii("c71",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c71")
        ig,ig_,_ = s2x_ii("c72",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c72")
        ig,ig_,_ = s2x_ii("c73",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c73")
        ig,ig_,_ = s2x_ii("c74",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c74")
        ig,ig_,_ = s2x_ii("c75",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c75")
        ig,ig_,_ = s2x_ii("c76",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c76")
        ig,ig_,_ = s2x_ii("c77",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c77")
        ig,ig_,_ = s2x_ii("c78",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c78")
        ig,ig_,_ = s2x_ii("c79",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c79")
        ig,ig_,_ = s2x_ii("c80",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c80")
        ig,ig_,_ = s2x_ii("c81",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c81")
        ig,ig_,_ = s2x_ii("c82",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c82")
        ig,ig_,_ = s2x_ii("c83",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c83")
        ig,ig_,_ = s2x_ii("c84",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c84")
        ig,ig_,_ = s2x_ii("c85",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c85")
        ig,ig_,_ = s2x_ii("c86",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c86")
        ig,ig_,_ = s2x_ii("c87",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c87")
        ig,ig_,_ = s2x_ii("c88",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c88")
        ig,ig_,_ = s2x_ii("c89",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c89")
        ig,ig_,_ = s2x_ii("c90",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c90")
        ig,ig_,_ = s2x_ii("c91",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c91")
        ig,ig_,_ = s2x_ii("c92",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c92")
        ig,ig_,_ = s2x_ii("c93",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c93")
        ig,ig_,_ = s2x_ii("c94",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c94")
        ig,ig_,_ = s2x_ii("c95",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c95")
        ig,ig_,_ = s2x_ii("c96",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c96")
        ig,ig_,_ = s2x_ii("c97",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c97")
        ig,ig_,_ = s2x_ii("c98",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c98")
        ig,ig_,_ = s2x_ii("c99",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c99")
        ig,ig_,_ = s2x_ii("c100",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c100")
        ig,ig_,_ = s2x_ii("c101",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c101")
        ig,ig_,_ = s2x_ii("c102",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c102")
        ig,ig_,_ = s2x_ii("c103",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c103")
        ig,ig_,_ = s2x_ii("c104",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c104")
        ig,ig_,_ = s2x_ii("c105",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c105")
        ig,ig_,_ = s2x_ii("c106",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c106")
        ig,ig_,_ = s2x_ii("c107",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c107")
        ig,ig_,_ = s2x_ii("c108",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c108")
        ig,ig_,_ = s2x_ii("c109",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c109")
        ig,ig_,_ = s2x_ii("c110",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c110")
        ig,ig_,_ = s2x_ii("c111",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c111")
        ig,ig_,_ = s2x_ii("c112",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c112")
        ig,ig_,_ = s2x_ii("c113",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c113")
        ig,ig_,_ = s2x_ii("c114",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c114")
        ig,ig_,_ = s2x_ii("c115",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c115")
        ig,ig_,_ = s2x_ii("c116",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c116")
        ig,ig_,_ = s2x_ii("c117",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c117")
        ig,ig_,_ = s2x_ii("c118",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c118")
        ig,ig_,_ = s2x_ii("c119",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c119")
        ig,ig_,_ = s2x_ii("c120",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c120")
        ig,ig_,_ = s2x_ii("c121",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c121")
        ig,ig_,_ = s2x_ii("c122",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c122")
        ig,ig_,_ = s2x_ii("c123",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c123")
        ig,ig_,_ = s2x_ii("c124",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c124")
        ig,ig_,_ = s2x_ii("c125",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c125")
        ig,ig_,_ = s2x_ii("c126",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c126")
        ig,ig_,_ = s2x_ii("c127",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c127")
        ig,ig_,_ = s2x_ii("c128",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c128")
        ig,ig_,_ = s2x_ii("c129",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c129")
        ig,ig_,_ = s2x_ii("c130",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c130")
        ig,ig_,_ = s2x_ii("c131",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c131")
        ig,ig_,_ = s2x_ii("c132",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c132")
        ig,ig_,_ = s2x_ii("c133",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c133")
        ig,ig_,_ = s2x_ii("c134",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c134")
        ig,ig_,_ = s2x_ii("c135",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c135")
        ig,ig_,_ = s2x_ii("c136",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c136")
        ig,ig_,_ = s2x_ii("c137",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c137")
        ig,ig_,_ = s2x_ii("c138",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c138")
        ig,ig_,_ = s2x_ii("c139",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c139")
        ig,ig_,_ = s2x_ii("c140",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c140")
        ig,ig_,_ = s2x_ii("c141",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c141")
        ig,ig_,_ = s2x_ii("c142",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c142")
        ig,ig_,_ = s2x_ii("c143",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c143")
        ig,ig_,_ = s2x_ii("c144",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c144")
        ig,ig_,_ = s2x_ii("c145",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c145")
        ig,ig_,_ = s2x_ii("c146",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c146")
        ig,ig_,_ = s2x_ii("c147",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c147")
        ig,ig_,_ = s2x_ii("c148",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c148")
        ig,ig_,_ = s2x_ii("c149",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c149")
        ig,ig_,_ = s2x_ii("c150",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c150")
        ig,ig_,_ = s2x_ii("c151",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c151")
        ig,ig_,_ = s2x_ii("c152",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c152")
        ig,ig_,_ = s2x_ii("c153",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c153")
        ig,ig_,_ = s2x_ii("c154",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c154")
        ig,ig_,_ = s2x_ii("c155",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c155")
        ig,ig_,_ = s2x_ii("c156",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c156")
        ig,ig_,_ = s2x_ii("c157",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c157")
        ig,ig_,_ = s2x_ii("c158",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c158")
        ig,ig_,_ = s2x_ii("c159",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c159")
        ig,ig_,_ = s2x_ii("c160",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c160")
        ig,ig_,_ = s2x_ii("c161",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c161")
        ig,ig_,_ = s2x_ii("c162",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c162")
        ig,ig_,_ = s2x_ii("c163",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c163")
        ig,ig_,_ = s2x_ii("c164",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c164")
        ig,ig_,_ = s2x_ii("c165",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c165")
        ig,ig_,_ = s2x_ii("c166",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c166")
        ig,ig_,_ = s2x_ii("c167",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c167")
        ig,ig_,_ = s2x_ii("c168",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c168")
        ig,ig_,_ = s2x_ii("c169",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c169")
        ig,ig_,_ = s2x_ii("c170",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c170")
        ig,ig_,_ = s2x_ii("c171",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c171")
        ig,ig_,_ = s2x_ii("c172",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c172")
        ig,ig_,_ = s2x_ii("c173",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c173")
        ig,ig_,_ = s2x_ii("c174",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c174")
        ig,ig_,_ = s2x_ii("c175",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c175")
        ig,ig_,_ = s2x_ii("c176",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c176")
        ig,ig_,_ = s2x_ii("c177",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c177")
        ig,ig_,_ = s2x_ii("c178",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c178")
        ig,ig_,_ = s2x_ii("c179",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c179")
        ig,ig_,_ = s2x_ii("c180",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c180")
        ig,ig_,_ = s2x_ii("c181",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c181")
        ig,ig_,_ = s2x_ii("c182",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c182")
        ig,ig_,_ = s2x_ii("c183",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c183")
        ig,ig_,_ = s2x_ii("c184",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c184")
        ig,ig_,_ = s2x_ii("c185",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c185")
        ig,ig_,_ = s2x_ii("c186",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c186")
        ig,ig_,_ = s2x_ii("c187",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c187")
        ig,ig_,_ = s2x_ii("c188",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c188")
        ig,ig_,_ = s2x_ii("c189",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c189")
        ig,ig_,_ = s2x_ii("c190",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c190")
        ig,ig_,_ = s2x_ii("c191",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c191")
        ig,ig_,_ = s2x_ii("c192",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c192")
        ig,ig_,_ = s2x_ii("c193",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c193")
        ig,ig_,_ = s2x_ii("c194",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c194")
        ig,ig_,_ = s2x_ii("c195",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c195")
        ig,ig_,_ = s2x_ii("c196",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c196")
        ig,ig_,_ = s2x_ii("c197",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c197")
        ig,ig_,_ = s2x_ii("c198",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c198")
        ig,ig_,_ = s2x_ii("c199",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c199")
        ig,ig_,_ = s2x_ii("c200",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c200")
        ig,ig_,_ = s2x_ii("c201",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c201")
        ig,ig_,_ = s2x_ii("c202",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c202")
        ig,ig_,_ = s2x_ii("c203",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c203")
        ig,ig_,_ = s2x_ii("c204",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c204")
        ig,ig_,_ = s2x_ii("c205",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c205")
        ig,ig_,_ = s2x_ii("c206",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c206")
        ig,ig_,_ = s2x_ii("c207",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c207")
        ig,ig_,_ = s2x_ii("c208",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c208")
        ig,ig_,_ = s2x_ii("c209",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c209")
        ig,ig_,_ = s2x_ii("c210",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c210")
        ig,ig_,_ = s2x_ii("c211",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c211")
        ig,ig_,_ = s2x_ii("c212",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c212")
        ig,ig_,_ = s2x_ii("c213",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c213")
        ig,ig_,_ = s2x_ii("c214",ig_)
        arrset(gtype,ig,"<=")
        arrset(pb.cnames,ig,"c214")
        ig,ig_,_ = s2x_ii("c215",ig_)
        arrset(gtype,ig,">=")
