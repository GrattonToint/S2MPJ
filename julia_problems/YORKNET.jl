...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        gtype    = String[]
        for I = Int64(v_["ONE"]):Int64(v_["NSTEP"])
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["1"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["2"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["3"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["4"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["5"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["6"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["12"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["7"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["8"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["7"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["9"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["11"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["10"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["6"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["11"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["15"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["12"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["q"*string(Int64(v_["10"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("ND"*string(Int64(v_["13"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["NSTEP"])
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["1"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["2"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["3"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["h"*string(Int64(v_["6"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["4"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["5"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["h"*string(Int64(v_["9"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["6"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["h"*string(Int64(v_["3"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["7"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["h"*string(Int64(v_["8"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["8"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["9"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            iv = ix_["h"*string(Int64(v_["13"]))*","*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("EL"*string(Int64(v_["10"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            ...
            pbm.A[ig,iv] += Float64(1.0)
            for J = Int64(v_["SuPMP"]):Int64(v_["EuPMP"])
                ig,ig_,_ = s2x_ii("EL"*string(J)*","*string(I),ig_)
                arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["ONE"]):Int64(v_["NSTEP"])
            for J = Int64(v_["SuTW"]):Int64(v_["EuTW"])
                ig,ig_,_ = s2x_ii("TWC"*string(J)*","*string(I),ig_)
                arrset(gtype,ig,"<>")
                iv = ix_["qs"*string(J)*","*string(I)]
                pbm.A[ig,iv] += Float64(v_["CTW"*string(J)*","*string(I)])
            end
            for J = Int64(v_["SuPMP"]):Int64(v_["EuPMP"])
                ig,ig_,_ = s2x_ii("PC"*string(J)*","*string(I),ig_)
                arrset(gtype,ig,"<>")
            end
        end
        for J = Int64(v_["SuRES"]):Int64(v_["EuRES"])
            ig,ig_,_ = s2x_ii("RD"*string(J)*","*string(Int64(v_["1"])),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["2"]):Int64(v_["NSTEP"])
            for J = Int64(v_["SuRES"]):Int64(v_["EuRES"])
                v_["A"] = -1+I
                ig,ig_,_ = s2x_ii("RD"*string(J)*","*string(I),ig_)
                arrset(gtype,ig,"==")
