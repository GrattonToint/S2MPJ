...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        if haskey(ix_,"I")
            ...
            pb.y0[findfirst(x->x==ig_["I"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[17.06794],pbm.congrps)]
        end
        if haskey(ix_,"S")
            pb.x0[ix_["S"]] = 8.0
        else
            pb.y0[findfirst(x->x==ig_["S"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[8.0],pbm.congrps)]
        end
        if haskey(ix_,"X0")
            pb.x0[ix_["X0"]] = 13642.3
        else
            pb.y0[findfirst(x->x==ig_["X0"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[13642.3],pbm.congrps)]
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
