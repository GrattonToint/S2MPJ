...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        ig,ig_,_ = s2x_ii("STRESS",ig_)
        arrset(gtype,ig,"<=")
        arrset(pb.cnames,ig,"STRESS")
        iv = ix_["U2"]
        ...
        pbm.gconst[ig_["STRESS"]] = Float64(22.86)
        ...
        it,iet_,_ = s2x_ii( "eXU", iet_)
        loaset(elftv,it,1,"X")
        loaset(elftv,it,2,"U")
        it,iet_,_ = s2x_ii( "eXUPV", iet_)
        loaset(elftv,it,1,"X")
        loaset(elftv,it,2,"U")
        loaset(elftv,it,3,"V")
        it,iet_,_ = s2x_ii( "eXUMV", iet_)
        loaset(elftv,it,1,"X")
        loaset(elftv,it,2,"U")
        loaset(elftv,it,3,"V")
        it,iet_,_ = s2x_ii( "eXBIG", iet_)
        loaset(elftv,it,1,"X")
        loaset(elftv,it,2,"U")
        loaset(elftv,it,3,"V")
        loaset(elftv,it,4,"W")
