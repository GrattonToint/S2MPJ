function LEVYMONT(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling LEVYMONT.")
    end
...
# IE N                   1000           $-PARAMETER
        if nargin<2
            v_["A"] = Float64(1.0);  #  SIF file default value
        else
            v_["A"] = Float64(args[2]);
        end
        if nargin<3
            v_["K"] = Float64(10.0);  #  SIF file default value
        else
            v_["K"] = Float64(args[3]);
        end
# RE L                   0.25           $-PARAMETER original value
        if nargin<4
            v_["L"] = Float64(1.0);  #  SIF file default value
        else
            v_["L"] = Float64(args[4]);
        end
# RE C                   0.75           $-PARAMETER original value
        if nargin<5
            v_["C"] = Float64(0.0);  #  SIF file default value
        else
            v_["C"] = Float64(args[5]);
        end
        v_["1"] = 1
