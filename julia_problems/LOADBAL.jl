...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["NLINK"])
            ig,ig_,_ = s2x_ii("CNST"*string(I),ig_)
            arrset(gtype,ig,"<=")
        ...
        binvars = Int64[]
        ngrp   = length(ig_)
        iv,ix_,_ = s2x_ii("X4,1",ix_)
        arrset(pb.xnames,iv,"X4,1")
        ig = ig_["N1"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X1,4",ix_)
        arrset(pb.xnames,iv,"X1,4")
        ig = ig_["N1"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X4,2",ix_)
        arrset(pb.xnames,iv,"X4,2")
        ig = ig_["N2"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X2,4",ix_)
        arrset(pb.xnames,iv,"X2,4")
        ig = ig_["N2"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X4,3",ix_)
        arrset(pb.xnames,iv,"X4,3")
        ig = ig_["N3"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X3,4",ix_)
        arrset(pb.xnames,iv,"X3,4")
        ig = ig_["N3"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X4,5",ix_)
        arrset(pb.xnames,iv,"X4,5")
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X5,4",ix_)
        arrset(pb.xnames,iv,"X5,4")
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N4"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X5,6",ix_)
        arrset(pb.xnames,iv,"X5,6")
        ig = ig_["N6"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X6,5",ix_)
        arrset(pb.xnames,iv,"X6,5")
        ig = ig_["N6"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X5,7",ix_)
        arrset(pb.xnames,iv,"X5,7")
        ig = ig_["N7"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X7,5",ix_)
        arrset(pb.xnames,iv,"X7,5")
        ig = ig_["N7"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X5,8",ix_)
        arrset(pb.xnames,iv,"X5,8")
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X8,5",ix_)
        arrset(pb.xnames,iv,"X8,5")
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N5"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X8,9",ix_)
        arrset(pb.xnames,iv,"X8,9")
        ig = ig_["N9"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X9,8",ix_)
        arrset(pb.xnames,iv,"X9,8")
        ig = ig_["N9"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X8,10",ix_)
        arrset(pb.xnames,iv,"X8,10")
        ig = ig_["N10"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X10,8",ix_)
        arrset(pb.xnames,iv,"X10,8")
        ig = ig_["N10"]
        pbm.A[ig,iv] += Float64(-1.00)
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(1.00)
        iv,ix_,_ = s2x_ii("X8,11",ix_)
        arrset(pb.xnames,iv,"X8,11")
        ig = ig_["N11"]
        pbm.A[ig,iv] += Float64(1.00)
        ig = ig_["N8"]
        pbm.A[ig,iv] += Float64(-1.00)
        iv,ix_,_ = s2x_ii("X11,8",ix_)
        ...
        it,iet_,_ = s2x_ii( "eBETA1", iet_)
        loaset(elftv,it,1,"V")
        it,iet_,_ = s2x_ii( "eBETA2", iet_)
        loaset(elftv,it,1,"V")
        it,iet_,_ = s2x_ii( "eCOMA1", iet_)
        loaset(elftv,it,1,"V")
        loaset(elftv,it,2,"W")
        it,iet_,_ = s2x_ii( "eCOMA2", iet_)
        loaset(elftv,it,1,"V")
        loaset(elftv,it,2,"W")
        it,iet_,_ = s2x_ii( "eCOMB1", iet_)
        loaset(elftv,it,1,"V")
        loaset(elftv,it,2,"W")
        it,iet_,_ = s2x_ii( "eCOMB2", iet_)
        loaset(elftv,it,1,"V")
        loaset(elftv,it,2,"W")
        #%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ie_      = Dict{String,Int}()
