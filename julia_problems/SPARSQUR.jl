function SPARSQUR(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling SPARSQUR.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            ...
            arrset(pbm.elftype,ie,"eSQUR")
            arrset(ielftype,ie,iet_["eSQUR"])
            vname = "X"*string(I)
            iv,ix_,pb  = (
                  s2mpj_nlx(vname,ix_,pb,1,Float64(-Inf),Float64(Inf),Float64(0.5)))
...
# **********************
    ...
    elseif action == "gSQR"
        ...
        nargout = args[3]
        pbm     = args[4]
        f_= 0.5e0*pbm.grpar[igr_][1]*GVAR_*GVAR_
        if nargout>1
