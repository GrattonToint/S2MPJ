function COSHFUN(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling COSHFUN.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["6"]):Int64(v_["3"]):Int64(v_["N-3"])
            ...
            push!(irA,ig)
            push!(icA,ix_["X"*string(Int64(v_["I-5"]))])
            push!(valA,Float64(1.0))
            push!(irA,ig)
