...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["G1"]] = Float64(v_["sumuMx"])
        pbm.gconst[ig_["G2"]] = Float64(v_["sumuMy"])
        pbm.gconst[ig_["G3"]] = Float64(v_["sumuA"])
        pbm.gconst[ig_["G4"]] = Float64(v_["sumuB"])
        pbm.gconst[ig_["G5"]] = Float64(v_["sumuC"])
        pbm.gconst[ig_["G6"]] = Float64(v_["sumuD"])
        pbm.gconst[ig_["G7"]] = Float64(v_["sumuE"])
        pbm.gconst[ig_["G8"]] = Float64(v_["sumuF"])
