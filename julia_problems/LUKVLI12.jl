...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        ig_ = Dict{String,Int}();
        if nargin<1
            v_["N"] = Int64(7);  #  SIF file default value
        else
            v_["N"] = Int64(args[1]);
        end
...
# IE N                   99997          $-PARAMETER
        ...
        for K = Int64(v_["1"]):Int64(v_["3"]):Int64(v_["NC"])
            ...
            pbm.gconst[ig_["C"*string(Int64(v_["K+1"]))]] = Float64(1.0)
            pbm.gconst[ig_["C"*string(Int64(v_["K+2"]))]] = Float64(1.0)
        end
