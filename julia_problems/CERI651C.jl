...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        if haskey(ix_,"I")
            ...
            pb.y0[findfirst(x->x==ig_["I"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[597.076],pbm.congrps)]
        end
        if haskey(ix_,"S")
            pb.x0[ix_["S"]] = 22.9096
        else
            pb.y0[findfirst(x->x==ig_["S"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[22.9096],pbm.congrps)]
        end
        if haskey(ix_,"X0")
            pb.x0[ix_["X0"]] = 24027.5
        else
            pb.y0[findfirst(x->x==ig_["X0"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[24027.5],pbm.congrps)]
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
