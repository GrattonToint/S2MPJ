function STREGNE(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling STREGNE.")
    end
    ...
    if action == "setup"
        ...
        if haskey(ix_,"X1")
            ...
            pb.y0[findfirst(x->x==ig_["X1"],pbm.congrps)] = Float64(-1.2)
        end
        if haskey(ix_,"X2")
        ...
        if haskey(ix_,"X3")
            ...
            pb.y0[findfirst(x->x==ig_["X3"],pbm.congrps)] = Float64(1.0e+10)
        end
        if haskey(ix_,"X4")
            pb.x0[ix_["X4"]] = Float64(1.0e+10)
        else
            pb.y0[findfirst(x->x==ig_["X4"],pbm.congrps)] = Float64(1.0e+10)
        end
        #%%%%%%%%%%%%%%%%%%%% QUADRATIC %%%%%%%%%%%%%%%%%%%
        irH  = Int64[]
        icH  = Int64[]
