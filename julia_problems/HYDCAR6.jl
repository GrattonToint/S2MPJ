...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        gtype    = String[]
        for J = Int64(v_["1"]):Int64(v_["M"])
            ig,ig_,_ = s2x_ii("2.1-"*string(J),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["0"]):Int64(v_["N-1"])
            ig,ig_,_ = s2x_ii("2.7-"*string(I),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["N-2"])
            ig,ig_,_ = s2x_ii("2.9-"*string(I),ig_)
            arrset(gtype,ig,"==")
        ...
        if haskey(ix_,"X0,2")
            ...
            pb.y0[findfirst(x->x==ig_["X0,2"],pbm.congrps)] = Float64(0.2)
        end
        if haskey(ix_,"X0,3")
            pb.x0[ix_["X0,3"]] = Float64(0.9)
        else
            pb.y0[findfirst(x->x==ig_["X0,3"],pbm.congrps)] = Float64(0.9)
        end
        if haskey(ix_,"X1,1")
        ...
        if haskey(ix_,"X1,2")
            ...
            pb.y0[findfirst(x->x==ig_["X1,2"],pbm.congrps)] = Float64(0.2)
        end
        if haskey(ix_,"X1,3")
            pb.x0[ix_["X1,3"]] = Float64(0.8)
        else
            pb.y0[findfirst(x->x==ig_["X1,3"],pbm.congrps)] = Float64(0.8)
        end
        if haskey(ix_,"X2,1")
            pb.x0[ix_["X2,1"]] = Float64(0.05)
        else
            pb.y0[findfirst(x->x==ig_["X2,1"],pbm.congrps)] = Float64(0.05)
        end
        if haskey(ix_,"X2,2")
        ...
        if haskey(ix_,"X2,3")
            ...
            pb.y0[findfirst(x->x==ig_["X2,3"],pbm.congrps)] = Float64(0.8)
        end
        if haskey(ix_,"X3,1")
            pb.x0[ix_["X3,1"]] = Float64(0.1)
        else
            pb.y0[findfirst(x->x==ig_["X3,1"],pbm.congrps)] = Float64(0.1)
        end
        if haskey(ix_,"X3,2")
            pb.x0[ix_["X3,2"]] = Float64(0.3)
        else
            pb.y0[findfirst(x->x==ig_["X3,2"],pbm.congrps)] = Float64(0.3)
        end
        if haskey(ix_,"X3,3")
            pb.x0[ix_["X3,3"]] = Float64(0.6)
        else
            pb.y0[findfirst(x->x==ig_["X3,3"],pbm.congrps)] = Float64(0.6)
        end
        if haskey(ix_,"X4,1")
            pb.x0[ix_["X4,1"]] = Float64(0.3)
        else
            pb.y0[findfirst(x->x==ig_["X4,1"],pbm.congrps)] = Float64(0.3)
        end
        if haskey(ix_,"X4,2")
            pb.x0[ix_["X4,2"]] = Float64(0.5)
        else
            pb.y0[findfirst(x->x==ig_["X4,2"],pbm.congrps)] = Float64(0.5)
        end
        if haskey(ix_,"X4,3")
            pb.x0[ix_["X4,3"]] = Float64(0.3)
        else
            pb.y0[findfirst(x->x==ig_["X4,3"],pbm.congrps)] = Float64(0.3)
        end
        if haskey(ix_,"X5,1")
            pb.x0[ix_["X5,1"]] = Float64(0.6)
        else
            pb.y0[findfirst(x->x==ig_["X5,1"],pbm.congrps)] = Float64(0.6)
        end
        if haskey(ix_,"X5,2")
            pb.x0[ix_["X5,2"]] = Float64(0.6)
        else
            pb.y0[findfirst(x->x==ig_["X5,2"],pbm.congrps)] = Float64(0.6)
        end
        if haskey(ix_,"X5,3")
            pb.x0[ix_["X5,3"]] = Float64(0.0)
        else
            pb.y0[findfirst(x->x==ig_["X5,3"],pbm.congrps)] = Float64(0.0)
        end
        for I = Int64(v_["0"]):Int64(v_["N-1"])
