function HS79(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS79.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["C1"]] = Float64(v_["2+3SQ2"])
        v_["SQ2"] = sqrt(2.0)
        v_["2SQ2"] = 2.0*v_["SQ2"]
        v_["2SQ2-2"] = -2.0+v_["2SQ2"]
        pbm.gconst[ig_["C2"]] = Float64(v_["2SQ2-2"])
        pbm.gconst[ig_["C3"]] = Float64(2.0)
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        ename = "E7"
        ie,ie_,_  = s2mpj_ii(ename,ie_)
        arrset(pbm.elftype,ie,"eDQU")
        arrset(ielftype,ie,iet_["eDQU"])
        vname = "X3"
        iv,ix_,pb  = (
              s2mpj_nlx(vname,ix_,pb,1,Float64(-Inf),Float64(Inf),Float64(2.0)))
        posev = findfirst(x->x=="X",elftv[ielftype[ie]])
