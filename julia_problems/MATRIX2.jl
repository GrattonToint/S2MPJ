...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        iv,ix_,_ = s2x_ii("Y11",ix_)
        arrset(pb.xnames,iv,"Y11")
        iv,ix_,_ = s2x_ii("Y12",ix_)
        arrset(pb.xnames,iv,"Y12")
        iv,ix_,_ = s2x_ii("Y22",ix_)
        arrset(pb.xnames,iv,"Y22")
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        gtype    = String[]
        ig,ig_,_ = s2x_ii("FROBDIST",ig_)
        arrset(gtype,ig,"<>")
        ig,ig_,_ = s2x_ii("XPOSDEF",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"XPOSDEF")
        ig,ig_,_ = s2x_ii("YNEGDEF",ig_)
        arrset(gtype,ig,"<=")
