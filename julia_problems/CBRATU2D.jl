function CBRATU2D(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling CBRATU2D.")
    end
...
# IE P                   40             $-PARAMETER n = 3200
        ...
        for I = Int64(v_["2"]):Int64(v_["P-1"])
            ...
            for J = Int64(v_["2"]):Int64(v_["P-1"])
                ...
                push!(irA,ig)
                push!(icA,ix_["U"*string(Int64(v_["R"]))*","*string(J)])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["U"*string(Int64(v_["S"]))*","*string(J)])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["U"*string(I)*","*string(Int64(v_["V"]))])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["U"*string(I)*","*string(Int64(v_["W"]))])
                push!(valA,Float64(-1.0))
                ...
                push!(valA,Float64(4.0))
                push!(irA,ig)
                push!(icA,ix_["X"*string(Int64(v_["R"]))*","*string(J)])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["X"*string(Int64(v_["S"]))*","*string(J)])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["X"*string(I)*","*string(Int64(v_["V"]))])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["X"*string(I)*","*string(Int64(v_["W"]))])
                push!(valA,Float64(-1.0))
            end
        end
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
