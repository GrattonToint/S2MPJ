function CORE2(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling CORE2.")
    end
    ...
    if action == "setup"
        ...
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0022"])
        push!(valA,Float64(-1.00000E+00))
        iv,ix_,_ = s2mpj_ii("FLOW0020",ix_)
        arrset(pb.xnames,iv,"FLOW0020")
        push!(icA,iv)
        push!(irA,ig_["NODE0023"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0024"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(icA,iv)
        push!(irA,ig_["NODE0037"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0038"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(icA,iv)
        push!(irA,ig_["NODE0044"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0045"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(valA,Float64(-6.97133E-01))
        iv,ix_,_ = s2mpj_ii("PI000001",ix_)
        arrset(pb.xnames,iv,"PI000001")
        push!(icA,iv)
        push!(irA,ig_["ARC00016"])
        push!(valA,Float64(1.81479E-02))
        iv,ix_,_ = s2mpj_ii("PI000001",ix_)
        arrset(pb.xnames,iv,"PI000001")
        push!(icA,iv)
        push!(irA,ig_["ARC00056"])
        push!(valA,Float64(2.85181E-02))
        ...
        push!(valA,Float64(-2.65927E-03))
        iv,ix_,_ = s2mpj_ii("PI000003",ix_)
        arrset(pb.xnames,iv,"PI000003")
        push!(icA,iv)
        push!(irA,ig_["ARC00055"])
        push!(valA,Float64(-3.99253E-02))
        ...
        arrset(pb.xnames,iv,"PI000007")
        push!(icA,iv)
        push!(irA,ig_["ARC00035"])
        push!(valA,Float64(9.98133E-02))
        iv,ix_,_ = s2mpj_ii("PI000007",ix_)
        arrset(pb.xnames,iv,"PI000007")
        push!(icA,iv)
        push!(irA,ig_["ARC00036"])
        push!(valA,Float64(-4.99067E-02))
        iv,ix_,_ = s2mpj_ii("PI000007",ix_)
        arrset(pb.xnames,iv,"PI000007")
        push!(icA,iv)
        push!(irA,ig_["ARC00047"])
        push!(valA,Float64(2.09022E+00))
        iv,ix_,_ = s2mpj_ii("PI000007",ix_)
        arrset(pb.xnames,iv,"PI000007")
        push!(icA,iv)
        push!(irA,ig_["ARC00048"])
        push!(valA,Float64(-6.96739E-01))
        iv,ix_,_ = s2mpj_ii("PI000008",ix_)
        arrset(pb.xnames,iv,"PI000008")
        push!(icA,iv)
        push!(irA,ig_["ARC00005"])
        push!(valA,Float64(-1.90020E-01))
        iv,ix_,_ = s2mpj_ii("PI000008",ix_)
        arrset(pb.xnames,iv,"PI000008")
        push!(icA,iv)
        push!(irA,ig_["ARC00009"])
        push!(valA,Float64(-6.11442E-03))
        ...
        push!(valA,Float64(-3.21572E-01))
        iv,ix_,_ = s2mpj_ii("PI000010",ix_)
        arrset(pb.xnames,iv,"PI000010")
        push!(icA,iv)
        push!(irA,ig_["ARC00008"])
        push!(valA,Float64(4.32263E-02))
        ...
        push!(valA,Float64(1.16174E-02))
        iv,ix_,_ = s2mpj_ii("PI000012",ix_)
        arrset(pb.xnames,iv,"PI000012")
        push!(icA,iv)
        push!(irA,ig_["ARC00011"])
        push!(valA,Float64(-2.59358E-01))
        ...
        arrset(pb.xnames,iv,"PI000016")
        push!(icA,iv)
        push!(irA,ig_["ARC00054"])
        push!(valA,Float64(1.36747E-01))
        ...
        push!(valA,Float64(-8.64525E-02))
        iv,ix_,_ = s2mpj_ii("PI000019",ix_)
        arrset(pb.xnames,iv,"PI000019")
        push!(icA,iv)
        push!(irA,ig_["ARC00027"])
        push!(valA,Float64(-3.32711E-02))
        iv,ix_,_ = s2mpj_ii("PI000019",ix_)
        arrset(pb.xnames,iv,"PI000019")
        push!(icA,iv)
        push!(irA,ig_["ARC00040"])
        push!(valA,Float64(-1.93623E-02))
        ...
        arrset(pb.xnames,iv,"PI000024")
        push!(icA,iv)
        push!(irA,ig_["ARC00033"])
        push!(valA,Float64(6.07700E-03))
        iv,ix_,_ = s2mpj_ii("PI000024",ix_)
        arrset(pb.xnames,iv,"PI000024")
        push!(icA,iv)
        push!(irA,ig_["ARC00046"])
        push!(valA,Float64(6.07700E-03))
        ...
        arrset(pb.xnames,iv,"PI000027")
        push!(icA,iv)
        push!(irA,ig_["ARC00034"])
        push!(valA,Float64(-4.10240E-01))
        ...
        arrset(pb.xnames,iv,"PI000028")
        push!(icA,iv)
        push!(irA,ig_["ARC00025"])
        push!(valA,Float64(4.18044E-01))
        iv,ix_,_ = s2mpj_ii("PI000028",ix_)
        arrset(pb.xnames,iv,"PI000028")
        push!(icA,iv)
        push!(irA,ig_["ARC00026"])
        push!(valA,Float64(-6.33373E-04))
        iv,ix_,_ = s2mpj_ii("PI000028",ix_)
        arrset(pb.xnames,iv,"PI000028")
        push!(icA,iv)
        push!(irA,ig_["ARC00039"])
        push!(valA,Float64(-1.99627E-02))
        ...
        arrset(pb.xnames,iv,"PI000029")
        push!(icA,iv)
        push!(irA,ig_["ARC00052"])
        push!(valA,Float64(3.21572E-01))
        iv,ix_,_ = s2mpj_ii("PI000029",ix_)
        arrset(pb.xnames,iv,"PI000029")
        push!(icA,iv)
        push!(irA,ig_["ARC00053"])
        push!(valA,Float64(-1.64096E-01))
        ...
        arrset(pb.xnames,iv,"PI000030")
        push!(icA,iv)
        push!(irA,ig_["ARC00030"])
        push!(valA,Float64(3.32711E-02))
        iv,ix_,_ = s2mpj_ii("PI000030",ix_)
        arrset(pb.xnames,iv,"PI000030")
        push!(icA,iv)
        push!(irA,ig_["ARC00031"])
        push!(valA,Float64(-9.54957E-03))
        iv,ix_,_ = s2mpj_ii("PI000030",ix_)
        arrset(pb.xnames,iv,"PI000030")
        push!(icA,iv)
        push!(irA,ig_["ARC00039"])
        ...
        arrset(pb.xnames,iv,"PI000030")
        push!(icA,iv)
        push!(irA,ig_["ARC00043"])
        push!(valA,Float64(1.93623E-02))
        iv,ix_,_ = s2mpj_ii("PI000030",ix_)
        arrset(pb.xnames,iv,"PI000030")
        push!(icA,iv)
        push!(irA,ig_["ARC00044"])
        push!(valA,Float64(-9.54957E-03))
        ...
        arrset(pb.xnames,iv,"PI000031")
        push!(icA,iv)
        push!(irA,ig_["ARC00041"])
        push!(valA,Float64(-5.80870E-02))
        ...
        arrset(pb.xnames,iv,"PI000034")
        push!(icA,iv)
        push!(irA,ig_["ARC00032"])
        push!(valA,Float64(-6.68470E-02))
        iv,ix_,_ = s2mpj_ii("PI000034",ix_)
        arrset(pb.xnames,iv,"PI000034")
        push!(icA,iv)
        push!(irA,ig_["ARC00034"])
        ...
        push!(icA,iv)
        push!(irA,ig_["ARC00037"])
        push!(valA,Float64(-3.48370E-01))
        iv,ix_,_ = s2mpj_ii("PI000037",ix_)
        arrset(pb.xnames,iv,"PI000037")
        push!(icA,iv)
        push!(irA,ig_["ARC00049"])
        push!(valA,Float64(-1.43027E-02))
        ...
        arrset(pb.xnames,iv,"PI000039")
        push!(icA,iv)
        push!(irA,ig_["ARC00050"])
        push!(valA,Float64(-1.09654E-01))
        ...
        push!(icA,iv)
        push!(irA,ig_["ARC00057"])
        push!(valA,Float64(-1.82329E-01))
        iv,ix_,_ = s2mpj_ii("PI000044",ix_)
        arrset(pb.xnames,iv,"PI000044")
        push!(icA,iv)
        push!(irA,ig_["ARC00059"])
        push!(valA,Float64(-3.32711E-02))
        ...
        arrset(pb.xnames,iv,"PI000047")
        push!(icA,iv)
        push!(irA,ig_["ARC00060"])
        push!(valA,Float64(-9.98133E-03))
