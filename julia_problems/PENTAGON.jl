function PENTAGON(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling PENTAGON.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["3"])
            for J = Int64(v_["0"]):Int64(v_["4"])
                ...
                push!(valA,Float64(v_["C"*string(J)]))
                push!(irA,ig)
