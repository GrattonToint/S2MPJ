function OBSTCLAL(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OBSTCLAL.")
    end
...
# IE PY                  125            $-PARAMETER
        ...
        for I = Int64(v_["2"]):Int64(v_["PY-1"])
            ...
            for J = Int64(v_["2"]):Int64(v_["PX-1"])
                ...
                iv,ix_,pb = s2mpj_nlx(vname,ix_,pb,1,nothing,Float64(2000.0),nothing)
