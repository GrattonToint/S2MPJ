...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        vname = "AW1"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,1.0e-8,1.0e+4,nothing)
