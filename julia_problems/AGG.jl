function AGG(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling AGG.")
    end
    ...
    if action == "setup"
        ...
        push!(icA,iv)
        push!(irA,ig_["MND00104"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01401"])
        push!(valA,Float64(.01773))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["CAP01501"])
        push!(valA,Float64(.01775))
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        push!(valA,Float64(.00132))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MND00103"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-.76829))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MXD00104"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-1.1405))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MXD00103"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01502"])
        push!(valA,Float64(.01248))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MXD00106"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01402"])
        push!(valA,Float64(.01301))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["CAP06301"])
        push!(valA,Float64(.00141))
        push!(icA,iv)
        push!(irA,ig_["MND00106"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MXD00102"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00102"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["MND00105"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00105"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00102",ix_)
        arrset(pb.xnames,iv,"Y00102")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-31.09))
        iv,ix_,_ = s2mpj_ii("Y00103",ix_)
        arrset(pb.xnames,iv,"Y00103")
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-1.05277))
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        push!(valA,Float64(.0013))
        iv,ix_,_ = s2mpj_ii("Y00103",ix_)
        arrset(pb.xnames,iv,"Y00103")
        push!(icA,iv)
        push!(irA,ig_["MXD00105"])
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01503"])
        push!(valA,Float64(.01385))
        iv,ix_,_ = s2mpj_ii("Y00103",ix_)
        arrset(pb.xnames,iv,"Y00103")
        push!(icA,iv)
        push!(irA,ig_["CAP06303"])
        push!(valA,Float64(.00143))
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        push!(valA,Float64(-.85602))
        iv,ix_,_ = s2mpj_ii("Y00103",ix_)
        arrset(pb.xnames,iv,"Y00103")
        push!(icA,iv)
        push!(irA,ig_["MND00105"])
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01403"])
        push!(valA,Float64(.01438))
        iv,ix_,_ = s2mpj_ii("Y00103",ix_)
        arrset(pb.xnames,iv,"Y00103")
        push!(icA,iv)
        push!(irA,ig_["MND00103"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-28.03))
        push!(icA,iv)
        push!(irA,ig_["CAP06304"])
        push!(valA,Float64(.00143))
        iv,ix_,_ = s2mpj_ii("Y00104",ix_)
        arrset(pb.xnames,iv,"Y00104")
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        push!(valA,Float64(-.85602))
        push!(icA,iv)
        push!(irA,ig_["CAP06303"])
        push!(valA,Float64(.0013))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01504"])
        push!(valA,Float64(.01578))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-26.61))
        iv,ix_,_ = s2mpj_ii("Y00105",ix_)
        arrset(pb.xnames,iv,"Y00105")
        push!(icA,iv)
        push!(irA,ig_["CAP01404"])
        push!(valA,Float64(.01576))
        push!(icA,iv)
        push!(irA,ig_["MND00105"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00105",ix_)
        arrset(pb.xnames,iv,"Y00105")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-.89501))
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        push!(valA,Float64(-1.01378))
        iv,ix_,_ = s2mpj_ii("Y00105",ix_)
        arrset(pb.xnames,iv,"Y00105")
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        push!(valA,Float64(.00147))
        push!(icA,iv)
        push!(irA,ig_["CAP06304"])
        push!(valA,Float64(.00125))
        iv,ix_,_ = s2mpj_ii("Y00105",ix_)
        arrset(pb.xnames,iv,"Y00105")
        push!(icA,iv)
        push!(irA,ig_["MXD00105"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01405"])
        push!(valA,Float64(.01498))
        iv,ix_,_ = s2mpj_ii("Y00105",ix_)
        arrset(pb.xnames,iv,"Y00105")
        push!(icA,iv)
        push!(irA,ig_["CAP01505"])
        push!(valA,Float64(.01446))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["CAP01506"])
        push!(valA,Float64(.03024))
        push!(icA,iv)
        push!(irA,ig_["CAP06306"])
        push!(valA,Float64(.00272))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.26))
        push!(icA,iv)
        push!(irA,ig_["INV00306"])
        push!(valA,Float64(-1.90879))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-1.09488))
        push!(icA,iv)
        push!(irA,ig_["CAP01405"])
        push!(valA,Float64(.01702))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["CAP01505"])
        push!(valA,Float64(.01704))
        push!(icA,iv)
        push!(irA,ig_["MND00106"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["CAP01406"])
        push!(valA,Float64(.03074))
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        push!(valA,Float64(.00135))
        iv,ix_,_ = s2mpj_ii("Y00106",ix_)
        arrset(pb.xnames,iv,"Y00106")
        push!(icA,iv)
        push!(irA,ig_["MXD00106"])
        ...
        push!(valA,Float64(.00132))
        push!(icA,iv)
        push!(irA,ig_["CAP00301"])
        push!(valA,Float64(.02059))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        arrset(pb.xnames,iv,"Y00202")
        push!(icA,iv)
        push!(irA,ig_["MXD00104"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-31.15))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        arrset(pb.xnames,iv,"Y00202")
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.01176))
        push!(icA,iv)
        push!(irA,ig_["MND00106"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-.52969))
        push!(icA,iv)
        push!(irA,ig_["CAP00302"])
        push!(valA,Float64(.00965))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        arrset(pb.xnames,iv,"Y00202")
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-1.3791))
        push!(icA,iv)
        push!(irA,ig_["MXD00106"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        ...
        arrset(pb.xnames,iv,"Y00202")
        push!(icA,iv)
        push!(irA,ig_["CAP00101"])
        push!(valA,Float64(.02083))
        push!(icA,iv)
        push!(irA,ig_["MXD00103"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00202",ix_)
        ...
        arrset(pb.xnames,iv,"Y00203")
        push!(icA,iv)
        push!(irA,ig_["CAP00103"])
        push!(valA,Float64(.01336))
        push!(icA,iv)
        push!(irA,ig_["CAP00303"])
        push!(valA,Float64(.01123))
        iv,ix_,_ = s2mpj_ii("Y00203",ix_)
        arrset(pb.xnames,iv,"Y00203")
        push!(icA,iv)
        push!(irA,ig_["MXD00105"])
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-1.27302))
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        push!(valA,Float64(-.63578))
        iv,ix_,_ = s2mpj_ii("Y00203",ix_)
        arrset(pb.xnames,iv,"Y00203")
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.01923))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-29.57))
        iv,ix_,_ = s2mpj_ii("Y00203",ix_)
        arrset(pb.xnames,iv,"Y00203")
        push!(icA,iv)
        push!(irA,ig_["MND00105"])
        ...
        push!(valA,Float64(-.63578))
        push!(icA,iv)
        push!(irA,ig_["CAP00304"])
        push!(valA,Float64(.01123))
        iv,ix_,_ = s2mpj_ii("Y00204",ix_)
        arrset(pb.xnames,iv,"Y00204")
        push!(icA,iv)
        push!(irA,ig_["CAP00104"])
        push!(valA,Float64(.01336))
        push!(icA,iv)
        push!(irA,ig_["CAP00303"])
        push!(valA,Float64(.019))
        ...
        arrset(pb.xnames,iv,"Y00205")
        push!(icA,iv)
        push!(irA,ig_["CAP00305"])
        push!(valA,Float64(.01194))
        push!(icA,iv)
        push!(irA,ig_["CAP00105"])
        push!(valA,Float64(.01408))
        iv,ix_,_ = s2mpj_ii("Y00205",ix_)
        arrset(pb.xnames,iv,"Y00205")
        push!(icA,iv)
        push!(irA,ig_["CAP06304"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00304"])
        push!(valA,Float64(.0183))
        iv,ix_,_ = s2mpj_ii("Y00205",ix_)
        arrset(pb.xnames,iv,"Y00205")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-.68292))
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        push!(valA,Float64(.00147))
        iv,ix_,_ = s2mpj_ii("Y00205",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00104"])
        push!(valA,Float64(.01852))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-26.66))
        iv,ix_,_ = s2mpj_ii("Y00205",ix_)
        arrset(pb.xnames,iv,"Y00205")
        push!(icA,iv)
        push!(irA,ig_["MND00105"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.31))
        iv,ix_,_ = s2mpj_ii("Y00206",ix_)
        arrset(pb.xnames,iv,"Y00206")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-1.32394))
        push!(icA,iv)
        push!(irA,ig_["INV00306"])
        push!(valA,Float64(-1.90879))
        iv,ix_,_ = s2mpj_ii("Y00206",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00105"])
        push!(valA,Float64(.02))
        iv,ix_,_ = s2mpj_ii("Y00206",ix_)
        arrset(pb.xnames,iv,"Y00206")
        push!(icA,iv)
        push!(irA,ig_["CAP00306"])
        push!(valA,Float64(.03024))
        push!(icA,iv)
        push!(irA,ig_["CAP00305"])
        push!(valA,Float64(.01976))
        iv,ix_,_ = s2mpj_ii("Y00206",ix_)
        arrset(pb.xnames,iv,"Y00206")
        push!(icA,iv)
        push!(irA,ig_["CAP00106"])
        push!(valA,Float64(.03259))
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        push!(valA,Float64(.00135))
        iv,ix_,_ = s2mpj_ii("Y00206",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["MXD00205"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00205"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["CAP00501"])
        push!(valA,Float64(.01455))
        push!(icA,iv)
        push!(irA,ig_["MXD00202"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["MND00204"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.46))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["CAP00401"])
        push!(valA,Float64(.01426))
        push!(icA,iv)
        push!(irA,ig_["CAP00502"])
        push!(valA,Float64(.06023))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["MND00202"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00204"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        push!(valA,Float64(.00165))
        push!(icA,iv)
        push!(irA,ig_["MND00206"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["MXD00206"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-.67787))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["CAP06301"])
        push!(valA,Float64(.00015))
        push!(icA,iv)
        push!(irA,ig_["CAP00402"])
        push!(valA,Float64(.04611))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-1.76124))
        push!(icA,iv)
        push!(irA,ig_["MND00203"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00302",ix_)
        arrset(pb.xnames,iv,"Y00302")
        push!(icA,iv)
        push!(irA,ig_["MXD00203"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00303",ix_)
        arrset(pb.xnames,iv,"Y00303")
        push!(icA,iv)
        push!(irA,ig_["CAP00503"])
        push!(valA,Float64(.06135))
        push!(icA,iv)
        push!(irA,ig_["CAP00403"])
        push!(valA,Float64(.0472))
        iv,ix_,_ = s2mpj_ii("Y00303",ix_)
        arrset(pb.xnames,iv,"Y00303")
        push!(icA,iv)
        push!(irA,ig_["MXD00205"])
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        push!(valA,Float64(-1.81339))
        iv,ix_,_ = s2mpj_ii("Y00303",ix_)
        arrset(pb.xnames,iv,"Y00303")
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-.62573))
        push!(icA,iv)
        push!(irA,ig_["MXD00206"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00303",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        push!(valA,Float64(.00014))
        push!(icA,iv)
        push!(irA,ig_["CAP00502"])
        push!(valA,Float64(.01343))
        iv,ix_,_ = s2mpj_ii("Y00303",ix_)
        arrset(pb.xnames,iv,"Y00303")
        push!(icA,iv)
        push!(irA,ig_["CAP00402"])
        push!(valA,Float64(.01316))
        ...
        push!(valA,Float64(-1.81339))
        push!(icA,iv)
        push!(irA,ig_["CAP00404"])
        push!(valA,Float64(.0472))
        iv,ix_,_ = s2mpj_ii("Y00304",ix_)
        arrset(pb.xnames,iv,"Y00304")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-28.52))
        push!(icA,iv)
        push!(irA,ig_["CAP00504"])
        push!(valA,Float64(.06135))
        iv,ix_,_ = s2mpj_ii("Y00304",ix_)
        arrset(pb.xnames,iv,"Y00304")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-1.83656))
        iv,ix_,_ = s2mpj_ii("Y00305",ix_)
        arrset(pb.xnames,iv,"Y00305")
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        push!(valA,Float64(-.60255))
        push!(icA,iv)
        push!(irA,ig_["CAP00505"])
        push!(valA,Float64(.06184))
        iv,ix_,_ = s2mpj_ii("Y00305",ix_)
        arrset(pb.xnames,iv,"Y00305")
        push!(icA,iv)
        push!(irA,ig_["CAP00404"])
        push!(valA,Float64(.01268))
        push!(icA,iv)
        push!(irA,ig_["MXD00205"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00305",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-27.08))
        push!(icA,iv)
        push!(irA,ig_["CAP00504"])
        push!(valA,Float64(.01293))
        iv,ix_,_ = s2mpj_ii("Y00305",ix_)
        arrset(pb.xnames,iv,"Y00305")
        push!(icA,iv)
        push!(irA,ig_["MND00205"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP06304"])
        push!(valA,Float64(.00013))
        iv,ix_,_ = s2mpj_ii("Y00305",ix_)
        arrset(pb.xnames,iv,"Y00305")
        push!(icA,iv)
        push!(irA,ig_["CAP00405"])
        push!(valA,Float64(.04769))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        arrset(pb.xnames,iv,"Y00306")
        push!(icA,iv)
        push!(irA,ig_["CAP06306"])
        push!(valA,Float64(.0018))
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        push!(valA,Float64(.00014))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00306"])
        push!(valA,Float64(-2.43911))
        push!(icA,iv)
        push!(irA,ig_["CAP00406"])
        push!(valA,Float64(.06037))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        arrset(pb.xnames,iv,"Y00306")
        push!(icA,iv)
        push!(irA,ig_["CAP00506"])
        push!(valA,Float64(.07478))
        push!(icA,iv)
        push!(irA,ig_["CAP00505"])
        push!(valA,Float64(.01397))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        arrset(pb.xnames,iv,"Y00306")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.71))
        push!(icA,iv)
        push!(irA,ig_["MND00206"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00405"])
        push!(valA,Float64(.01369))
        iv,ix_,_ = s2mpj_ii("Y00306",ix_)
        arrset(pb.xnames,iv,"Y00306")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-.65075))
        ...
        push!(valA,Float64(.00165))
        push!(icA,iv)
        push!(irA,ig_["CAP01701"])
        push!(valA,Float64(.00928))
        iv,ix_,_ = s2mpj_ii("Y00402",ix_)
        arrset(pb.xnames,iv,"Y00402")
        push!(icA,iv)
        push!(irA,ig_["CAP06301"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.42))
        iv,ix_,_ = s2mpj_ii("Y00402",ix_)
        arrset(pb.xnames,iv,"Y00402")
        push!(icA,iv)
        push!(irA,ig_["CAP01602"])
        push!(valA,Float64(.05177))
        push!(icA,iv)
        push!(irA,ig_["MXD00205"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00402",ix_)
        ...
        arrset(pb.xnames,iv,"Y00402")
        push!(icA,iv)
        push!(irA,ig_["CAP01601"])
        push!(valA,Float64(.0086))
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-.37298))
        iv,ix_,_ = s2mpj_ii("Y00402",ix_)
        arrset(pb.xnames,iv,"Y00402")
        push!(icA,iv)
        push!(irA,ig_["MXD00203"])
        ...
        arrset(pb.xnames,iv,"Y00402")
        push!(icA,iv)
        push!(irA,ig_["CAP01702"])
        push!(valA,Float64(.061))
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-30.0))
        iv,ix_,_ = s2mpj_ii("Y00403",ix_)
        arrset(pb.xnames,iv,"Y00403")
        push!(icA,iv)
        push!(irA,ig_["CAP01603"])
        push!(valA,Float64(.05243))
        push!(icA,iv)
        push!(irA,ig_["CAP01602"])
        push!(valA,Float64(.00794))
        iv,ix_,_ = s2mpj_ii("Y00403",ix_)
        arrset(pb.xnames,iv,"Y00403")
        push!(icA,iv)
        push!(irA,ig_["CAP01703"])
        push!(valA,Float64(.06171))
        push!(icA,iv)
        push!(irA,ig_["MXD00204"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00403",ix_)
        ...
        arrset(pb.xnames,iv,"Y00404")
        push!(icA,iv)
        push!(irA,ig_["CAP01604"])
        push!(valA,Float64(.05243))
        push!(icA,iv)
        push!(irA,ig_["CAP01704"])
        push!(valA,Float64(.06171))
        iv,ix_,_ = s2mpj_ii("Y00404",ix_)
        arrset(pb.xnames,iv,"Y00404")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01704"])
        push!(valA,Float64(.00825))
        iv,ix_,_ = s2mpj_ii("Y00405",ix_)
        arrset(pb.xnames,iv,"Y00405")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-27.04))
        push!(icA,iv)
        push!(irA,ig_["CAP06304"])
        push!(valA,Float64(.00013))
        iv,ix_,_ = s2mpj_ii("Y00405",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-2.10758))
        iv,ix_,_ = s2mpj_ii("Y00405",ix_)
        arrset(pb.xnames,iv,"Y00405")
        push!(icA,iv)
        push!(irA,ig_["CAP01605"])
        push!(valA,Float64(.05272))
        push!(icA,iv)
        push!(irA,ig_["CAP01705"])
        push!(valA,Float64(.06203))
        iv,ix_,_ = s2mpj_ii("Y00405",ix_)
        arrset(pb.xnames,iv,"Y00405")
        push!(icA,iv)
        push!(irA,ig_["CAP06305"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01706"])
        push!(valA,Float64(.07028))
        push!(icA,iv)
        push!(irA,ig_["CAP01605"])
        push!(valA,Float64(.00826))
        iv,ix_,_ = s2mpj_ii("Y00406",ix_)
        arrset(pb.xnames,iv,"Y00406")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        push!(valA,Float64(-.35806))
        push!(icA,iv)
        push!(irA,ig_["MND00206"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00406",ix_)
        ...
        push!(valA,Float64(-2.43911))
        push!(icA,iv)
        push!(irA,ig_["CAP01606"])
        push!(valA,Float64(.06037))
        iv,ix_,_ = s2mpj_ii("Y00406",ix_)
        arrset(pb.xnames,iv,"Y00406")
        push!(icA,iv)
        push!(irA,ig_["CAP01705"])
        push!(valA,Float64(.00891))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.67))
        iv,ix_,_ = s2mpj_ii("Y00406",ix_)
        arrset(pb.xnames,iv,"Y00406")
        push!(icA,iv)
        push!(irA,ig_["CAP06306"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00401"])
        push!(valA,Float64(.00401))
        push!(icA,iv)
        push!(irA,ig_["MND00305"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-.216))
        push!(icA,iv)
        push!(irA,ig_["MND00304"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["CAP06002"])
        push!(valA,Float64(.00225))
        push!(icA,iv)
        push!(irA,ig_["CAP06003"])
        push!(valA,Float64(.00124))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["CAP00502"])
        push!(valA,Float64(.03973))
        push!(icA,iv)
        push!(irA,ig_["MXD00306"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-33.21))
        push!(icA,iv)
        push!(irA,ig_["MXD00304"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["MND00306"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00305"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["CAP00501"])
        push!(valA,Float64(.00331))
        push!(icA,iv)
        push!(irA,ig_["INV00302"])
        push!(valA,Float64(-1.18801))
        iv,ix_,_ = s2mpj_ii("Y00503",ix_)
        arrset(pb.xnames,iv,"Y00503")
        push!(icA,iv)
        push!(irA,ig_["MXD00303"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00402"])
        push!(valA,Float64(.03074))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00403"])
        push!(valA,Float64(.03341))
        iv,ix_,_ = s2mpj_ii("Y00504",ix_)
        arrset(pb.xnames,iv,"Y00504")
        push!(icA,iv)
        push!(irA,ig_["CAP00402"])
        push!(valA,Float64(.00134))
        push!(icA,iv)
        push!(irA,ig_["CAP06003"])
        push!(valA,Float64(.00225))
        iv,ix_,_ = s2mpj_ii("Y00504",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-28.74))
        push!(icA,iv)
        push!(irA,ig_["CAP00503"])
        push!(valA,Float64(.04304))
        iv,ix_,_ = s2mpj_ii("Y00505",ix_)
        arrset(pb.xnames,iv,"Y00505")
        push!(icA,iv)
        push!(irA,ig_["CAP06005"])
        push!(valA,Float64(.00133))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-27.28))
        iv,ix_,_ = s2mpj_ii("Y00505",ix_)
        arrset(pb.xnames,iv,"Y00505")
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00505"])
        push!(valA,Float64(.00159))
        iv,ix_,_ = s2mpj_ii("Y00505",ix_)
        arrset(pb.xnames,iv,"Y00505")
        push!(icA,iv)
        push!(irA,ig_["CAP00403"])
        push!(valA,Float64(.00129))
        push!(icA,iv)
        push!(irA,ig_["CAP00404"])
        push!(valA,Float64(.03346))
        iv,ix_,_ = s2mpj_ii("Y00505",ix_)
        arrset(pb.xnames,iv,"Y00505")
        push!(icA,iv)
        push!(irA,ig_["CAP00504"])
        push!(valA,Float64(.04145))
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        push!(valA,Float64(-1.30001))
        iv,ix_,_ = s2mpj_ii("Y00505",ix_)
        arrset(pb.xnames,iv,"Y00505")
        push!(icA,iv)
        push!(irA,ig_["MND00305"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00405"])
        push!(valA,Float64(.03753))
        iv,ix_,_ = s2mpj_ii("Y00506",ix_)
        arrset(pb.xnames,iv,"Y00506")
        push!(icA,iv)
        push!(irA,ig_["INV00306"])
        push!(valA,Float64(-1.40401))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-25.9))
        iv,ix_,_ = s2mpj_ii("Y00506",ix_)
        arrset(pb.xnames,iv,"Y00506")
        push!(icA,iv)
        push!(irA,ig_["CAP06005"])
        push!(valA,Float64(.00234))
        push!(icA,iv)
        push!(irA,ig_["CAP06006"])
        push!(valA,Float64(.00349))
        iv,ix_,_ = s2mpj_ii("Y00506",ix_)
        arrset(pb.xnames,iv,"Y00506")
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        push!(valA,Float64(-.05616))
        push!(icA,iv)
        push!(irA,ig_["CAP00406"])
        push!(valA,Float64(.03475))
        iv,ix_,_ = s2mpj_ii("Y00506",ix_)
        arrset(pb.xnames,iv,"Y00506")
        push!(icA,iv)
        push!(irA,ig_["CAP00506"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01702"])
        push!(valA,Float64(.03734))
        iv,ix_,_ = s2mpj_ii("Y00603",ix_)
        arrset(pb.xnames,iv,"Y00603")
        push!(icA,iv)
        push!(irA,ig_["INV00301"])
        push!(valA,Float64(-.054))
        push!(icA,iv)
        push!(irA,ig_["CAP06003"])
        push!(valA,Float64(.00124))
        iv,ix_,_ = s2mpj_ii("Y00603",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01603"])
        push!(valA,Float64(.03308))
        push!(icA,iv)
        push!(irA,ig_["CAP01703"])
        push!(valA,Float64(.03812))
        iv,ix_,_ = s2mpj_ii("Y00604",ix_)
        arrset(pb.xnames,iv,"Y00604")
        push!(icA,iv)
        push!(irA,ig_["MND00306"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01604"])
        push!(valA,Float64(.03185))
        push!(icA,iv)
        push!(irA,ig_["CAP01605"])
        push!(valA,Float64(.0029))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01705"])
        push!(valA,Float64(.03965))
        iv,ix_,_ = s2mpj_ii("Y00606",ix_)
        arrset(pb.xnames,iv,"Y00606")
        push!(icA,iv)
        push!(irA,ig_["CAP01605"])
        push!(valA,Float64(.0344))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["CAP00101"])
        push!(valA,Float64(.00217))
        push!(icA,iv)
        push!(irA,ig_["CAP06402"])
        push!(valA,Float64(.001))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["MND00404"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00405"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["MND00405"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00406"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["CAP06403"])
        push!(valA,Float64(.0009))
        push!(icA,iv)
        push!(irA,ig_["MXD00404"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["MXD00406"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00602"])
        push!(valA,Float64(-1.24142))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["MND00403"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00202"])
        push!(valA,Float64(.0111))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-87.07))
        push!(icA,iv)
        push!(irA,ig_["MXD00403"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["INV00601"])
        push!(valA,Float64(-.37243))
        push!(icA,iv)
        push!(irA,ig_["CAP00201"])
        push!(valA,Float64(.00264))
        iv,ix_,_ = s2mpj_ii("Y00703",ix_)
        arrset(pb.xnames,iv,"Y00703")
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.01192))
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00203"])
        push!(valA,Float64(.01215))
        iv,ix_,_ = s2mpj_ii("Y00704",ix_)
        arrset(pb.xnames,iv,"Y00704")
        push!(icA,iv)
        push!(irA,ig_["MND00405"])
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00602"])
        push!(valA,Float64(-.24828))
        iv,ix_,_ = s2mpj_ii("Y00704",ix_)
        arrset(pb.xnames,iv,"Y00704")
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.00108))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-82.66))
        iv,ix_,_ = s2mpj_ii("Y00704",ix_)
        arrset(pb.xnames,iv,"Y00704")
        push!(icA,iv)
        push!(irA,ig_["MND00406"])
        ...
        arrset(pb.xnames,iv,"Y00704")
        push!(icA,iv)
        push!(irA,ig_["INV00603"])
        push!(valA,Float64(-1.36556))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["INV00604"])
        push!(valA,Float64(-1.37476))
        push!(icA,iv)
        push!(irA,ig_["CAP00103"])
        push!(valA,Float64(.00104))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["MND00406"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-78.48))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["INV00603"])
        push!(valA,Float64(-.23909))
        push!(icA,iv)
        push!(irA,ig_["CAP06405"])
        push!(valA,Float64(.00094))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["CAP06404"])
        push!(valA,Float64(.00097))
        push!(icA,iv)
        push!(irA,ig_["MND00405"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00104"])
        push!(valA,Float64(.01305))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["CAP00204"])
        push!(valA,Float64(.01221))
        push!(icA,iv)
        push!(irA,ig_["CAP00203"])
        push!(valA,Float64(.00153))
        iv,ix_,_ = s2mpj_ii("Y00705",ix_)
        arrset(pb.xnames,iv,"Y00705")
        push!(icA,iv)
        push!(irA,ig_["MXD00406"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00106"])
        push!(valA,Float64(.01409))
        push!(icA,iv)
        push!(irA,ig_["CAP00104"])
        push!(valA,Float64(.00056))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["MND00406"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-74.51))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["CAP00105"])
        push!(valA,Float64(.01522))
        push!(icA,iv)
        push!(irA,ig_["CAP06406"])
        push!(valA,Float64(.00191))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["CAP06405"])
        push!(valA,Float64(.00104))
        push!(icA,iv)
        push!(irA,ig_["CAP00206"])
        push!(valA,Float64(.01374))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["INV00604"])
        push!(valA,Float64(-.19366))
        push!(icA,iv)
        push!(irA,ig_["CAP00205"])
        push!(valA,Float64(.01484))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["INV00606"])
        push!(valA,Float64(-1.61385))
        push!(icA,iv)
        push!(irA,ig_["CAP00204"])
        push!(valA,Float64(.0011))
        iv,ix_,_ = s2mpj_ii("Y00706",ix_)
        arrset(pb.xnames,iv,"Y00706")
        push!(icA,iv)
        push!(irA,ig_["MXD00406"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00605"])
        push!(valA,Float64(-1.74296))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MXD00503"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00602"])
        push!(valA,Float64(.01774))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["CAP06501"])
        push!(valA,Float64(.00033))
        push!(icA,iv)
        push!(irA,ig_["CAP00201"])
        push!(valA,Float64(.00241))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["INV00102"])
        push!(valA,Float64(-.64004))
        push!(icA,iv)
        push!(irA,ig_["MND00503"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        ...
        push!(valA,Float64(.00401))
        push!(icA,iv)
        push!(irA,ig_["CAP00601"])
        push!(valA,Float64(.01267))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MXD00505"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00506"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MND00504"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00101"])
        push!(valA,Float64(-.54157))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-4.06))
        push!(icA,iv)
        push!(irA,ig_["MXD00502"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MXD00504"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP06502"])
        push!(valA,Float64(.0023))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MND00502"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00506"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00802",ix_)
        arrset(pb.xnames,iv,"Y00802")
        push!(icA,iv)
        push!(irA,ig_["MND00505"])
        push!(valA,Float64(1.0))
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00103"])
        push!(valA,Float64(-.68169))
        iv,ix_,_ = s2mpj_ii("Y00803",ix_)
        arrset(pb.xnames,iv,"Y00803")
        push!(icA,iv)
        push!(irA,ig_["CAP00202"])
        push!(valA,Float64(.00222))
        push!(icA,iv)
        push!(irA,ig_["MND00503"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00803",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00102"])
        push!(valA,Float64(-.49991))
        push!(icA,iv)
        push!(irA,ig_["CAP00602"])
        push!(valA,Float64(.0117))
        iv,ix_,_ = s2mpj_ii("Y00803",ix_)
        arrset(pb.xnames,iv,"Y00803")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.86))
        push!(icA,iv)
        push!(irA,ig_["MXD00503"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00803",ix_)
        arrset(pb.xnames,iv,"Y00803")
        push!(icA,iv)
        push!(irA,ig_["CAP06503"])
        push!(valA,Float64(.00232))
        push!(icA,iv)
        push!(irA,ig_["CAP00203"])
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00603"])
        push!(valA,Float64(.01872))
        iv,ix_,_ = s2mpj_ii("Y00803",ix_)
        arrset(pb.xnames,iv,"Y00803")
        push!(icA,iv)
        push!(irA,ig_["MND00505"])
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00104"])
        push!(valA,Float64(-.68169))
        iv,ix_,_ = s2mpj_ii("Y00804",ix_)
        arrset(pb.xnames,iv,"Y00804")
        push!(icA,iv)
        push!(irA,ig_["CAP00604"])
        push!(valA,Float64(.01872))
        push!(icA,iv)
        push!(irA,ig_["CAP06503"])
        push!(valA,Float64(.0003))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00604"])
        push!(valA,Float64(.01126))
        push!(icA,iv)
        push!(irA,ig_["CAP06504"])
        push!(valA,Float64(.00029))
        iv,ix_,_ = s2mpj_ii("Y00805",ix_)
        arrset(pb.xnames,iv,"Y00805")
        push!(icA,iv)
        push!(irA,ig_["MND00505"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP06505"])
        push!(valA,Float64(.00233))
        iv,ix_,_ = s2mpj_ii("Y00805",ix_)
        arrset(pb.xnames,iv,"Y00805")
        push!(icA,iv)
        push!(irA,ig_["INV00104"])
        push!(valA,Float64(-.48139))
        push!(icA,iv)
        push!(irA,ig_["MND00506"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00805",ix_)
        arrset(pb.xnames,iv,"Y00805")
        push!(icA,iv)
        push!(irA,ig_["CAP00605"])
        push!(valA,Float64(.01915))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.48))
        iv,ix_,_ = s2mpj_ii("Y00805",ix_)
        arrset(pb.xnames,iv,"Y00805")
        push!(icA,iv)
        push!(irA,ig_["CAP00204"])
        push!(valA,Float64(.00214))
        push!(icA,iv)
        push!(irA,ig_["CAP00205"])
        push!(valA,Float64(.00428))
        iv,ix_,_ = s2mpj_ii("Y00805",ix_)
        arrset(pb.xnames,iv,"Y00805")
        push!(icA,iv)
        push!(irA,ig_["INV00105"])
        push!(valA,Float64(-.70021))
        iv,ix_,_ = s2mpj_ii("Y00806",ix_)
        arrset(pb.xnames,iv,"Y00806")
        push!(icA,iv)
        push!(irA,ig_["CAP00206"])
        push!(valA,Float64(.00642))
        push!(icA,iv)
        push!(irA,ig_["MXD00506"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y00806",ix_)
        ...
        arrset(pb.xnames,iv,"Y00806")
        push!(icA,iv)
        push!(irA,ig_["INV00106"])
        push!(valA,Float64(-1.1816))
        push!(icA,iv)
        push!(irA,ig_["CAP06506"])
        push!(valA,Float64(.00262))
        iv,ix_,_ = s2mpj_ii("Y00806",ix_)
        arrset(pb.xnames,iv,"Y00806")
        push!(icA,iv)
        push!(irA,ig_["CAP00606"])
        push!(valA,Float64(.03041))
        push!(icA,iv)
        push!(irA,ig_["INV00105"])
        push!(valA,Float64(-.51991))
        iv,ix_,_ = s2mpj_ii("Y00806",ix_)
        arrset(pb.xnames,iv,"Y00806")
        push!(icA,iv)
        push!(irA,ig_["CAP00205"])
        push!(valA,Float64(.00231))
        push!(icA,iv)
        push!(irA,ig_["CAP00605"])
        push!(valA,Float64(.01217))
        iv,ix_,_ = s2mpj_ii("Y00806",ix_)
        arrset(pb.xnames,iv,"Y00806")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        ...
        arrset(pb.xnames,iv,"Y00902")
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        push!(valA,Float64(.00401))
        push!(icA,iv)
        push!(irA,ig_["CAP01102"])
        push!(valA,Float64(.01774))
        iv,ix_,_ = s2mpj_ii("Y00902",ix_)
        arrset(pb.xnames,iv,"Y00902")
        push!(icA,iv)
        ...
        arrset(pb.xnames,iv,"Y00904")
        push!(icA,iv)
        push!(irA,ig_["CAP01004"])
        push!(valA,Float64(.0042))
        push!(icA,iv)
        push!(irA,ig_["CAP01104"])
        push!(valA,Float64(.01872))
        iv,ix_,_ = s2mpj_ii("Y00904",ix_)
        arrset(pb.xnames,iv,"Y00904")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["MXD00606"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00606"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["CAP06002"])
        push!(valA,Float64(.00699))
        push!(icA,iv)
        push!(irA,ig_["MND00603"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        push!(valA,Float64(.01383))
        push!(icA,iv)
        push!(irA,ig_["MXD00605"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["INV00202"])
        push!(valA,Float64(-1.2326))
        push!(icA,iv)
        push!(irA,ig_["INV00201"])
        push!(valA,Float64(-.22411))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["CAP01201"])
        push!(valA,Float64(.0013))
        push!(icA,iv)
        push!(irA,ig_["MND00604"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["MXD00603"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01001"])
        push!(valA,Float64(.00115))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-33.1))
        push!(icA,iv)
        push!(irA,ig_["MXD00604"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["MND00605"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01202"])
        push!(valA,Float64(.00995))
        iv,ix_,_ = s2mpj_ii("Y01003",ix_)
        arrset(pb.xnames,iv,"Y01003")
        push!(icA,iv)
        push!(irA,ig_["CAP06003"])
        push!(valA,Float64(.00384))
        iv,ix_,_ = s2mpj_ii("Y01004",ix_)
        arrset(pb.xnames,iv,"Y01004")
        push!(icA,iv)
        push!(irA,ig_["CAP01202"])
        push!(valA,Float64(.00043))
        push!(icA,iv)
        push!(irA,ig_["CAP01003"])
        push!(valA,Float64(.01498))
        iv,ix_,_ = s2mpj_ii("Y01004",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00202"])
        push!(valA,Float64(-.11205))
        iv,ix_,_ = s2mpj_ii("Y01004",ix_)
        arrset(pb.xnames,iv,"Y01004")
        push!(icA,iv)
        push!(irA,ig_["CAP01203"])
        push!(valA,Float64(.01082))
        push!(icA,iv)
        push!(irA,ig_["MND00604"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01004",ix_)
        ...
        push!(valA,Float64(.00384))
        push!(icA,iv)
        push!(irA,ig_["INV00203"])
        push!(valA,Float64(-1.34466))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP06004"])
        push!(valA,Float64(.00674))
        iv,ix_,_ = s2mpj_ii("Y01005",ix_)
        arrset(pb.xnames,iv,"Y01005")
        push!(icA,iv)
        push!(irA,ig_["CAP06005"])
        push!(valA,Float64(.0041))
        push!(icA,iv)
        push!(irA,ig_["CAP01203"])
        push!(valA,Float64(.00042))
        iv,ix_,_ = s2mpj_ii("Y01005",ix_)
        arrset(pb.xnames,iv,"Y01005")
        push!(icA,iv)
        push!(irA,ig_["INV00204"])
        push!(valA,Float64(-1.34881))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-29.83))
        iv,ix_,_ = s2mpj_ii("Y01005",ix_)
        arrset(pb.xnames,iv,"Y01005")
        push!(icA,iv)
        push!(irA,ig_["INV00203"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01204"])
        push!(valA,Float64(.01083))
        iv,ix_,_ = s2mpj_ii("Y01005",ix_)
        arrset(pb.xnames,iv,"Y01005")
        push!(icA,iv)
        push!(irA,ig_["MND00605"])
        ...
        arrset(pb.xnames,iv,"Y01006")
        push!(icA,iv)
        push!(irA,ig_["INV00206"])
        push!(valA,Float64(-1.45671))
        push!(icA,iv)
        push!(irA,ig_["INV00205"])
        push!(valA,Float64(-1.57325))
        iv,ix_,_ = s2mpj_ii("Y01006",ix_)
        arrset(pb.xnames,iv,"Y01006")
        push!(icA,iv)
        push!(irA,ig_["CAP06005"])
        push!(valA,Float64(.00727))
        push!(icA,iv)
        push!(irA,ig_["CAP01205"])
        push!(valA,Float64(.01215))
        iv,ix_,_ = s2mpj_ii("Y01006",ix_)
        arrset(pb.xnames,iv,"Y01006")
        push!(icA,iv)
        push!(irA,ig_["CAP01005"])
        push!(valA,Float64(.01558))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-28.32))
        iv,ix_,_ = s2mpj_ii("Y01006",ix_)
        arrset(pb.xnames,iv,"Y01006")
        push!(icA,iv)
        push!(irA,ig_["INV00204"])
        push!(valA,Float64(-.05827))
        push!(icA,iv)
        push!(irA,ig_["CAP01006"])
        push!(valA,Float64(.01498))
        iv,ix_,_ = s2mpj_ii("Y01006",ix_)
        arrset(pb.xnames,iv,"Y01006")
        push!(icA,iv)
        push!(irA,ig_["CAP01206"])
        push!(valA,Float64(.01125))
        push!(icA,iv)
        push!(irA,ig_["CAP06006"])
        push!(valA,Float64(.01084))
        ...
        push!(icA,iv)
        push!(irA,ig_["MND00705"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00703"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["INV00402"])
        push!(valA,Float64(-.86606))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP06301"])
        push!(valA,Float64(.00002))
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        push!(valA,Float64(.0004))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["MXD00702"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00706"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["MND00702"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00705"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["MND00703"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00704"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["MXD00704"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01201"])
        push!(valA,Float64(.00186))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["CAP01202"])
        push!(valA,Float64(.00706))
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        ...
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["MXD00706"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00401"])
        push!(valA,Float64(-.28869))
        iv,ix_,_ = s2mpj_ii("Y01202",ix_)
        arrset(pb.xnames,iv,"Y01202")
        push!(icA,iv)
        push!(irA,ig_["CAP01001"])
        push!(valA,Float64(.00198))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01203"])
        push!(valA,Float64(.0072))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-5.32))
        iv,ix_,_ = s2mpj_ii("Y01203",ix_)
        arrset(pb.xnames,iv,"Y01203")
        push!(icA,iv)
        push!(irA,ig_["MXD00704"])
        ...
        arrset(pb.xnames,iv,"Y01203")
        push!(icA,iv)
        push!(irA,ig_["INV00403"])
        push!(valA,Float64(-.88827))
        push!(icA,iv)
        push!(irA,ig_["MND00705"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01203",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        push!(valA,Float64(.00183))
        push!(icA,iv)
        push!(irA,ig_["INV00402"])
        push!(valA,Float64(-.26648))
        iv,ix_,_ = s2mpj_ii("Y01203",ix_)
        arrset(pb.xnames,iv,"Y01203")
        push!(icA,iv)
        push!(irA,ig_["CAP06302"])
        ...
        push!(valA,Float64(.00727))
        push!(icA,iv)
        push!(irA,ig_["INV00405"])
        push!(valA,Float64(-.89814))
        iv,ix_,_ = s2mpj_ii("Y01205",ix_)
        arrset(pb.xnames,iv,"Y01205")
        push!(icA,iv)
        push!(irA,ig_["MND00705"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-4.79))
        iv,ix_,_ = s2mpj_ii("Y01205",ix_)
        arrset(pb.xnames,iv,"Y01205")
        push!(icA,iv)
        push!(irA,ig_["INV00404"])
        push!(valA,Float64(-.25661))
        iv,ix_,_ = s2mpj_ii("Y01206",ix_)
        arrset(pb.xnames,iv,"Y01206")
        push!(icA,iv)
        push!(irA,ig_["CAP01205"])
        push!(valA,Float64(.00178))
        push!(icA,iv)
        push!(irA,ig_["CAP01005"])
        push!(valA,Float64(.0019))
        iv,ix_,_ = s2mpj_ii("Y01206",ix_)
        arrset(pb.xnames,iv,"Y01206")
        push!(icA,iv)
        push!(irA,ig_["CAP06306"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01206"])
        push!(valA,Float64(.00892))
        iv,ix_,_ = s2mpj_ii("Y01206",ix_)
        arrset(pb.xnames,iv,"Y01206")
        push!(icA,iv)
        push!(irA,ig_["CAP01006"])
        push!(valA,Float64(.01188))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-4.55))
        iv,ix_,_ = s2mpj_ii("Y01206",ix_)
        arrset(pb.xnames,iv,"Y01206")
        push!(icA,iv)
        push!(irA,ig_["INV00406"])
        push!(valA,Float64(-1.15475))
        push!(icA,iv)
        push!(irA,ig_["MND00706"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01206",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["MND00803"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00802"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["MND00802"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00803"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["CAP01001"])
        push!(valA,Float64(.00412))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-5.46))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["MXD00805"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["INV00502"])
        push!(valA,Float64(-.7014))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["CAP06201"])
        push!(valA,Float64(.00083))
        push!(icA,iv)
        push!(irA,ig_["CAP06202"])
        push!(valA,Float64(.00442))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["MND00805"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP06102"])
        push!(valA,Float64(.00066))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["INV00501"])
        push!(valA,Float64(-.501))
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        push!(valA,Float64(.00824))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["CAP01202"])
        push!(valA,Float64(.0058))
        push!(icA,iv)
        push!(irA,ig_["MXD00806"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["CAP01201"])
        push!(valA,Float64(.00348))
        push!(icA,iv)
        push!(irA,ig_["CAP06101"])
        push!(valA,Float64(.00006))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["MND00806"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00804"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01402",ix_)
        arrset(pb.xnames,iv,"Y01402")
        push!(icA,iv)
        push!(irA,ig_["MXD00804"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["CAP01003"])
        push!(valA,Float64(.00856))
        push!(icA,iv)
        push!(irA,ig_["MXD00805"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-5.18))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["CAP06202"])
        push!(valA,Float64(.00077))
        push!(icA,iv)
        push!(irA,ig_["CAP01203"])
        push!(valA,Float64(.00607))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["CAP06102"])
        ...
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["CAP06203"])
        push!(valA,Float64(.00449))
        push!(icA,iv)
        push!(irA,ig_["INV00502"])
        push!(valA,Float64(-.46246))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["MXD00803"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP06103"])
        push!(valA,Float64(.00067))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["CAP01202"])
        push!(valA,Float64(.00321))
        push!(icA,iv)
        push!(irA,ig_["CAP01002"])
        push!(valA,Float64(.0038))
        iv,ix_,_ = s2mpj_ii("Y01403",ix_)
        arrset(pb.xnames,iv,"Y01403")
        push!(icA,iv)
        push!(irA,ig_["INV00503"])
        push!(valA,Float64(-.73994))
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00504"])
        push!(valA,Float64(-.44534))
        push!(icA,iv)
        push!(irA,ig_["CAP01205"])
        push!(valA,Float64(.00619))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        arrset(pb.xnames,iv,"Y01405")
        push!(icA,iv)
        push!(irA,ig_["CAP01005"])
        push!(valA,Float64(.0087))
        push!(icA,iv)
        push!(irA,ig_["INV00505"])
        push!(valA,Float64(-.75707))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        arrset(pb.xnames,iv,"Y01405")
        push!(icA,iv)
        push!(irA,ig_["CAP06105"])
        push!(valA,Float64(.00067))
        push!(icA,iv)
        push!(irA,ig_["CAP06204"])
        push!(valA,Float64(.00074))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        arrset(pb.xnames,iv,"Y01405")
        push!(icA,iv)
        push!(irA,ig_["MND00805"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01004"])
        push!(valA,Float64(.00366))
        push!(icA,iv)
        push!(irA,ig_["CAP01204"])
        push!(valA,Float64(.0031))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        arrset(pb.xnames,iv,"Y01405")
        push!(icA,iv)
        push!(irA,ig_["CAP06104"])
        push!(valA,Float64(.00005))
        push!(icA,iv)
        push!(irA,ig_["MND00806"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        arrset(pb.xnames,iv,"Y01405")
        push!(icA,iv)
        push!(irA,ig_["CAP06205"])
        push!(valA,Float64(.00452))
        push!(icA,iv)
        push!(irA,ig_["MXD00806"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01405",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01006"])
        push!(valA,Float64(.01237))
        push!(icA,iv)
        push!(irA,ig_["CAP06205"])
        push!(valA,Float64(.0008))
        iv,ix_,_ = s2mpj_ii("Y01406",ix_)
        arrset(pb.xnames,iv,"Y01406")
        push!(icA,iv)
        push!(irA,ig_["INV00505"])
        push!(valA,Float64(-.48096))
        push!(icA,iv)
        push!(irA,ig_["MXD00806"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01406",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00506"])
        push!(valA,Float64(-1.20241))
        iv,ix_,_ = s2mpj_ii("Y01406",ix_)
        arrset(pb.xnames,iv,"Y01406")
        push!(icA,iv)
        push!(irA,ig_["CAP06106"])
        push!(valA,Float64(.00072))
        push!(icA,iv)
        push!(irA,ig_["MND00806"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01406",ix_)
        arrset(pb.xnames,iv,"Y01406")
        push!(icA,iv)
        push!(irA,ig_["CAP06206"])
        push!(valA,Float64(.00525))
        push!(icA,iv)
        push!(irA,ig_["CAP01005"])
        push!(valA,Float64(.00396))
        iv,ix_,_ = s2mpj_ii("Y01406",ix_)
        arrset(pb.xnames,iv,"Y01406")
        push!(icA,iv)
        push!(irA,ig_["CAP01205"])
        push!(valA,Float64(.00334))
        ...
        push!(icA,iv)
        push!(irA,ig_["MND00904"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND00906"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["MXD00903"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD00904"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.99))
        push!(icA,iv)
        push!(irA,ig_["MND00903"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["CAP00802"])
        push!(valA,Float64(.00063))
        push!(icA,iv)
        push!(irA,ig_["MXD00906"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        ...
        push!(valA,Float64(.00002))
        push!(icA,iv)
        push!(irA,ig_["MXD00905"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["MXD00902"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00101"])
        push!(valA,Float64(.00131))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["MND00905"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.00654))
        iv,ix_,_ = s2mpj_ii("Y01602",ix_)
        arrset(pb.xnames,iv,"Y01602")
        push!(icA,iv)
        push!(irA,ig_["CAP00801"])
        push!(valA,Float64(.00017))
        iv,ix_,_ = s2mpj_ii("Y01603",ix_)
        arrset(pb.xnames,iv,"Y01603")
        push!(icA,iv)
        push!(irA,ig_["CAP00102"])
        push!(valA,Float64(.00121))
        push!(icA,iv)
        push!(irA,ig_["MXD00903"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01603",ix_)
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00803"])
        push!(valA,Float64(.00065))
        iv,ix_,_ = s2mpj_ii("Y01603",ix_)
        arrset(pb.xnames,iv,"Y01603")
        push!(icA,iv)
        push!(irA,ig_["INV00402"])
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.59))
        push!(icA,iv)
        push!(irA,ig_["CAP00804"])
        push!(valA,Float64(.00065))
        iv,ix_,_ = s2mpj_ii("Y01604",ix_)
        arrset(pb.xnames,iv,"Y01604")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.24))
        iv,ix_,_ = s2mpj_ii("Y01606",ix_)
        arrset(pb.xnames,iv,"Y01606")
        push!(icA,iv)
        push!(irA,ig_["CAP00805"])
        push!(valA,Float64(.00016))
        push!(icA,iv)
        push!(irA,ig_["MND00906"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01606",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP00902"])
        push!(valA,Float64(.00654))
        push!(icA,iv)
        push!(irA,ig_["CAP01301"])
        push!(valA,Float64(.00017))
        iv,ix_,_ = s2mpj_ii("Y01702",ix_)
        arrset(pb.xnames,iv,"Y01702")
        push!(icA,iv)
        ...
        arrset(pb.xnames,iv,"Y01702")
        push!(icA,iv)
        push!(irA,ig_["CAP01302"])
        push!(valA,Float64(.00063))
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.97))
        iv,ix_,_ = s2mpj_ii("Y01702",ix_)
        arrset(pb.xnames,iv,"Y01702")
        push!(icA,iv)
        push!(irA,ig_["MND00903"])
        ...
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP00903"])
        push!(valA,Float64(.00664))
        iv,ix_,_ = s2mpj_ii("Y01703",ix_)
        arrset(pb.xnames,iv,"Y01703")
        push!(icA,iv)
        push!(irA,ig_["CAP01303"])
        push!(valA,Float64(.00065))
        ...
        push!(valA,Float64(.00121))
        push!(icA,iv)
        push!(irA,ig_["CAP01304"])
        push!(valA,Float64(.00065))
        iv,ix_,_ = s2mpj_ii("Y01704",ix_)
        arrset(pb.xnames,iv,"Y01704")
        push!(icA,iv)
        push!(irA,ig_["CAP00904"])
        push!(valA,Float64(.00664))
        push!(icA,iv)
        push!(irA,ig_["MXD00904"])
        push!(valA,Float64(1.0))
        ...
        push!(valA,Float64(.00002))
        push!(icA,iv)
        push!(irA,ig_["CAP01802"])
        push!(valA,Float64(.00071))
        iv,ix_,_ = s2mpj_ii("Y01802",ix_)
        arrset(pb.xnames,iv,"Y01802")
        push!(icA,iv)
        push!(irA,ig_["MXD00903"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01402"])
        push!(valA,Float64(.00662))
        push!(icA,iv)
        push!(irA,ig_["INV00402"])
        push!(valA,Float64(-1.0104))
        iv,ix_,_ = s2mpj_ii("Y01802",ix_)
        arrset(pb.xnames,iv,"Y01802")
        push!(icA,iv)
        push!(irA,ig_["CAP01801"])
        push!(valA,Float64(.00009))
        push!(icA,iv)
        push!(irA,ig_["MXD00902"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01802",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01405"])
        push!(valA,Float64(.00671))
        push!(icA,iv)
        push!(irA,ig_["INV00405"])
        push!(valA,Float64(-1.02644))
        iv,ix_,_ = s2mpj_ii("Y01805",ix_)
        arrset(pb.xnames,iv,"Y01805")
        push!(icA,iv)
        push!(irA,ig_["CAP01804"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01406"])
        push!(valA,Float64(.00739))
        push!(icA,iv)
        push!(irA,ig_["CAP01806"])
        push!(valA,Float64(.0008))
        iv,ix_,_ = s2mpj_ii("Y01806",ix_)
        arrset(pb.xnames,iv,"Y01806")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-3.67))
        push!(icA,iv)
        push!(irA,ig_["MXD01004"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01902",ix_)
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        push!(irA,ig_["MXD01006"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP06201"])
        push!(valA,Float64(.00083))
        ...
        push!(valA,Float64(.00006))
        push!(icA,iv)
        push!(irA,ig_["MND01006"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01902",ix_)
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        push!(irA,ig_["CAP01302"])
        push!(valA,Float64(.00052))
        push!(icA,iv)
        push!(irA,ig_["MND01004"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01902",ix_)
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        push!(irA,ig_["MND01005"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["CAP01301"])
        push!(valA,Float64(.00031))
        ...
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        push!(irA,ig_["MND01003"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MXD01003"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01902",ix_)
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        push!(irA,ig_["MXD01002"])
        push!(valA,Float64(1.0))
        push!(icA,iv)
        push!(irA,ig_["MND01002"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01902",ix_)
        arrset(pb.xnames,iv,"Y01902")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01303"])
        push!(valA,Float64(.00054))
        iv,ix_,_ = s2mpj_ii("Y01903",ix_)
        arrset(pb.xnames,iv,"Y01903")
        push!(icA,iv)
        push!(irA,ig_["CAP00902"])
        push!(valA,Float64(.00251))
        push!(icA,iv)
        push!(irA,ig_["MND01004"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y01903",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(-2.99))
        iv,ix_,_ = s2mpj_ii("Y01906",ix_)
        arrset(pb.xnames,iv,"Y01906")
        push!(icA,iv)
        push!(irA,ig_["CAP00905"])
        push!(valA,Float64(.00261))
        push!(icA,iv)
        push!(irA,ig_["CAP06106"])
        push!(valA,Float64(.00072))
        iv,ix_,_ = s2mpj_ii("Y01906",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00502"])
        push!(valA,Float64(-.85171))
        iv,ix_,_ = s2mpj_ii("Y02002",ix_)
        arrset(pb.xnames,iv,"Y02002")
        push!(icA,iv)
        push!(irA,ig_["CAP01402"])
        push!(valA,Float64(.00561))
        push!(icA,iv)
        push!(irA,ig_["MXD01002"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("Y02002",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01403"])
        push!(valA,Float64(.00577))
        push!(icA,iv)
        push!(irA,ig_["CAP01802"])
        push!(valA,Float64(.00022))
        iv,ix_,_ = s2mpj_ii("Y02003",ix_)
        arrset(pb.xnames,iv,"Y02003")
        push!(icA,iv)
        push!(irA,ig_["INV00502"])
        push!(valA,Float64(-.32373))
        push!(icA,iv)
        push!(irA,ig_["INV00503"])
        push!(valA,Float64(-.87868))
        iv,ix_,_ = s2mpj_ii("Y02003",ix_)
        arrset(pb.xnames,iv,"Y02003")
        push!(icA,iv)
        push!(irA,ig_["MXD01003"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01804"])
        push!(valA,Float64(.00021))
        iv,ix_,_ = s2mpj_ii("Y02005",ix_)
        arrset(pb.xnames,iv,"Y02005")
        push!(icA,iv)
        push!(irA,ig_["INV00505"])
        push!(valA,Float64(-.89067))
        push!(icA,iv)
        push!(irA,ig_["CAP06204"])
        push!(valA,Float64(.00074))
        iv,ix_,_ = s2mpj_ii("Y02005",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00504"])
        push!(valA,Float64(-.31174))
        push!(icA,iv)
        push!(irA,ig_["CAP01405"])
        push!(valA,Float64(.00585))
        iv,ix_,_ = s2mpj_ii("Y02005",ix_)
        arrset(pb.xnames,iv,"Y02005")
        push!(icA,iv)
        push!(irA,ig_["CAP01404"])
        push!(valA,Float64(.00185))
        push!(icA,iv)
        push!(irA,ig_["CAP06105"])
        push!(valA,Float64(.00067))
        iv,ix_,_ = s2mpj_ii("Y02005",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01405"])
        push!(valA,Float64(.002))
        push!(icA,iv)
        push!(irA,ig_["CAP01406"])
        push!(valA,Float64(.0077))
        iv,ix_,_ = s2mpj_ii("Y02006",ix_)
        arrset(pb.xnames,iv,"Y02006")
        push!(icA,iv)
        push!(irA,ig_["CAP06205"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.00677))
        push!(icA,iv)
        push!(irA,ig_["CAP01903"])
        push!(valA,Float64(.02109))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP03101"])
        push!(valA,Float64(.0033))
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.0013))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP02001"])
        push!(valA,Float64(.00072))
        push!(icA,iv)
        push!(irA,ig_["CAP02002"])
        push!(valA,Float64(.00936))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP02102"])
        push!(valA,Float64(.00546))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.0395))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP01902"])
        push!(valA,Float64(.01285))
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.01142))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.04825))
        push!(icA,iv)
        push!(irA,ig_["CAP02501"])
        push!(valA,Float64(.00294))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP02701"])
        push!(valA,Float64(.00356))
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.10013))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["CAP02802"])
        push!(valA,Float64(.06479))
        push!(icA,iv)
        push!(irA,ig_["CAP02502"])
        push!(valA,Float64(.01241))
        iv,ix_,_ = s2mpj_ii("X00103",ix_)
        arrset(pb.xnames,iv,"X00103")
        push!(icA,iv)
        push!(irA,ig_["INV00103"])
        push!(valA,Float64(280.0))
        push!(icA,iv)
        push!(irA,ig_["CAP03102"])
        push!(valA,Float64(.08414))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00947))
        push!(icA,iv)
        push!(irA,ig_["CAP02002"])
        push!(valA,Float64(.00042))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.00521))
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.00226))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02503"])
        push!(valA,Float64(.01324))
        push!(icA,iv)
        push!(irA,ig_["CAP03102"])
        push!(valA,Float64(.0021))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["INV00104"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01903"])
        push!(valA,Float64(.01226))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02502"])
        push!(valA,Float64(.00211))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.08241))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.09784))
        push!(icA,iv)
        push!(irA,ig_["CAP01904"])
        push!(valA,Float64(.02167))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02104"])
        push!(valA,Float64(.00702))
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.05183))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02804"])
        push!(valA,Float64(.01437))
        push!(icA,iv)
        push!(irA,ig_["CAP03104"])
        push!(valA,Float64(.04242))
        iv,ix_,_ = s2mpj_ii("X00104",ix_)
        arrset(pb.xnames,iv,"X00104")
        push!(icA,iv)
        push!(irA,ig_["CAP02004"])
        push!(valA,Float64(.00149))
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.06185))
        iv,ix_,_ = s2mpj_ii("X00105",ix_)
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.09897))
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.00113))
        iv,ix_,_ = s2mpj_ii("X00105",ix_)
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP01904"])
        ...
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP02504"])
        push!(valA,Float64(.01394))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.00105))
        iv,ix_,_ = s2mpj_ii("X00105",ix_)
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP03105"])
        push!(valA,Float64(.04242))
        push!(icA,iv)
        push!(irA,ig_["CAP02804"])
        push!(valA,Float64(.06185))
        ...
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP02805"])
        push!(valA,Float64(.01437))
        push!(icA,iv)
        push!(irA,ig_["CAP03104"])
        push!(valA,Float64(.08346))
        iv,ix_,_ = s2mpj_ii("X00105",ix_)
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP01905"])
        push!(valA,Float64(.02167))
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00016))
        ...
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP02005"])
        push!(valA,Float64(.00149))
        push!(icA,iv)
        push!(irA,ig_["CAP02105"])
        push!(valA,Float64(.00702))
        iv,ix_,_ = s2mpj_ii("X00105",ix_)
        arrset(pb.xnames,iv,"X00105")
        push!(icA,iv)
        push!(irA,ig_["CAP02004"])
        push!(valA,Float64(.00973))
        push!(icA,iv)
        push!(irA,ig_["INV00105"])
        push!(valA,Float64(280.0))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03105"])
        push!(valA,Float64(.08854))
        push!(icA,iv)
        push!(irA,ig_["CAP02705"])
        push!(valA,Float64(.10487))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["INV00106"])
        ...
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP02505"])
        push!(valA,Float64(.01608))
        push!(icA,iv)
        push!(irA,ig_["CAP01906"])
        push!(valA,Float64(.03394))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP02006"])
        push!(valA,Float64(.01139))
        push!(icA,iv)
        push!(irA,ig_["CAP03106"])
        push!(valA,Float64(.12694))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP02106"])
        push!(valA,Float64(.01223))
        push!(icA,iv)
        push!(irA,ig_["CAP02506"])
        push!(valA,Float64(.01535))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP02806"])
        push!(valA,Float64(.07621))
        push!(icA,iv)
        push!(irA,ig_["CAP02706"])
        push!(valA,Float64(.15193))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP02105"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02504"])
        push!(valA,Float64(.00148))
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.00119))
        iv,ix_,_ = s2mpj_ii("X00106",ix_)
        arrset(pb.xnames,iv,"X00106")
        push!(icA,iv)
        push!(irA,ig_["CAP01905"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02102"])
        push!(valA,Float64(.00766))
        push!(icA,iv)
        push!(irA,ig_["CAP01903"])
        push!(valA,Float64(.01492))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00051))
        push!(icA,iv)
        push!(irA,ig_["CAP02701"])
        push!(valA,Float64(.00333))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02501"])
        push!(valA,Float64(.00296))
        push!(icA,iv)
        push!(irA,ig_["CAP02502"])
        push!(valA,Float64(.01161))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP03203"])
        push!(valA,Float64(.01487))
        push!(icA,iv)
        push!(irA,ig_["CAP03101"])
        push!(valA,Float64(.00008))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02002"])
        push!(valA,Float64(.0098))
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.00459))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02303"])
        push!(valA,Float64(.0206))
        push!(icA,iv)
        push!(irA,ig_["CAP01902"])
        push!(valA,Float64(.01768))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02603"])
        push!(valA,Float64(.02157))
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.02094))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.00342))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.03082))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02001"])
        push!(valA,Float64(.00079))
        push!(icA,iv)
        push!(irA,ig_["CAP03102"])
        push!(valA,Float64(.06879))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["INV00203"])
        push!(valA,Float64(75.0))
        push!(icA,iv)
        push!(irA,ig_["CAP03202"])
        push!(valA,Float64(.02505))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02802"])
        push!(valA,Float64(.01722))
        push!(icA,iv)
        push!(irA,ig_["CAP02602"])
        push!(valA,Float64(.02373))
        iv,ix_,_ = s2mpj_ii("X00203",ix_)
        arrset(pb.xnames,iv,"X00203")
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.08608))
        push!(icA,iv)
        push!(irA,ig_["CAP02302"])
        push!(valA,Float64(.01551))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP03203"])
        push!(valA,Float64(.02391))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.06574))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP03204"])
        push!(valA,Float64(.01601))
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.01644))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.08418))
        push!(icA,iv)
        push!(irA,ig_["CAP03104"])
        push!(valA,Float64(.03395))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP02603"])
        push!(valA,Float64(.02265))
        push!(icA,iv)
        push!(irA,ig_["CAP02503"])
        push!(valA,Float64(.01241))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02303"])
        push!(valA,Float64(.01481))
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.00731))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00987))
        push!(icA,iv)
        push!(irA,ig_["CAP02002"])
        push!(valA,Float64(.0005))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP01903"])
        push!(valA,Float64(.01688))
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.00217))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP01904"])
        push!(valA,Float64(.01572))
        push!(icA,iv)
        push!(irA,ig_["CAP02304"])
        push!(valA,Float64(.02131))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP02104"])
        push!(valA,Float64(.00494))
        push!(icA,iv)
        push!(irA,ig_["CAP02004"])
        push!(valA,Float64(.00073))
        iv,ix_,_ = s2mpj_ii("X00204",ix_)
        arrset(pb.xnames,iv,"X00204")
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.024))
        iv,ix_,_ = s2mpj_ii("X00205",ix_)
        arrset(pb.xnames,iv,"X00205")
        push!(icA,iv)
        push!(irA,ig_["CAP02503"])
        push!(valA,Float64(.0015))
        push!(icA,iv)
        push!(irA,ig_["CAP02705"])
        push!(valA,Float64(.024))
        iv,ix_,_ = s2mpj_ii("X00205",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03206"])
        push!(valA,Float64(.03992))
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.00122))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP02805"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02505"])
        push!(valA,Float64(.01526))
        push!(icA,iv)
        push!(irA,ig_["CAP02005"])
        push!(valA,Float64(.01086))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP02705"])
        push!(valA,Float64(.09047))
        push!(icA,iv)
        push!(irA,ig_["CAP02004"])
        push!(valA,Float64(.00026))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP02105"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02504"])
        push!(valA,Float64(.00157))
        push!(icA,iv)
        push!(irA,ig_["CAP02806"])
        push!(valA,Float64(.02064))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP03105"])
        push!(valA,Float64(.06887))
        push!(icA,iv)
        push!(irA,ig_["CAP02506"])
        push!(valA,Float64(.01457))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP01906"])
        push!(valA,Float64(.0326))
        push!(icA,iv)
        push!(irA,ig_["CAP02306"])
        push!(valA,Float64(.03611))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP02706"])
        push!(valA,Float64(.11036))
        push!(icA,iv)
        push!(irA,ig_["CAP02606"])
        push!(valA,Float64(.04529))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP02006"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02106"])
        push!(valA,Float64(.01225))
        iv,ix_,_ = s2mpj_ii("X00206",ix_)
        arrset(pb.xnames,iv,"X00206")
        push!(icA,iv)
        push!(irA,ig_["CAP03106"])
        push!(valA,Float64(.09969))
        push!(icA,iv)
        push!(irA,ig_["CAP03205"])
        push!(valA,Float64(.02505))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03002"])
        push!(valA,Float64(.00998))
        push!(icA,iv)
        push!(irA,ig_["CAP02501"])
        push!(valA,Float64(.00285))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02202"])
        push!(valA,Float64(.12349))
        push!(icA,iv)
        push!(irA,ig_["CAP02403"])
        push!(valA,Float64(.00837))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        push!(valA,Float64(43.0))
        push!(icA,iv)
        push!(irA,ig_["CAP02903"])
        push!(valA,Float64(.00719))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02201"])
        push!(valA,Float64(.00077))
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.00392))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02502"])
        push!(valA,Float64(.01187))
        push!(icA,iv)
        push!(irA,ig_["CAP02902"])
        push!(valA,Float64(.01593))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02603"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.11034))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        push!(valA,Float64(.02005))
        push!(icA,iv)
        push!(irA,ig_["CAP02001"])
        push!(valA,Float64(.00079))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02802"])
        push!(valA,Float64(.01664))
        push!(icA,iv)
        push!(irA,ig_["CAP02203"])
        push!(valA,Float64(.02513))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02102"])
        push!(valA,Float64(.02041))
        push!(icA,iv)
        push!(irA,ig_["CAP02002"])
        push!(valA,Float64(.00977))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00054))
        push!(icA,iv)
        push!(irA,ig_["CAP03003"])
        push!(valA,Float64(.01077))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP03202"])
        push!(valA,Float64(.01831))
        push!(icA,iv)
        push!(irA,ig_["CAP02701"])
        push!(valA,Float64(.00576))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP03102"])
        push!(valA,Float64(.00594))
        push!(icA,iv)
        push!(irA,ig_["CAP02402"])
        push!(valA,Float64(.01363))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP02602"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.02973))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP03203"])
        push!(valA,Float64(.02077))
        push!(icA,iv)
        push!(irA,ig_["CAP01902"])
        push!(valA,Float64(.01255))
        iv,ix_,_ = s2mpj_ii("X00303",ix_)
        arrset(pb.xnames,iv,"X00303")
        push!(icA,iv)
        push!(irA,ig_["CAP01903"])
        push!(valA,Float64(.01979))
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.01198))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02502"])
        push!(valA,Float64(.00205))
        push!(icA,iv)
        push!(irA,ig_["CAP02204"])
        push!(valA,Float64(.03078))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02703"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02104"])
        push!(valA,Float64(.03066))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02903"])
        push!(valA,Float64(.0152))
        push!(icA,iv)
        push!(irA,ig_["CAP02404"])
        push!(valA,Float64(.00899))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02702"])
        push!(valA,Float64(.00376))
        push!(icA,iv)
        push!(irA,ig_["CAP03204"])
        push!(valA,Float64(.0216))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02004"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03003"])
        push!(valA,Float64(.00953))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02803"])
        push!(valA,Float64(.01589))
        push!(icA,iv)
        push!(irA,ig_["CAP03203"])
        push!(valA,Float64(.01748))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP03103"])
        push!(valA,Float64(.00567))
        push!(icA,iv)
        push!(irA,ig_["CAP02403"])
        push!(valA,Float64(.01301))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        ...
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02904"])
        push!(valA,Float64(.00791))
        push!(icA,iv)
        push!(irA,ig_["CAP02804"])
        push!(valA,Float64(.00467))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02003"])
        push!(valA,Float64(.00983))
        push!(icA,iv)
        push!(irA,ig_["CAP03104"])
        push!(valA,Float64(.01225))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02103"])
        push!(valA,Float64(.01948))
        push!(icA,iv)
        push!(irA,ig_["CAP02203"])
        push!(valA,Float64(.11861))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.02409))
        push!(icA,iv)
        push!(irA,ig_["CAP03004"])
        push!(valA,Float64(.01122))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["CAP01904"])
        push!(valA,Float64(.02036))
        push!(icA,iv)
        push!(irA,ig_["CAP02604"])
        push!(valA,Float64(.02873))
        iv,ix_,_ = s2mpj_ii("X00304",ix_)
        arrset(pb.xnames,iv,"X00304")
        push!(icA,iv)
        push!(irA,ig_["INV00304"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02504"])
        push!(valA,Float64(.01333))
        iv,ix_,_ = s2mpj_ii("X00305",ix_)
        arrset(pb.xnames,iv,"X00305")
        push!(icA,iv)
        push!(irA,ig_["CAP02205"])
        push!(valA,Float64(.03078))
        push!(icA,iv)
        push!(irA,ig_["CAP02904"])
        push!(valA,Float64(.0152))
        ...
        arrset(pb.xnames,iv,"X00305")
        push!(icA,iv)
        push!(irA,ig_["CAP02905"])
        push!(valA,Float64(.00791))
        push!(icA,iv)
        push!(irA,ig_["CAP02405"])
        push!(valA,Float64(.00899))
        iv,ix_,_ = s2mpj_ii("X00305",ix_)
        arrset(pb.xnames,iv,"X00305")
        push!(icA,iv)
        push!(irA,ig_["CAP03005"])
        push!(valA,Float64(.01122))
        push!(icA,iv)
        push!(irA,ig_["CAP02805"])
        push!(valA,Float64(.00467))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03206"])
        push!(valA,Float64(.03908))
        push!(icA,iv)
        push!(irA,ig_["CAP03006"])
        push!(valA,Float64(.02075))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02106"])
        push!(valA,Float64(.05014))
        push!(icA,iv)
        push!(irA,ig_["CAP02206"])
        push!(valA,Float64(.14939))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP03106"])
        push!(valA,Float64(.01793))
        push!(icA,iv)
        push!(irA,ig_["CAP02705"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02704"])
        push!(valA,Float64(.00265))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02806"])
        push!(valA,Float64(.02056))
        push!(icA,iv)
        push!(irA,ig_["CAP02006"])
        push!(valA,Float64(.0111))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        ...
        push!(valA,Float64(.00026))
        push!(icA,iv)
        push!(irA,ig_["CAP02906"])
        push!(valA,Float64(.02312))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02606"])
        push!(valA,Float64(.04408))
        push!(icA,iv)
        push!(irA,ig_["CAP02505"])
        push!(valA,Float64(.01542))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02005"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP02506"])
        push!(valA,Float64(.01472))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02406"])
        push!(valA,Float64(.02201))
        push!(icA,iv)
        push!(irA,ig_["CAP02205"])
        push!(valA,Float64(.12425))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP02706"])
        push!(valA,Float64(.13616))
        push!(icA,iv)
        push!(irA,ig_["CAP02504"])
        push!(valA,Float64(.00145))
        iv,ix_,_ = s2mpj_ii("X00306",ix_)
        arrset(pb.xnames,iv,"X00306")
        push!(icA,iv)
        push!(irA,ig_["CAP01905"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04703"])
        push!(valA,Float64(.01583))
        push!(icA,iv)
        push!(irA,ig_["CAP04403"])
        push!(valA,Float64(.01286))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04603"])
        push!(valA,Float64(.00104))
        push!(icA,iv)
        push!(irA,ig_["CAP04503"])
        push!(valA,Float64(.01688))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04402"])
        push!(valA,Float64(.00521))
        push!(icA,iv)
        push!(irA,ig_["CAP03301"])
        push!(valA,Float64(.00006))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04102"])
        push!(valA,Float64(.0117))
        push!(icA,iv)
        push!(irA,ig_["CAP03702"])
        push!(valA,Float64(.03304))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP03402"])
        push!(valA,Float64(.02558))
        push!(icA,iv)
        push!(irA,ig_["CAP03802"])
        push!(valA,Float64(.02733))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04002"])
        push!(valA,Float64(.01621))
        push!(icA,iv)
        push!(irA,ig_["CAP05403"])
        push!(valA,Float64(.01089))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP05303"])
        push!(valA,Float64(.00591))
        push!(icA,iv)
        push!(irA,ig_["CAP04903"])
        push!(valA,Float64(.00431))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04202"])
        push!(valA,Float64(.01126))
        push!(icA,iv)
        push!(irA,ig_["CAP05103"])
        push!(valA,Float64(.00439))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP05003"])
        push!(valA,Float64(.00685))
        push!(icA,iv)
        push!(irA,ig_["CAP04302"])
        push!(valA,Float64(.02743))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP03803"])
        push!(valA,Float64(.01706))
        push!(icA,iv)
        push!(irA,ig_["CAP04103"])
        push!(valA,Float64(.0005))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP03703"])
        push!(valA,Float64(.00362))
        push!(icA,iv)
        push!(irA,ig_["CAP03302"])
        push!(valA,Float64(.01548))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04502"])
        push!(valA,Float64(.02252))
        push!(icA,iv)
        push!(irA,ig_["CAP04203"])
        push!(valA,Float64(.02393))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04003"])
        push!(valA,Float64(.02556))
        push!(icA,iv)
        push!(irA,ig_["CAP03403"])
        push!(valA,Float64(.03192))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04602"])
        push!(valA,Float64(.01566))
        push!(icA,iv)
        push!(irA,ig_["CAP03303"])
        push!(valA,Float64(.00255))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04702"])
        push!(valA,Float64(.01004))
        push!(icA,iv)
        push!(irA,ig_["CAP04303"])
        push!(valA,Float64(.00576))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP05402"])
        push!(valA,Float64(.00786))
        push!(icA,iv)
        push!(irA,ig_["CAP05302"])
        push!(valA,Float64(.01148))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04601"])
        push!(valA,Float64(.00027))
        push!(icA,iv)
        push!(irA,ig_["CAP05102"])
        push!(valA,Float64(.0132))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP05002"])
        push!(valA,Float64(.01633))
        push!(icA,iv)
        push!(irA,ig_["INV00303"])
        push!(valA,Float64(153.0))
        iv,ix_,_ = s2mpj_ii("X00403",ix_)
        arrset(pb.xnames,iv,"X00403")
        push!(icA,iv)
        push!(irA,ig_["CAP04902"])
        push!(valA,Float64(.01393))
        push!(icA,iv)
        push!(irA,ig_["CAP04101"])
        push!(valA,Float64(.00047))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP05004"])
        push!(valA,Float64(.00685))
        push!(icA,iv)
        push!(irA,ig_["CAP05103"])
        push!(valA,Float64(.0132))
        ...
        push!(valA,Float64(.02733))
        push!(icA,iv)
        push!(irA,ig_["CAP05104"])
        push!(valA,Float64(.00439))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP04904"])
        push!(valA,Float64(.00431))
        push!(icA,iv)
        push!(irA,ig_["CAP04704"])
        push!(valA,Float64(.01583))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        ...
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP05304"])
        push!(valA,Float64(.00591))
        push!(icA,iv)
        push!(irA,ig_["CAP05404"])
        push!(valA,Float64(.01089))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03303"])
        push!(valA,Float64(.01554))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP03804"])
        push!(valA,Float64(.01706))
        push!(icA,iv)
        push!(irA,ig_["CAP04203"])
        push!(valA,Float64(.01126))
        ...
        push!(valA,Float64(153.0))
        push!(icA,iv)
        push!(irA,ig_["CAP03404"])
        push!(valA,Float64(.03192))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP04304"])
        push!(valA,Float64(.00576))
        push!(icA,iv)
        push!(irA,ig_["CAP04603"])
        push!(valA,Float64(.01593))
        ...
        push!(valA,Float64(.01621))
        push!(icA,iv)
        push!(irA,ig_["CAP03304"])
        push!(valA,Float64(.00255))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP04104"])
        push!(valA,Float64(.0005))
        push!(icA,iv)
        push!(irA,ig_["CAP04503"])
        push!(valA,Float64(.02252))
        ...
        push!(valA,Float64(.01217))
        push!(icA,iv)
        push!(irA,ig_["CAP03704"])
        push!(valA,Float64(.00362))
        iv,ix_,_ = s2mpj_ii("X00404",ix_)
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP04604"])
        push!(valA,Float64(.00104))
        push!(icA,iv)
        push!(irA,ig_["CAP04903"])
        push!(valA,Float64(.01393))
        ...
        arrset(pb.xnames,iv,"X00404")
        push!(icA,iv)
        push!(irA,ig_["CAP04004"])
        push!(valA,Float64(.02556))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        push!(valA,Float64(.00313))
        push!(icA,iv)
        push!(irA,ig_["CAP04505"])
        push!(valA,Float64(.01772))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03304"])
        push!(valA,Float64(.01496))
        push!(icA,iv)
        push!(irA,ig_["CAP04004"])
        push!(valA,Float64(.01561))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03804"])
        push!(valA,Float64(.02632))
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.00678))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        push!(valA,Float64(.01306))
        push!(icA,iv)
        push!(irA,ig_["CAP04105"])
        push!(valA,Float64(.00095))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03405"])
        push!(valA,Float64(.03287))
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.00485))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03805"])
        push!(valA,Float64(.01807))
        push!(icA,iv)
        push!(irA,ig_["CAP03404"])
        push!(valA,Float64(.02464))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04005"])
        push!(valA,Float64(.02616))
        push!(icA,iv)
        push!(irA,ig_["CAP04205"])
        push!(valA,Float64(.02435))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.00488))
        push!(icA,iv)
        push!(irA,ig_["CAP04604"])
        push!(valA,Float64(.01534))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04704"])
        push!(valA,Float64(.00967))
        push!(icA,iv)
        push!(irA,ig_["CAP04904"])
        push!(valA,Float64(.01341))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP05004"])
        push!(valA,Float64(.01573))
        push!(icA,iv)
        push!(irA,ig_["CAP04504"])
        push!(valA,Float64(.02169))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["INV00305"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05104"])
        push!(valA,Float64(.01271))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04404"])
        push!(valA,Float64(.00502))
        push!(icA,iv)
        push!(irA,ig_["CAP05304"])
        push!(valA,Float64(.01106))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP05404"])
        push!(valA,Float64(.00757))
        push!(icA,iv)
        push!(irA,ig_["CAP04605"])
        push!(valA,Float64(.00163))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04304"])
        push!(valA,Float64(.02642))
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.01118))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP05305"])
        push!(valA,Float64(.00634))
        push!(icA,iv)
        push!(irA,ig_["CAP04204"])
        push!(valA,Float64(.01084))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP05005"])
        push!(valA,Float64(.00745))
        push!(icA,iv)
        push!(irA,ig_["CAP04905"])
        push!(valA,Float64(.00483))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP04104"])
        push!(valA,Float64(.01172))
        push!(icA,iv)
        push!(irA,ig_["CAP04705"])
        push!(valA,Float64(.0162))
        iv,ix_,_ = s2mpj_ii("X00405",ix_)
        arrset(pb.xnames,iv,"X00405")
        push!(icA,iv)
        push!(irA,ig_["CAP03704"])
        push!(valA,Float64(.03181))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        push!(valA,Float64(.00542))
        push!(icA,iv)
        push!(irA,ig_["CAP05305"])
        push!(valA,Float64(.01194))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.01373))
        push!(icA,iv)
        push!(irA,ig_["CAP05005"])
        push!(valA,Float64(.01699))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04905"])
        push!(valA,Float64(.01448))
        push!(icA,iv)
        push!(irA,ig_["CAP04705"])
        push!(valA,Float64(.01044))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04605"])
        push!(valA,Float64(.01656))
        push!(icA,iv)
        push!(irA,ig_["CAP04505"])
        push!(valA,Float64(.02342))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.02853))
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.00817))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04005"])
        push!(valA,Float64(.01686))
        push!(icA,iv)
        push!(irA,ig_["CAP04906"])
        push!(valA,Float64(.01824))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.03436))
        push!(icA,iv)
        push!(irA,ig_["CAP03405"])
        push!(valA,Float64(.02661))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP03306"])
        push!(valA,Float64(.01809))
        push!(icA,iv)
        push!(irA,ig_["CAP04406"])
        push!(valA,Float64(.01808))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04706"])
        push!(valA,Float64(.02586))
        push!(icA,iv)
        push!(irA,ig_["CAP04606"])
        push!(valA,Float64(.01696))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04506"])
        push!(valA,Float64(.0394))
        push!(icA,iv)
        push!(irA,ig_["CAP05006"])
        push!(valA,Float64(.02318))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP05106"])
        push!(valA,Float64(.01759))
        push!(icA,iv)
        push!(irA,ig_["CAP05306"])
        push!(valA,Float64(.0174))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP05406"])
        push!(valA,Float64(.01875))
        push!(icA,iv)
        push!(irA,ig_["CAP04306"])
        push!(valA,Float64(.03319))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        push!(valA,Float64(.01616))
        push!(icA,iv)
        push!(irA,ig_["CAP04206"])
        push!(valA,Float64(.03519))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP04106"])
        push!(valA,Float64(.01267))
        push!(icA,iv)
        push!(irA,ig_["CAP04006"])
        push!(valA,Float64(.04177))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP03806"])
        push!(valA,Float64(.04439))
        push!(icA,iv)
        push!(irA,ig_["CAP03706"])
        push!(valA,Float64(.03666))
        iv,ix_,_ = s2mpj_ii("X00406",ix_)
        arrset(pb.xnames,iv,"X00406")
        push!(icA,iv)
        push!(irA,ig_["CAP03406"])
        push!(valA,Float64(.05751))
        push!(icA,iv)
        push!(irA,ig_["CAP03805"])
        push!(valA,Float64(.02843))
        ...
        push!(valA,Float64(.00376))
        push!(icA,iv)
        push!(irA,ig_["CAP03902"])
        push!(valA,Float64(.00969))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP03301"])
        push!(valA,Float64(.00093))
        push!(icA,iv)
        push!(irA,ig_["CAP03802"])
        push!(valA,Float64(.01945))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05102"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04102"])
        push!(valA,Float64(.01116))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP04203"])
        push!(valA,Float64(.0244))
        push!(icA,iv)
        push!(irA,ig_["CAP04402"])
        push!(valA,Float64(.00496))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP04202"])
        push!(valA,Float64(.00978))
        push!(icA,iv)
        push!(irA,ig_["CAP05703"])
        push!(valA,Float64(.02434))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP03502"])
        push!(valA,Float64(.01463))
        push!(icA,iv)
        push!(irA,ig_["CAP03302"])
        push!(valA,Float64(.01962))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05903"])
        push!(valA,Float64(.02055))
        push!(icA,iv)
        push!(irA,ig_["CAP03903"])
        push!(valA,Float64(.0079))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP04602"])
        push!(valA,Float64(.01478))
        push!(icA,iv)
        push!(irA,ig_["CAP03701"])
        push!(valA,Float64(.0026))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP03402"])
        push!(valA,Float64(.0313))
        push!(icA,iv)
        push!(irA,ig_["CAP05803"])
        push!(valA,Float64(.01677))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP03803"])
        push!(valA,Float64(.0227))
        push!(icA,iv)
        push!(irA,ig_["CAP04303"])
        push!(valA,Float64(.00396))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04403"])
        push!(valA,Float64(.01299))
        push!(icA,iv)
        push!(irA,ig_["CAP03702"])
        push!(valA,Float64(.0251))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP04302"])
        push!(valA,Float64(.02908))
        push!(icA,iv)
        push!(irA,ig_["CAP05302"])
        push!(valA,Float64(.01822))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP04301"])
        push!(valA,Float64(.00012))
        push!(icA,iv)
        push!(irA,ig_["CAP05303"])
        push!(valA,Float64(.01977))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP03503"])
        push!(valA,Float64(.03477))
        push!(icA,iv)
        push!(irA,ig_["CAP05902"])
        push!(valA,Float64(.01455))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["INV00503"])
        push!(valA,Float64(424.0))
        push!(icA,iv)
        push!(irA,ig_["CAP05103"])
        push!(valA,Float64(.00539))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05402"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04601"])
        push!(valA,Float64(.00258))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05502"])
        push!(valA,Float64(.01259))
        push!(icA,iv)
        push!(irA,ig_["CAP05501"])
        push!(valA,Float64(.00229))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05602"])
        push!(valA,Float64(.02266))
        push!(icA,iv)
        push!(irA,ig_["CAP04101"])
        push!(valA,Float64(.00203))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05702"])
        push!(valA,Float64(.01024))
        push!(icA,iv)
        push!(irA,ig_["CAP03403"])
        push!(valA,Float64(.04854))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05403"])
        push!(valA,Float64(.01247))
        push!(icA,iv)
        push!(irA,ig_["CAP05802"])
        push!(valA,Float64(.01936))
        iv,ix_,_ = s2mpj_ii("X00703",ix_)
        arrset(pb.xnames,iv,"X00703")
        push!(icA,iv)
        push!(irA,ig_["CAP05603"])
        push!(valA,Float64(.01208))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04303"])
        push!(valA,Float64(.0292))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP03703"])
        push!(valA,Float64(.02723))
        push!(icA,iv)
        push!(irA,ig_["CAP05403"])
        push!(valA,Float64(.00542))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        ...
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP05704"])
        push!(valA,Float64(.02434))
        push!(icA,iv)
        push!(irA,ig_["CAP03504"])
        push!(valA,Float64(.03477))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP03302"])
        push!(valA,Float64(.00045))
        push!(icA,iv)
        push!(irA,ig_["CAP05604"])
        push!(valA,Float64(.01208))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP04103"])
        push!(valA,Float64(.01218))
        push!(icA,iv)
        push!(irA,ig_["CAP05404"])
        push!(valA,Float64(.01247))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        ...
        push!(valA,Float64(.0313))
        push!(icA,iv)
        push!(irA,ig_["CAP05503"])
        push!(valA,Float64(.01374))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP04102"])
        push!(valA,Float64(.00101))
        push!(icA,iv)
        push!(irA,ig_["CAP04403"])
        push!(valA,Float64(.00496))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04603"])
        push!(valA,Float64(.01612))
        push!(icA,iv)
        push!(irA,ig_["CAP05904"])
        push!(valA,Float64(.02055))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        arrset(pb.xnames,iv,"X00704")
        push!(icA,iv)
        push!(irA,ig_["CAP03303"])
        push!(valA,Float64(.0201))
        push!(icA,iv)
        push!(irA,ig_["CAP03804"])
        push!(valA,Float64(.0227))
        iv,ix_,_ = s2mpj_ii("X00704",ix_)
        ...
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05605"])
        push!(valA,Float64(.01292))
        push!(icA,iv)
        push!(irA,ig_["CAP05704"])
        push!(valA,Float64(.00986))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["INV00505"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.00571))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05904"])
        push!(valA,Float64(.01401))
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.01267))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05905"])
        push!(valA,Float64(.02109))
        push!(icA,iv)
        push!(irA,ig_["CAP03704"])
        push!(valA,Float64(.02668))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05705"])
        push!(valA,Float64(.02472))
        push!(icA,iv)
        push!(irA,ig_["CAP03904"])
        push!(valA,Float64(.00933))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05804"])
        push!(valA,Float64(.01864))
        push!(icA,iv)
        push!(irA,ig_["CAP05805"])
        push!(valA,Float64(.01749))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP04204"])
        push!(valA,Float64(.00942))
        push!(icA,iv)
        push!(irA,ig_["CAP05503"])
        push!(valA,Float64(.0011))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03804"])
        push!(valA,Float64(.01873))
        push!(icA,iv)
        push!(irA,ig_["CAP05305"])
        push!(valA,Float64(.02044))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05404"])
        push!(valA,Float64(.00522))
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        push!(valA,Float64(.00429))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP04604"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.00504))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03304"])
        push!(valA,Float64(.01958))
        push!(icA,iv)
        push!(irA,ig_["CAP04205"])
        push!(valA,Float64(.02476))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03703"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05104"])
        push!(valA,Float64(.0083))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03905"])
        push!(valA,Float64(.00826))
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        push!(valA,Float64(.01317))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03805"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04603"])
        push!(valA,Float64(.0012))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03405"])
        push!(valA,Float64(.0497))
        push!(icA,iv)
        push!(irA,ig_["CAP03505"])
        push!(valA,Float64(.03531))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP04304"])
        push!(valA,Float64(.02812))
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.00057))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05604"])
        push!(valA,Float64(.02182))
        push!(icA,iv)
        push!(irA,ig_["CAP04103"])
        push!(valA,Float64(.00098))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP04404"])
        push!(valA,Float64(.00477))
        push!(icA,iv)
        push!(irA,ig_["CAP03404"])
        push!(valA,Float64(.03014))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP05504"])
        push!(valA,Float64(.01378))
        push!(icA,iv)
        push!(irA,ig_["CAP05304"])
        push!(valA,Float64(.01755))
        iv,ix_,_ = s2mpj_ii("X00705",ix_)
        arrset(pb.xnames,iv,"X00705")
        push!(icA,iv)
        push!(irA,ig_["CAP03504"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05406"])
        push!(valA,Float64(.01789))
        push!(icA,iv)
        push!(irA,ig_["CAP05906"])
        push!(valA,Float64(.0351))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP04406"])
        push!(valA,Float64(.01795))
        push!(icA,iv)
        push!(irA,ig_["CAP03306"])
        push!(valA,Float64(.0243))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05306"])
        push!(valA,Float64(.03799))
        push!(icA,iv)
        push!(irA,ig_["CAP05506"])
        push!(valA,Float64(.01488))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05106"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04106"])
        push!(valA,Float64(.01319))
        push!(icA,iv)
        push!(irA,ig_["CAP03806"])
        push!(valA,Float64(.04215))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05806"])
        push!(valA,Float64(.03613))
        push!(icA,iv)
        push!(irA,ig_["CAP03906"])
        push!(valA,Float64(.01759))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        ...
        push!(valA,Float64(.00022))
        push!(icA,iv)
        push!(irA,ig_["CAP05706"])
        push!(valA,Float64(.03458))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP03506"])
        push!(valA,Float64(.0494))
        push!(icA,iv)
        push!(irA,ig_["CAP04306"])
        push!(valA,Float64(.03316))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP03406"])
        push!(valA,Float64(.07984))
        push!(icA,iv)
        push!(irA,ig_["CAP04606"])
        push!(valA,Float64(.01736))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP04206"])
        push!(valA,Float64(.03418))
        push!(icA,iv)
        push!(irA,ig_["CAP05606"])
        push!(valA,Float64(.03474))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["INV00506"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.0293))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.00564))
        push!(icA,iv)
        push!(irA,ig_["CAP05305"])
        push!(valA,Float64(.01895))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        push!(valA,Float64(.02162))
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.00897))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP03405"])
        push!(valA,Float64(.03255))
        push!(icA,iv)
        push!(irA,ig_["CAP03505"])
        push!(valA,Float64(.01522))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03805"])
        push!(valA,Float64(.02023))
        push!(icA,iv)
        push!(irA,ig_["CAP05505"])
        push!(valA,Float64(.01607))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP03905"])
        push!(valA,Float64(.01007))
        push!(icA,iv)
        push!(irA,ig_["CAP04105"])
        push!(valA,Float64(.01425))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP04205"])
        push!(valA,Float64(.01017))
        push!(icA,iv)
        push!(irA,ig_["CAP04605"])
        push!(valA,Float64(.01875))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.03037))
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        push!(valA,Float64(.00515))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP04604"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04104"])
        push!(valA,Float64(.00053))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05605"])
        push!(valA,Float64(.02356))
        push!(icA,iv)
        push!(irA,ig_["CAP05705"])
        push!(valA,Float64(.01065))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05504"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05905"])
        push!(valA,Float64(.01513))
        iv,ix_,_ = s2mpj_ii("X00706",ix_)
        arrset(pb.xnames,iv,"X00706")
        push!(icA,iv)
        push!(irA,ig_["CAP05805"])
        push!(valA,Float64(.02013))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05103"])
        push!(valA,Float64(.00692))
        push!(icA,iv)
        push!(irA,ig_["CAP05102"])
        push!(valA,Float64(.02245))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04403"])
        push!(valA,Float64(.01289))
        push!(icA,iv)
        push!(irA,ig_["CAP03701"])
        push!(valA,Float64(.00081))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05203"])
        push!(valA,Float64(.0323))
        push!(icA,iv)
        push!(irA,ig_["CAP05002"])
        push!(valA,Float64(.01034))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05403"])
        push!(valA,Float64(.01151))
        push!(icA,iv)
        push!(irA,ig_["CAP04902"])
        push!(valA,Float64(.01364))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04601"])
        push!(valA,Float64(.00097))
        push!(icA,iv)
        push!(irA,ig_["CAP03603"])
        push!(valA,Float64(.01934))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05903"])
        push!(valA,Float64(.02063))
        push!(icA,iv)
        push!(irA,ig_["CAP05902"])
        push!(valA,Float64(.01835))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04903"])
        push!(valA,Float64(.00453))
        push!(icA,iv)
        push!(irA,ig_["CAP04803"])
        push!(valA,Float64(.00494))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05802"])
        push!(valA,Float64(.02611))
        push!(icA,iv)
        push!(irA,ig_["CAP05702"])
        push!(valA,Float64(.01309))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05602"])
        push!(valA,Float64(.03388))
        push!(icA,iv)
        push!(irA,ig_["CAP05402"])
        push!(valA,Float64(.00679))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04101"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04603"])
        push!(valA,Float64(.00037))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP05603"])
        push!(valA,Float64(.00898))
        push!(icA,iv)
        push!(irA,ig_["CAP05202"])
        push!(valA,Float64(.01958))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP03703"])
        push!(valA,Float64(.00397))
        push!(icA,iv)
        push!(irA,ig_["CAP05003"])
        push!(valA,Float64(.00678))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["INV00603"])
        push!(valA,Float64(26.0))
        push!(icA,iv)
        push!(irA,ig_["CAP03303"])
        push!(valA,Float64(.00271))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP03302"])
        push!(valA,Float64(.01518))
        push!(icA,iv)
        push!(irA,ig_["CAP04103"])
        push!(valA,Float64(.00002))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP03602"])
        push!(valA,Float64(.03149))
        push!(icA,iv)
        push!(irA,ig_["CAP04602"])
        push!(valA,Float64(.01598))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04402"])
        push!(valA,Float64(.00529))
        push!(icA,iv)
        push!(irA,ig_["CAP03702"])
        push!(valA,Float64(.05747))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP03301"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05803"])
        push!(valA,Float64(.01413))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04102"])
        push!(valA,Float64(.01196))
        push!(icA,iv)
        push!(irA,ig_["CAP04302"])
        push!(valA,Float64(.03242))
        iv,ix_,_ = s2mpj_ii("X00803",ix_)
        arrset(pb.xnames,iv,"X00803")
        push!(icA,iv)
        push!(irA,ig_["CAP04802"])
        push!(valA,Float64(.01307))
        push!(icA,iv)
        push!(irA,ig_["CAP05703"])
        push!(valA,Float64(.02476))
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05604"])
        push!(valA,Float64(.03262))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP04605"])
        push!(valA,Float64(.00099))
        push!(icA,iv)
        push!(irA,ig_["CAP04104"])
        push!(valA,Float64(.01246))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05704"])
        push!(valA,Float64(.0126))
        push!(icA,iv)
        push!(irA,ig_["CAP04604"])
        push!(valA,Float64(.01632))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05804"])
        push!(valA,Float64(.02515))
        push!(icA,iv)
        push!(irA,ig_["CAP04804"])
        push!(valA,Float64(.01258))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.00609))
        push!(icA,iv)
        push!(irA,ig_["INV00605"])
        push!(valA,Float64(26.0))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05904"])
        push!(valA,Float64(.01767))
        push!(icA,iv)
        push!(irA,ig_["CAP04404"])
        push!(valA,Float64(.0051))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03304"])
        push!(valA,Float64(.01493))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.00776))
        push!(icA,iv)
        push!(irA,ig_["CAP05805"])
        push!(valA,Float64(.0151))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP03604"])
        push!(valA,Float64(.03033))
        push!(icA,iv)
        push!(irA,ig_["CAP05205"])
        push!(valA,Float64(.03303))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP03605"])
        push!(valA,Float64(.0205))
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        push!(valA,Float64(.00328))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05005"])
        push!(valA,Float64(.00717))
        push!(icA,iv)
        push!(irA,ig_["CAP05104"])
        push!(valA,Float64(.02161))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP03704"])
        push!(valA,Float64(.05612))
        push!(icA,iv)
        push!(irA,ig_["CAP05004"])
        push!(valA,Float64(.00996))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05204"])
        push!(valA,Float64(.01886))
        push!(icA,iv)
        push!(irA,ig_["CAP04304"])
        push!(valA,Float64(.03122))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.00613))
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.01176))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP04904"])
        push!(valA,Float64(.01313))
        push!(icA,iv)
        push!(irA,ig_["CAP04905"])
        push!(valA,Float64(.00503))
        iv,ix_,_ = s2mpj_ii("X00805",ix_)
        arrset(pb.xnames,iv,"X00805")
        push!(icA,iv)
        push!(irA,ig_["CAP05605"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP05705"])
        push!(valA,Float64(.02525))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05705"])
        push!(valA,Float64(.01361))
        push!(icA,iv)
        push!(irA,ig_["CAP04805"])
        push!(valA,Float64(.01359))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05805"])
        push!(valA,Float64(.02716))
        push!(icA,iv)
        push!(irA,ig_["CAP05605"])
        push!(valA,Float64(.03523))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05405"])
        push!(valA,Float64(.00707))
        push!(icA,iv)
        push!(irA,ig_["CAP05205"])
        push!(valA,Float64(.02037))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05105"])
        push!(valA,Float64(.02334))
        push!(icA,iv)
        push!(irA,ig_["CAP05005"])
        push!(valA,Float64(.01076))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04905"])
        push!(valA,Float64(.01418))
        push!(icA,iv)
        push!(irA,ig_["CAP04605"])
        push!(valA,Float64(.01763))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05905"])
        push!(valA,Float64(.01908))
        push!(icA,iv)
        push!(irA,ig_["CAP04405"])
        push!(valA,Float64(.00551))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04305"])
        push!(valA,Float64(.03372))
        push!(icA,iv)
        push!(irA,ig_["CAP04105"])
        push!(valA,Float64(.01346))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP03705"])
        push!(valA,Float64(.06061))
        push!(icA,iv)
        push!(irA,ig_["CAP03605"])
        push!(valA,Float64(.03275))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP03305"])
        ...
        push!(icA,iv)
        push!(irA,ig_["CAP03306"])
        push!(valA,Float64(.01821))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04906"])
        push!(valA,Float64(.01817))
        push!(icA,iv)
        push!(irA,ig_["CAP05806"])
        push!(valA,Float64(.04025))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05706"])
        push!(valA,Float64(.03785))
        push!(icA,iv)
        push!(irA,ig_["CAP05606"])
        push!(valA,Float64(.04286))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05406"])
        push!(valA,Float64(.01831))
        push!(icA,iv)
        push!(irA,ig_["CAP05206"])
        push!(valA,Float64(.05189))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP05106"])
        push!(valA,Float64(.02937))
        push!(icA,iv)
        push!(irA,ig_["CAP05006"])
        push!(valA,Float64(.01713))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04806"])
        push!(valA,Float64(.018))
        push!(icA,iv)
        push!(irA,ig_["CAP05906"])
        push!(valA,Float64(.03898))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04606"])
        push!(valA,Float64(.01732))
        push!(icA,iv)
        push!(irA,ig_["CAP04406"])
        push!(valA,Float64(.01818))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP04306"])
        push!(valA,Float64(.03731))
        push!(icA,iv)
        push!(irA,ig_["CAP04106"])
        push!(valA,Float64(.01296))
        iv,ix_,_ = s2mpj_ii("X00806",ix_)
        arrset(pb.xnames,iv,"X00806")
        push!(icA,iv)
        push!(irA,ig_["CAP03706"])
        push!(valA,Float64(.06226))
        push!(icA,iv)
        push!(irA,ig_["CAP03606"])
        push!(valA,Float64(.05083))
        iv,ix_,_ = s2mpj_ii("I00101",ix_)
        arrset(pb.xnames,iv,"I00101")
        push!(icA,iv)
        push!(irA,ig_["OBJECTIV"])
        push!(valA,Float64(100.08))
        push!(icA,iv)
        push!(irA,ig_["INV00102"])
        push!(valA,Float64(1.0))
        iv,ix_,_ = s2mpj_ii("I00101",ix_)
