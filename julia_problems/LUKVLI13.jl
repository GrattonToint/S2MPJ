function LUKVLI13(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling LUKVLI13.")
    end
...
# IE N                   99998          $-PARAMETER
        ...
        for I = Int64(v_["1"]):Int64(v_["(N-2)/3"])
            pbm.gconst[ig_["OBJ1"*string(I)]] = Float64(1.0)
        end
        for K = Int64(v_["1"]):Int64(v_["2"]):Int64(v_["NC"])
            v_["K+1"] = 1+K
            pbm.gconst[ig_["C"*string(K)]] = Float64(5.0)
            pbm.gconst[ig_["C"*string(Int64(v_["K+1"]))]] = Float64(3.0)
        end
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I = Int64(v_["2"]):Int64(v_["3"]):Int64(v_["N"])
            pb.x0[ix_["X"*string(I)]] = Float64(5.0)
        end
