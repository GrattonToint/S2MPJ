function TOINTGOR(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling TOINTGOR.")
    end
...
# ********************
    ...
    elseif action == "g_globs"
        ...
        pbm = args[1]
        arrset(pbm.gfpar,1,1.0e0)    # this is  ONE
        arrset(pbm.gfpar,2,0.0e0)    # this is  ZERO
        return pbm
