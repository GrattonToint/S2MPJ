function HS11(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS11.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["OBJ"]] = Float64(25.0)
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        if haskey(ix_,"X1")
            pb.x0[ix_["X1"]] = Float64(4.9)
        else
            pb.y0[findfirst(x->x==ig_["X1"],pbm.congrps)] = Float64(4.9)
        end
        if haskey(ix_,"X2")
        ...
        posep = findfirst(x->x=="SH",elftp[ielftype[ie]])
