function OET5(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OET5.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["0"]):Int64(v_["M"])
            ...
            pbm.gconst[ig_["LO"*string(I)]] = Float64(v_["-SQRTW"])
            pbm.gconst[ig_["UP"*string(I)]] = Float64(v_["SQRTW"])
        end
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
    ...
    elseif action == "eQUAD"
        ...
        if nargout>1
            ...
            g_[1] = 2.0*TERM*W2
            g_[2] = 2.0*TERM*pbm.elpar[iel_][1]
            g_[3] = 2.0*TERM
            if nargout>2
