function DECONVBNE(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling DECONVBNE.")
    end
    ...
    if action == "setup"
        ...
        for K = Int64(v_["1"]):Int64(v_["LGTR"])
            ...
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"R"*string(K))
        end
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = length(ix_)
        ngrp   = length(ig_)
        ...
        for I = Int64(v_["1"]):Int64(v_["LGSG"])
            ...
            pb.xupper[ix_["SG"*string(I)]] = v_["PIC"]
        end
