...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        arrset(pbm.elftype,ie,"T3")
        arrset(ielftype, ie, iet_["T3"])
        vname = "A"
        ...
        ename = "EB"
        ie,ie_,_  = s2x_ii(ename,ie_)
        arrset(pbm.elftype,ie,"T2")
        arrset(ielftype, ie, iet_["T2"])
        vname = "A"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,nothing,nothing)
        posev = findfirst(x->x=="AA",elftv[ielftype[ie]])
        loaset(pbm.elvar,ie,posev,iv)
        ...
        ename = "EC"
        ie,ie_,_  = s2x_ii(ename,ie_)
        arrset(pbm.elftype,ie,"T1")
        arrset(ielftype, ie, iet_["T1"])
        vname = "A"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,nothing,nothing)
        posev = findfirst(x->x=="AA",elftv[ielftype[ie]])
        loaset(pbm.elvar,ie,posev,iv)
        ...
        ename = "ED"
        ie,ie_,_  = s2x_ii(ename,ie_)
        arrset(pbm.elftype,ie,"T4")
        arrset(ielftype, ie, iet_["T4"])
        vname = "A"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,nothing,nothing)
        posev = findfirst(x->x=="AA",elftv[ielftype[ie]])
        loaset(pbm.elvar,ie,posev,iv)
        ...
        ename = "EE"
        ie,ie_,_  = s2x_ii(ename,ie_)
        arrset(pbm.elftype,ie,"T5")
        arrset(ielftype, ie, iet_["T5"])
        vname = "A"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,nothing,nothing)
        posev = findfirst(x->x=="AA",elftv[ielftype[ie]])
        loaset(pbm.elvar,ie,posev,iv)
