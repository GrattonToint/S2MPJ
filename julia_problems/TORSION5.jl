function TORSION5(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling TORSION5.")
    end
...
# IE Q                   61             $-PARAMETER n= 14884
        if nargin<2
            v_["C"] = Float64(20.0);  #  SIF file default value
        else
            v_["C"] = Float64(args[2]);
        end
        v_["Q+1"] = 1+v_["Q"]
