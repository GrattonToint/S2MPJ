function HATFLDCNE(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HATFLDCNE.")
    end
    ...
    if action == "setup"
        ...
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"G"*string(Int64(v_["N"])))
        push!(irA,ig)
        ...
        for I = Int64(v_["2"]):Int64(v_["N-1"])
            ...
            vname = "X"*string(I)
            iv,ix_,pb = s2mpj_nlx(vname,ix_,pb,1,nothing,Float64(10.0),Float64(0.9))
