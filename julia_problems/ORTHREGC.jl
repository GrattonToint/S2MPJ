function ORTHREGC(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling ORTHREGC.")
    end
...
# IE NPTS                50000          $-PARAMETER n= 100005
        ...
        if haskey(ix_,"G1")
            pb.x0[ix_["G1"]] = Float64(1.0)
        else
            pb.y0[findfirst(x->x==ig_["G1"],pbm.congrps)] = Float64(1.0)
        end
        if haskey(ix_,"G2")
            pb.x0[ix_["G2"]] = Float64(1.0)
        else
            pb.y0[findfirst(x->x==ig_["G2"],pbm.congrps)] = Float64(1.0)
        end
        for I = Int64(v_["1"]):Int64(v_["NPTS"])
