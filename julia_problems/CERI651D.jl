...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        if haskey(ix_,"I")
            ...
            pb.y0[findfirst(x->x==ig_["I"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[15.1595],pbm.congrps)]
        end
        if haskey(ix_,"S")
            pb.x0[ix_["S"]] = 8.0
        else
        ...
        if haskey(ix_,"X0")
            ...
            pb.y0[findfirst(x->x==ig_["X0"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[13072.9],pbm.congrps)]
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
