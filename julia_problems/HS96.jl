function HS96(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS96.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["C1"]] = Float64(4.97)
        pbm.gconst[ig_["C2"]] = Float64(-1.88)
        pbm.gconst[ig_["C3"]] = Float64(-69.08)
        pbm.gconst[ig_["C4"]] = Float64(-118.02)
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
