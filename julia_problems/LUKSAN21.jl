...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        gtype    = String[]
        ig,ig_,_ = s2x_ii("E"*string(Int64(v_["1"])),ig_)
        arrset(gtype,ig,"==")
        ...
        ig,ig_,_ = s2x_ii("E"*string(Int64(v_["M"])),ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"E"*string(Int64(v_["M"])))
        iv = ix_["X"*string(Int64(v_["N"]))]
        pbm.A[ig,iv] += Float64(2.0)
        iv = ix_["X"*string(Int64(v_["M-1"]))]
        pbm.A[ig,iv] += Float64(-1.0)
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = length(ix_)
        ngrp   = length(ig_)
