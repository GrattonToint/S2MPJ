function CONCON(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling CONCON.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            pb.x0[ix_["P"*string(I)]] = Float64(965)
        end
        pb.x0[ix_["Q1"]] = Float64(100)
        pb.x0[ix_["Q2"]] = Float64(100)
        pb.x0[ix_["Q3"]] = Float64(-100)
        pb.x0[ix_["Q4"]] = Float64(-100)
        pb.x0[ix_["F1"]] = Float64(1000)
        pb.x0[ix_["F2"]] = Float64(1000)
        pb.x0[ix_["F3"]] = Float64(1000)
        pb.x0[ix_["F4"]] = Float64(1000)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
