...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            for K = Int64(v_["1"]):Int64(v_["L"])
                for J = Int64(v_["1"]):Int64(v_["M"])
                    iv,ix_,_ = s2x_ii("X"*string(I)*","*string(K)*","*string(J),ix_)
        ...
        for S = Int64(v_["1"]):Int64(v_["T"])
            for I = Int64(v_["1"]):Int64(v_["N"])
                iv,ix_,_ = s2x_ii("KINF"*string(I)*","*string(S),ix_)
                arrset(pb.xnames,iv,"KINF"*string(I)*","*string(S))
                iv,ix_,_ = s2x_ii("PHI"*string(I)*","*string(S),ix_)
                arrset(pb.xnames,iv,"PHI"*string(I)*","*string(S))
            end
            iv,ix_,_ = s2x_ii("KEFF"*string(S),ix_)
        ...
        for K = Int64(v_["1"]):Int64(v_["L"])
            for J = Int64(v_["1"]):Int64(v_["M"])
                for I = Int64(v_["1"]):Int64(v_["N"])
                    ig,ig_,_ = s2x_ii("SUMI"*string(K)*","*string(J),ig_)
                    arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            for K = Int64(v_["1"]):Int64(v_["L"])
                for J = Int64(v_["1"]):Int64(v_["M"])
                    ig,ig_,_ = s2x_ii("SUMLM"*string(I),ig_)
                    arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            ig,ig_,_ = s2x_ii("PLAC"*string(I),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            for S = Int64(v_["1"]):Int64(v_["T"])
                ig,ig_,_ = s2x_ii("KERN"*string(I)*","*string(S),ig_)
                arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            for S = Int64(v_["1"]):Int64(v_["T-1"])
                v_["R"] = 1+S
                ig,ig_,_ = s2x_ii("KINFF"*string(I)*","*string(S),ig_)
                arrset(gtype,ig,"==")
        ...
        for S = Int64(v_["1"]):Int64(v_["T"])
            ig,ig_,_ = s2x_ii("CPOW"*string(S),ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"CPOW"*string(S))
        end
        for I = Int64(v_["1"]):Int64(v_["N"])
            for S = Int64(v_["1"]):Int64(v_["T"])
                ig,ig_,_ = s2x_ii("PEAK"*string(I)*","*string(S),ig_)
                arrset(gtype,ig,"<=")
