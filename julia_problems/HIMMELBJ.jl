function HIMMELBJ(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HIMMELBJ.")
    end
    ...
    if action == "setup"
        ...
        push!(irA,ig)
        push!(icA,ix_["X2,1"])
        push!(valA,Float64(-7.69))
        push!(irA,ig)
        push!(icA,ix_["X3,1"])
        push!(valA,Float64(-11.52))
        push!(irA,ig)
        push!(icA,ix_["X4,1"])
        push!(valA,Float64(-36.60))
        push!(irA,ig)
        push!(icA,ix_["X1,2"])
        push!(valA,Float64(-10.94))
        push!(irA,ig)
        push!(icA,ix_["X8,2"])
        push!(valA,Float64(2.5966))
        push!(irA,ig)
        push!(icA,ix_["X9,2"])
        push!(valA,Float64(-39.39))
        push!(irA,ig)
        push!(icA,ix_["X10,2"])
        push!(valA,Float64(-21.35))
        push!(irA,ig)
        push!(icA,ix_["X11,2"])
        push!(valA,Float64(-32.84))
        push!(irA,ig)
        push!(icA,ix_["X12,2"])
        push!(valA,Float64(6.26))
        push!(irA,ig)
        push!(icA,ix_["X1,3"])
        push!(valA,Float64(10.45))
        push!(irA,ig)
        push!(icA,ix_["X3,3"])
        push!(valA,Float64(-0.5))
        push!(irA,ig)
        push!(icA,ix_["X7,3"])
        push!(valA,Float64(2.2435))
        push!(irA,ig)
        push!(icA,ix_["X9,3"])
        push!(valA,Float64(-39.39))
        push!(irA,ig)
        push!(icA,ix_["X10,3"])
        push!(valA,Float64(-21.49))
        push!(irA,ig)
        push!(icA,ix_["X11,3"])
        push!(valA,Float64(-32.84))
        push!(irA,ig)
        push!(icA,ix_["X12,3"])
        push!(valA,Float64(6.12))
        push!(irA,ig)
        push!(icA,ix_["X15,3"])
        push!(valA,Float64(-1.9028))
        push!(irA,ig)
        push!(icA,ix_["X16,3"])
        push!(valA,Float64(-2.8889))
        push!(irA,ig)
        push!(icA,ix_["X17,3"])
        push!(valA,Float64(-3.3622))
        push!(irA,ig)
        push!(icA,ix_["X18,3"])
        push!(valA,Float64(-7.4854))
        push!(irA,ig)
        push!(icA,ix_["X1,4"])
        push!(valA,Float64(-15.639))
        push!(irA,ig)
        push!(icA,ix_["X3,4"])
        push!(valA,Float64(21.81))
        push!(irA,ig)
        push!(icA,ix_["X1,5"])
        push!(valA,Float64(-16.79))
        push!(irA,ig)
        push!(icA,ix_["X3,5"])
        push!(valA,Float64(18.9779))
        push!(irA,ig)
        push!(icA,ix_["X2,6"])
        push!(valA,Float64(11.959))
        push!(irA,ig)
        push!(icA,ix_["X2,7"])
        push!(valA,Float64(12.899))
