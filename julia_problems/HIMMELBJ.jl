...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        loaset(elftv,it,1,"X")
        it,iet_,_ = s2x_ii( "eXLOGX2", iet_)
        loaset(elftv,it,1,"Y1")
        loaset(elftv,it,2,"Y2")
        loaset(elftv,it,3,"X")
        it,iet_,_ = s2x_ii( "eXLOGX3", iet_)
        loaset(elftv,it,1,"Y1")
        loaset(elftv,it,2,"Y2")
        loaset(elftv,it,3,"Y3")
        loaset(elftv,it,4,"X")
        it,iet_,_ = s2x_ii( "eXLOGX4", iet_)
        loaset(elftv,it,1,"Y1")
        loaset(elftv,it,2,"Y2")
        loaset(elftv,it,3,"Y3")
        loaset(elftv,it,4,"Y4")
        loaset(elftv,it,5,"X")
        it,iet_,_ = s2x_ii( "eXLOGX13", iet_)
        loaset(elftv,it,1,"Y1")
        loaset(elftv,it,2,"Y2")
        loaset(elftv,it,3,"Y3")
        loaset(elftv,it,4,"Y4")
        ...
        it,iet_,_ = s2x_ii( "eXLOGX18", iet_)
        loaset(elftv,it,1,"Y1")
        loaset(elftv,it,2,"Y2")
        loaset(elftv,it,3,"Y3")
        loaset(elftv,it,4,"Y4")
        ...
        for K = Int64(v_["1"]):Int64(v_["NSETS"])
            ...
            for J = Int64(v_["1"]):Int64(v_["NSK"])
                ...
                iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,1.e-12,nothing,0.1)
