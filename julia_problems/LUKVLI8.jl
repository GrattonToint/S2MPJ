...
# IE N                   100000         $-PARAMETER
        ...
        for I = Int64(v_["1"]):Int64(v_["N/5"])
            ig,ig_,_ = s2x_ii("O1"*string(I),ig_)
            arrset(gtype,ig,"<>")
            ig,ig_,_ = s2x_ii("O2"*string(I),ig_)
            arrset(gtype,ig,"<>")
            ig,ig_,_ = s2x_ii("O3"*string(I),ig_)
            arrset(gtype,ig,"<>")
            ig,ig_,_ = s2x_ii("O4"*string(I),ig_)
            arrset(gtype,ig,"<>")
        end
