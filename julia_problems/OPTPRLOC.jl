function OPTPRLOC(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OPTPRLOC.")
    end
    ...
    if action == "setup"
        ...
        push!(irA,ig)
        push!(icA,ix_["Y8"])
        push!(valA,Float64(-0.8))
        push!(irA,ig)
        push!(icA,ix_["Y9"])
        push!(valA,Float64(-1.0))
        push!(irA,ig)
        push!(icA,ix_["Y10"])
        push!(valA,Float64(-0.4))
        push!(irA,ig)
        push!(icA,ix_["Y11"])
        push!(valA,Float64(-1.0))
        push!(irA,ig)
        push!(icA,ix_["Y12"])
        push!(valA,Float64(-0.3))
        push!(irA,ig)
        push!(icA,ix_["Y13"])
        push!(valA,Float64(-0.1))
        push!(irA,ig)
