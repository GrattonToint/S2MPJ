function MARATOS(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling MARATOS.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["F"]] = Float64(v_["TAU"])
        ...
        if haskey(ix_,"X1")
            ...
            pb.y0[findfirst(x->x==ig_["X1"],pbm.congrps)] = Float64(1.1)
        end
        if haskey(ix_,"X2")
        ...
        loaset(pbm.grelw,ig,posel,Float64(v_["TAU"]))
        posel = length(pbm.grelt[ig])+1
