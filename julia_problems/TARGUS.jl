...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        #%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        gtype    = String[]
        ig,ig_,_ = s2x_ii("R0001",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0001")
        ig,ig_,_ = s2x_ii("R0002",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0002")
        ig,ig_,_ = s2x_ii("R0003",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0003")
        ig,ig_,_ = s2x_ii("R0004",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0004")
        ig,ig_,_ = s2x_ii("R0005",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0005")
        ig,ig_,_ = s2x_ii("R0006",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0006")
        ig,ig_,_ = s2x_ii("R0007",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0007")
        ig,ig_,_ = s2x_ii("R0008",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0008")
        ig,ig_,_ = s2x_ii("R0009",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0009")
        ig,ig_,_ = s2x_ii("R0010",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0010")
        ig,ig_,_ = s2x_ii("R0011",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0011")
        ig,ig_,_ = s2x_ii("R0012",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0012")
        ig,ig_,_ = s2x_ii("R0013",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0013")
        ig,ig_,_ = s2x_ii("R0014",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0014")
        ig,ig_,_ = s2x_ii("R0015",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0015")
        ig,ig_,_ = s2x_ii("R0016",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0016")
        ig,ig_,_ = s2x_ii("R0017",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0017")
        ig,ig_,_ = s2x_ii("R0018",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0018")
        ig,ig_,_ = s2x_ii("R0019",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0019")
        ig,ig_,_ = s2x_ii("R0020",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0020")
        ig,ig_,_ = s2x_ii("R0021",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0021")
        ig,ig_,_ = s2x_ii("R0022",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0022")
        ig,ig_,_ = s2x_ii("R0023",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0023")
        ig,ig_,_ = s2x_ii("R0024",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0024")
        ig,ig_,_ = s2x_ii("R0025",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0025")
        ig,ig_,_ = s2x_ii("R0026",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0026")
        ig,ig_,_ = s2x_ii("R0027",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0027")
        ig,ig_,_ = s2x_ii("R0028",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0028")
        ig,ig_,_ = s2x_ii("R0029",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0029")
        ig,ig_,_ = s2x_ii("R0030",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0030")
        ig,ig_,_ = s2x_ii("R0031",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0031")
        ig,ig_,_ = s2x_ii("R0032",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0032")
        ig,ig_,_ = s2x_ii("R0033",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0033")
        ig,ig_,_ = s2x_ii("R0034",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0034")
        ig,ig_,_ = s2x_ii("R0035",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0035")
        ig,ig_,_ = s2x_ii("R0036",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0036")
        ig,ig_,_ = s2x_ii("R0037",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0037")
        ig,ig_,_ = s2x_ii("R0038",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0038")
        ig,ig_,_ = s2x_ii("R0039",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0039")
        ig,ig_,_ = s2x_ii("R0040",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0040")
        ig,ig_,_ = s2x_ii("R0041",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0041")
        ig,ig_,_ = s2x_ii("R0042",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0042")
        ig,ig_,_ = s2x_ii("R0043",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0043")
        ig,ig_,_ = s2x_ii("R0044",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0044")
        ig,ig_,_ = s2x_ii("R0045",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0045")
        ig,ig_,_ = s2x_ii("R0046",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0046")
        ig,ig_,_ = s2x_ii("R0047",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0047")
        ig,ig_,_ = s2x_ii("R0048",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0048")
        ig,ig_,_ = s2x_ii("R0049",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0049")
        ig,ig_,_ = s2x_ii("R0050",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0050")
        ig,ig_,_ = s2x_ii("R0051",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0051")
        ig,ig_,_ = s2x_ii("R0052",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0052")
        ig,ig_,_ = s2x_ii("R0053",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0053")
        ig,ig_,_ = s2x_ii("R0054",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0054")
        ig,ig_,_ = s2x_ii("R0055",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0055")
        ig,ig_,_ = s2x_ii("R0056",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0056")
        ig,ig_,_ = s2x_ii("R0057",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0057")
        ig,ig_,_ = s2x_ii("R0058",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0058")
        ig,ig_,_ = s2x_ii("R0059",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0059")
        ig,ig_,_ = s2x_ii("R0060",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0060")
        ig,ig_,_ = s2x_ii("R0061",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0061")
        ig,ig_,_ = s2x_ii("R0062",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0062")
        ig,ig_,_ = s2x_ii("R0063",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"R0063")
        ig,ig_,_ = s2x_ii("R0064",ig_)
        arrset(gtype,ig,"<>")
        #%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        xscale  = Float64[]
        intvars = Int64[]
