function OPTCNTRL(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OPTCNTRL.")
    end
    ...
    if action == "setup"
        ...
        for t = Int64(v_["0"]):Int64(v_["T-1"])
            ...
            push!(irA,ig)
            push!(icA,ix_["x"*string(t)])
            push!(valA,Float64(0.004))
            push!(irA,ig)
            push!(icA,ix_["u"*string(t)])
            push!(valA,Float64(-0.2))
        end
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = length(ix_)
