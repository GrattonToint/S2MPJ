function OBSTCLBM(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OBSTCLBM.")
    end
...
# IE PY                  125            $-PARAMETER
        ...
        for I = Int64(v_["2"]):Int64(v_["PY-1"])
            ...
            for J = Int64(v_["2"]):Int64(v_["PX-1"])
                ...
                v_["M1"] = v_["LOW"]+v_["UPP"]
                v_["MID"] = 0.5*v_["M1"]
                pb.x0[ix_["X"*string(I)*","*string(J)]] = Float64(v_["MID"])
            end
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
