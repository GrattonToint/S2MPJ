function BRATU2DT(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling BRATU2DT.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["2"]):Int64(v_["P-1"])
            ...
            for J = Int64(v_["2"]):Int64(v_["P-1"])
                ...
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["U"*string(I)*","*string(Int64(v_["J+1"]))])
                push!(valA,Float64(-1.0))
                push!(irA,ig)
                push!(icA,ix_["U"*string(I)*","*string(Int64(v_["J-1"]))])
                push!(valA,Float64(-1.0))
