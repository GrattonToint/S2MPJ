function DEVGLA2NE(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling DEVGLA2NE.")
    end
    ...
    if action == "setup"
        ...
        if haskey(ix_,"X1")
            ...
            pb.y0[findfirst(x->x==ig_["X1"],pbm.congrps)] = Float64(20.0)
        end
        if haskey(ix_,"X2")
        ...
        if haskey(ix_,"X5")
            ...
            pb.y0[findfirst(x->x==ig_["X5"],pbm.congrps)] = Float64(0.2)
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
