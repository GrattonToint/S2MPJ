...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        for I = Int64(v_["2"]):Int64(v_["S-1"])
            iv,ix_,_ = s2x_ii("PHI"*string(I),ix_)
            arrset(pb.xnames,iv,"PHI"*string(I))
            iv,ix_,_ = s2x_ii("LAM"*string(I),ix_)
        ...
        for I = Int64(v_["2"]):Int64(v_["S"])
            v_["I1"] = -1+I
            v_["I2"] = -2+I
            ig,ig_,_ = s2x_ii("R"*string(Int64(v_["I2"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"R"*string(Int64(v_["I2"]))*","*string(I))
            ig,ig_,_ = s2x_ii("R"*string(Int64(v_["I1"]))*","*string(I),ig_)
            arrset(gtype,ig,"==")
        ...
        vname = "PHI1"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,-1000.0,1000.0,nothing)
