function WACHBIEG(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling WACHBIEG.")
    end
    ...
    if action == "setup"
        ...
        ig_ = Dict{String,Int}();
        if nargin<1
            v_["A"] = Float64(3);  #  SIF file default value
        else
            v_["A"] = Float64(args[1]);
        end
        if nargin<2
        ...
        pbm.gconst[ig_["CON1"]] = Float64(v_["-A"])
        pbm.gconst[ig_["CON2"]] = Float64(v_["B"])
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
