function n3PK(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling n3PK.")
    end
    ...
    if action == "setup"
        ...
        push!(irA,ig)
        push!(icA,ix_["T0,3"])
        push!(valA,Float64(0.010000))
        ig,ig_,_ = s2mpj_ii("G1,3",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T1,3"])
        push!(valA,Float64(0.007143))
        ig,ig_,_ = s2mpj_ii("G2,3",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T2,3"])
        push!(valA,Float64(0.008333))
        ig,ig_,_ = s2mpj_ii("G4,3",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T4,3"])
        push!(valA,Float64(0.050000))
        ...
        push!(irA,ig)
        push!(icA,ix_["T0,4"])
        push!(valA,Float64(0.005000))
        ig,ig_,_ = s2mpj_ii("G1,4",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T1,4"])
        push!(valA,Float64(0.005556))
        ...
        push!(irA,ig)
        push!(icA,ix_["T3,4"])
        push!(valA,Float64(0.001667))
        ig,ig_,_ = s2mpj_ii("G5,4",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T5,4"])
        push!(valA,Float64(0.025000))
        ig,ig_,_ = s2mpj_ii("G0,5",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T0,5"])
        push!(valA,Float64(0.020000))
        ig,ig_,_ = s2mpj_ii("G1,5",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T1,5"])
        push!(valA,Float64(0.033333))
        ig,ig_,_ = s2mpj_ii("G2,5",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T2,5"])
        push!(valA,Float64(0.014286))
        ig,ig_,_ = s2mpj_ii("G3,5",ig_)
        arrset(gtype,ig,"<>")
        push!(irA,ig)
        push!(icA,ix_["T3,5"])
        push!(valA,Float64(0.006667))
        ...
        push!(irA,ig)
        push!(icA,ix_["A1,0"])
        push!(valA,Float64(-0.800000))
        arrset(pbm.gscale,ig,Float64(0.500000))
        push!(irA,ig)
        push!(icA,ix_["A2,0"])
        push!(valA,Float64(0.200000))
        push!(irA,ig)
        push!(icA,ix_["A3,0"])
        push!(valA,Float64(0.200000))
        push!(irA,ig)
