...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX"])
            ig,ig_,_ = s2x_ii("FENTR",ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"FENTR")
            iv = ix_["W"*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("NTRAY",ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"NTRAY")
            iv = ix_["S"*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("NDEF1",ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"NDEF1")
            iv = ix_["Z"*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            v_["RI"] = Float64(I)
            ig,ig_,_ = s2x_ii("NDEF2",ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX-1"])
            v_["I+1"] = 1+I
            ig,ig_,_ = s2x_ii("NIL"*string(I),ig_)
            arrset(gtype,ig,">=")
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX"])
            ig,ig_,_ = s2x_ii("LASTX"*string(I),ig_)
            arrset(gtype,ig,"<=")
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX"])
            ig,ig_,_ = s2x_ii("ZNOT"*string(I),ig_)
            arrset(gtype,ig,"<=")
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX"])
            ig,ig_,_ = s2x_ii("FEEDX"*string(I),ig_)
            arrset(gtype,ig,"<=")
        ...
        for I = Int64(v_["2"]):Int64(v_["NMAX"])
            v_["I-1"] = -1+I
            ig,ig_,_ = s2x_ii("WNES1u"*string(I),ig_)
            arrset(gtype,ig,"<=")
            ...
            iv = ix_["S"*string(I)]
            pbm.A[ig,iv] += Float64(1.0)
            ig,ig_,_ = s2x_ii("WNES2u"*string(I),ig_)
            arrset(gtype,ig,"<=")
        ...
        for I = Int64(v_["1"]):Int64(v_["NMAX"])
            ...
            pbm.A[ig,iv] += Float64(-1.0)
            for J = Int64(v_["1"]):Int64(v_["M"])
                ig,ig_,_ = s2x_ii("XNOT"*string(I)*","*string(J),ig_)
                arrset(gtype,ig,"<=")
                ...
                iv = ix_["Z"*string(I)]
                pbm.A[ig,iv] += Float64(-1.0)
                ig,ig_,_ = s2x_ii("YNOT"*string(I)*","*string(J),ig_)
                arrset(gtype,ig,"<=")
        ...
        for J = Int64(v_["1"]):Int64(v_["M"])
            v_["TEMP"] = -1.0*v_["F"]
            ig,ig_,_ = s2x_ii("CMB1u"*string(J),ig_)
            arrset(gtype,ig,"==")
        ...
        for I = Int64(v_["2"]):Int64(v_["NMAX"])
            for J = Int64(v_["1"]):Int64(v_["M"])
                v_["TEMP"] = -1.0*v_["BIGM"]
                ig,ig_,_ = s2x_ii("CMBN1"*string(I)*","*string(J),ig_)
                arrset(gtype,ig,"<=")
                arrset(pb.cnames,ig,"CMBN1"*string(I)*","*string(J))
                iv = ix_["S"*string(I)]
                pbm.A[ig,iv] += Float64(v_["BIGM"])
                ig,ig_,_ = s2x_ii("CMBN2"*string(I)*","*string(J),ig_)
                arrset(gtype,ig,">=")
        ...
        for I = Int64(v_["2"]):Int64(v_["NMAX-1"])
            ...
            ig,ig_,_ = s2x_ii("CMB1"*string(I),ig_)
            arrset(gtype,ig,"<=")
            ...
            ig,ig_,_ = s2x_ii("CMB2"*string(I),ig_)
            arrset(gtype,ig,">=")
        ...
        for I = Int64(v_["3"]):Int64(v_["NMAX"])
            ig,ig_,_ = s2x_ii("RECR"*string(I),ig_)
            arrset(gtype,ig,"<=")
