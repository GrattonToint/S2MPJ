...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        ig,ig_,_ = s2x_ii("Q8E",ig_)
        arrset(gtype,ig,"==")
        arrset(pb.cnames,ig,"Q8E")
        ig,ig_,_ = s2x_ii("S8E",ig_)
        arrset(gtype,ig,"==")
        ...
        vname = "X1"
        iv,ix_,pb = s2x_nlx(vname,ix_,pb,1,nothing,1.58,0.5)
