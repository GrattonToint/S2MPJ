    ...
    if action == "setup"
        ...
        for j = Int64(v_["1"]):Int64(v_["2"])
            for k = Int64(v_["1"]):Int64(v_["xm"])
                iv,ix_,_ = s2x_ii("X"*string(j)*","*string(k),ix_)
        ...
        for i = Int64(v_["1"]):Int64(v_["3"])
            for j = Int64(v_["1"]):Int64(v_["2"])
                for k = Int64(v_["1"]):Int64(v_["Lm"])
                    iv,ix_,_ = s2x_ii("L"*string(i)*","*string(j)*","*string(k),ix_)
        ...
        for j = Int64(v_["1"]):Int64(v_["2"])
            for k = Int64(v_["2"]):Int64(v_["xm-2"])
                v_["k+"] = 1+k
                ig,ig_,_ = s2x_ii("PS"*string(j)*","*string(k),ig_)
                arrset(gtype,ig,">=")
        ...
        for i = Int64(v_["1"]):Int64(v_["3"])
            for j = Int64(v_["1"]):Int64(v_["2"])
                for k = Int64(v_["1"]):Int64(v_["Lm-"])
                    ...
                    v_["2k"] = 2*k
                    v_["2k-"] = -1+v_["2k"]
                    ig,ig_,_ = s2x_ii("SU"*string(i)*","*string(j)*","*string(k),ig_)
                    arrset(gtype,ig,"<=")
                    ...
                    iv = ix_["X"*string(j)*","*string(Int64(v_["2k-"]))]
                    pbm.A[ig,iv] += Float64(v_["k1"])
                    ig,ig_,_ = s2x_ii("SL"*string(i)*","*string(j)*","*string(k),ig_)
                    arrset(gtype,ig,">=")
        ...
        for i = Int64(v_["1"]):Int64(v_["3"])
            ig,ig_,_ = s2x_ii("c2const"*string(i),ig_)
            arrset(gtype,ig,"==")
        ...
        ig,ig_,_ = s2x_ii("c3con1",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c3con1")
        ig,ig_,_ = s2x_ii("c3con2",ig_)
        arrset(gtype,ig,"<=")
        arrset(pb.cnames,ig,"c3con2")
        ig,ig_,_ = s2x_ii("c4const",ig_)
        arrset(gtype,ig,">=")
        arrset(pb.cnames,ig,"c4const")
        for i = Int64(v_["1"]):Int64(v_["3"])
            ig,ig_,_ = s2x_ii("c5con"*string(i),ig_)
            arrset(gtype,ig,"==")
            arrset(pb.cnames,ig,"c5con"*string(i))
        end
        for i = Int64(v_["1"]):Int64(v_["2"])
            ig,ig_,_ = s2x_ii("c6cn"*string(i),ig_)
            arrset(gtype,ig,"==")
        ...
        it,iet_,_ = s2x_ii( "euv1", iet_)
        loaset(elftv,it,1,"v1")
        loaset(elftv,it,2,"v2")
        loaset(elftv,it,3,"v3")
        loaset(elftv,it,4,"v4")
        it,iet_,_ = s2x_ii( "euv2", iet_)
        loaset(elftv,it,1,"v1")
        loaset(elftv,it,2,"v2")
        loaset(elftv,it,3,"v3")
        it,iet_,_ = s2x_ii( "euvw1", iet_)
        loaset(elftv,it,1,"v1")
        loaset(elftv,it,2,"v2")
        loaset(elftv,it,3,"v3")
        elftp = Vector{Vector{String}}()
        loaset(elftp,it,1,"p1")
        it,iet_,_ = s2x_ii( "emo", iet_)
