function OSBORNE1(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling OSBORNE1.")
    end
    ...
    if action == "setup"
        ...
        if haskey(ix_,"X2")
            ...
            pb.y0[findfirst(x->x==ig_["X2"],pbm.congrps)] = Float64(1.5)
        end
        if haskey(ix_,"X3")
        ...
        if haskey(ix_,"X4")
            ...
            pb.y0[findfirst(x->x==ig_["X4"],pbm.congrps)] = Float64(0.01)
        end
        if haskey(ix_,"X5")
            pb.x0[ix_["X5"]] = Float64(0.02)
        else
            pb.y0[findfirst(x->x==ig_["X5"],pbm.congrps)] = Float64(0.02)
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
