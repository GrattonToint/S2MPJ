...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        iv = ix_["NA3"]
        pbm.A[ig,iv] += Float64(1.0)
        ig,ig_,_ = s2x_ii("HINF",ig_)
        arrset(gtype,ig,"<>")
        ig,ig_,_ = s2x_ii("HINN",ig_)
        arrset(gtype,ig,"<>")
        ig,ig_,_ = s2x_ii("PSF",ig_)
        arrset(gtype,ig,"==")
