function HS77(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS77.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["O2"]] = Float64(0.0)
        pbm.gconst[ig_["CON1"]] = Float64(v_["C1"])
        pbm.gconst[ig_["CON2"]] = Float64(v_["C2"])
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        arrset(pbm.elftype,ie,"eSQLN")
        arrset(ielftype,ie,iet_["eSQLN"])
        vname = "X1"
        iv,ix_,pb  = (
        ...
        ename = "E7"
        ie,ie_,_  = s2mpj_ii(ename,ie_)
        arrset(pbm.elftype,ie,"eQDSQ")
        arrset(ielftype,ie,iet_["eQDSQ"])
        vname = "X3"
        iv,ix_,pb  = (
              s2mpj_nlx(vname,ix_,pb,1,Float64(-Inf),Float64(Inf),Float64(2.0)))
        posev = findfirst(x->x=="V1",elftv[ielftype[ie]])
