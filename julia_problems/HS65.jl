function HS65(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HS65.")
    end
    ...
    if action == "setup"
        ...
        push!(icA,ix_["X2"])
        push!(valA,Float64(1.0))
        arrset(pbm.gscale,ig,Float64(9.0))
        ...
        pbm.gconst[ig_["OBJ3"]] = Float64(5.0)
        pbm.gconst[ig_["C1"]] = Float64(-48.0)
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        pb.xlower = zeros(Float64,pb.n)
        pb.xupper =    fill(Inf,pb.n)
        pb.xlower[ix_["X1"]] = -4.5
        pb.xupper[ix_["X1"]] = 4.5
        pb.xlower[ix_["X2"]] = -4.5
        pb.xupper[ix_["X2"]] = 4.5
        pb.xlower[ix_["X3"]] = -5.0
