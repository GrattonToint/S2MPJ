...
# IE N                   99997          $-PARAMETER
        ...
        for I = Int64(v_["1"]):Int64(v_["(N-1)/4"])
            ...
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("OBJ2"*string(I),ig_)
            arrset(gtype,ig,"<>")
            iv = ix_["X"*string(Int64(v_["J+2"]))]
            pbm.A[ig,iv] += Float64(1.0)
            ...
            pbm.A[ig,iv] += Float64(-1.0)
            ig,ig_,_ = s2x_ii("OBJ4"*string(I),ig_)
            arrset(gtype,ig,"<>")
            iv = ix_["X"*string(Int64(v_["J+4"]))]
            pbm.A[ig,iv] += Float64(1.0)
        ...
        for K = Int64(v_["1"]):Int64(v_["3"]):Int64(v_["NC"])
            ...
            pbm.A[ig,iv] += Float64(3.0)
            ig,ig_,_ = s2x_ii("C"*string(Int64(v_["K+2"])),ig_)
            arrset(gtype,ig,"==")
        ...
        for K = Int64(v_["1"]):Int64(v_["NC"])
            pbm.gconst[ig_["C"*string(K)]] = Float64(6.0)
        end
        ...
        for I = Int64(v_["1"]):Int64(v_["4"]):Int64(v_["N"])
            pb.x0[ix_["X"*string(I)]] = Float64(35.0)
        end
        for I = Int64(v_["2"]):Int64(v_["4"]):Int64(v_["N"])
            pb.x0[ix_["X"*string(I)]] = Float64(11.0)
        end
