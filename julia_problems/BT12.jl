function BT12(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling BT12.")
    end
    ...
    if action == "setup"
        ...
        pbm.gconst[ig_["CON1"]] = Float64(25.0)
        pbm.gconst[ig_["CON2"]] = Float64(25.0)
        ...
        pb.x0[ix_["X1"]] = Float64(15.811)
        pb.x0[ix_["X2"]] = Float64(1.5811)
        pb.x0[ix_["X3"]] = Float64(0.0)
        pb.x0[ix_["X4"]] = Float64(15.083)
        pb.x0[ix_["X5"]] = Float64(3.7164)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
