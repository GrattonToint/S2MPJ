...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        if haskey(ix_,"I")
            ...
            pb.y0[findfirst(x->x==ig_["I"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[26061.4],pbm.congrps)]
        end
        if haskey(ix_,"S")
            pb.x0[ix_["S"]] = 38.7105
        else
            pb.y0[findfirst(x->x==ig_["S"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[38.7105],pbm.congrps)]
        end
        if haskey(ix_,"X0")
            pb.x0[ix_["X0"]] = 37027.1
        else
            pb.y0[findfirst(x->x==ig_["X0"],pbm.congrps)]pb.y0[findfirst(x->x==ig_[37027.1],pbm.congrps)]
        end
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
