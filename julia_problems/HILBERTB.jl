function HILBERTB(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling HILBERTB.")
    end
...
# IE N                   50             $-PARAMETER
        if nargin<2
            v_["D"] = Float64(5.0);  #  SIF file default value
        else
            v_["D"] = Float64(args[2]);
        end
        v_["1"] = 1
        ...
        for I = Int64(v_["1"]):Int64(v_["N"])
            ...
            for J = Int64(v_["1"]):Int64(v_["I-1"])
                ...
                vname = "X"*string(I)
                iv,ix_,pb  = (
                      s2mpj_nlx(vname,ix_,pb,1,Float64(-Inf),Float64(Inf),Float64(-3.0)))
