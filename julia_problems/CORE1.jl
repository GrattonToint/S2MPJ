function CORE1(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling CORE1.")
    end
    ...
    if action == "setup"
        ...
        push!(icA,iv)
        push!(irA,ig_["NODE0001"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0002"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0004"])
        push!(valA,Float64(-1.00000E+00))
        iv,ix_,_ = s2mpj_ii("FLOW0006",ix_)
        arrset(pb.xnames,iv,"FLOW0006")
        push!(icA,iv)
        push!(irA,ig_["NODE0005"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0006"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0014"])
        push!(valA,Float64(-1.00000E+00))
        iv,ix_,_ = s2mpj_ii("FLOW0010",ix_)
        arrset(pb.xnames,iv,"FLOW0010")
        push!(icA,iv)
        push!(irA,ig_["NODE0008"])
        push!(valA,Float64(1.00000E+00))
        push!(icA,iv)
        push!(irA,ig_["NODE0009"])
        push!(valA,Float64(-1.00000E+00))
        ...
        push!(icA,iv)
        push!(irA,ig_["ARC00001"])
        push!(valA,Float64(-9.07027E+00))
        iv,ix_,_ = s2mpj_ii("PI000001",ix_)
        arrset(pb.xnames,iv,"PI000001")
        push!(icA,iv)
        push!(irA,ig_["ARC00002"])
        push!(valA,Float64(-9.07027E+00))
        ...
        arrset(pb.xnames,iv,"PI000002")
        push!(icA,iv)
        push!(irA,ig_["ARC00003"])
        push!(valA,Float64(-6.04685E+00))
        iv,ix_,_ = s2mpj_ii("PI000002",ix_)
        arrset(pb.xnames,iv,"PI000002")
        push!(icA,iv)
        push!(irA,ig_["ARC00004"])
        push!(valA,Float64(-6.04685E+00))
        ...
        arrset(pb.xnames,iv,"PI000003")
        push!(icA,iv)
        push!(irA,ig_["ARC00005"])
        push!(valA,Float64(-1.39543E+00))
        ...
        arrset(pb.xnames,iv,"PI000004")
        push!(icA,iv)
        push!(irA,ig_["ARC00008"])
        push!(valA,Float64(2.26895E-01))
        iv,ix_,_ = s2mpj_ii("PI000004",ix_)
        arrset(pb.xnames,iv,"PI000004")
        push!(icA,iv)
        push!(irA,ig_["ARC00009"])
        push!(valA,Float64(-6.59656E-01))
        iv,ix_,_ = s2mpj_ii("PI000005",ix_)
        arrset(pb.xnames,iv,"PI000005")
        push!(icA,iv)
        push!(irA,ig_["ARC00006"])
        push!(valA,Float64(-1.00256E-01))
        ...
        arrset(pb.xnames,iv,"PI000006")
        push!(icA,iv)
        push!(irA,ig_["ARC00007"])
        push!(valA,Float64(-1.48655E-01))
        ...
        push!(icA,iv)
        push!(irA,ig_["ARC00010"])
        push!(valA,Float64(-7.25622E+00))
        iv,ix_,_ = s2mpj_ii("PI000008",ix_)
        arrset(pb.xnames,iv,"PI000008")
        push!(icA,iv)
        push!(irA,ig_["ARC00011"])
        push!(valA,Float64(-1.08033E-01))
        ...
        arrset(pb.xnames,iv,"PI000009")
        push!(icA,iv)
        push!(irA,ig_["ARC00012"])
        push!(valA,Float64(-1.81405E+00))
        iv,ix_,_ = s2mpj_ii("PI000009",ix_)
        arrset(pb.xnames,iv,"PI000009")
        push!(icA,iv)
        push!(irA,ig_["ARC00013"])
        push!(valA,Float64(-2.70084E-02))
        ...
        arrset(pb.xnames,iv,"PI000010")
        push!(icA,iv)
        push!(irA,ig_["ARC00014"])
        push!(valA,Float64(-1.45124E+00))
        iv,ix_,_ = s2mpj_ii("PI000010",ix_)
        arrset(pb.xnames,iv,"PI000010")
        push!(icA,iv)
        push!(irA,ig_["ARC00015"])
        push!(valA,Float64(-2.16067E-02))
        ...
        arrset(pb.xnames,iv,"PI000011")
        push!(icA,iv)
        push!(irA,ig_["ARC00016"])
        push!(valA,Float64(-8.63836E-01))
        iv,ix_,_ = s2mpj_ii("PI000011",ix_)
        arrset(pb.xnames,iv,"PI000011")
        push!(icA,iv)
        push!(irA,ig_["ARC00021"])
        push!(valA,Float64(-5.14445E-02))
        ...
        arrset(pb.xnames,iv,"PI000012")
        push!(icA,iv)
        push!(irA,ig_["ARC00017"])
        push!(valA,Float64(-9.07027E-01))
        ...
        arrset(pb.xnames,iv,"PI000014")
        push!(icA,iv)
        push!(irA,ig_["ARC00019"])
        push!(valA,Float64(-3.62811E+00))
        ...
        arrset(pb.xnames,iv,"PI000017")
        push!(icA,iv)
        push!(irA,ig_["ARC00022"])
        push!(valA,Float64(-6.41977E-03))
        ...
        arrset(pb.xnames,iv,"PI000018")
        push!(icA,iv)
        push!(irA,ig_["ARC00023"])
        push!(valA,Float64(-1.70320E-03))
        ...
        arrset(pb.xnames,iv,"PI000019")
        push!(icA,iv)
        push!(irA,ig_["ARC00024"])
        push!(valA,Float64(-2.78190E-02))
