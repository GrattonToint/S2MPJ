function ACOPP30(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling ACOPP30.")
    end
    ...
    if action == "setup"
        ...
        push!(irH,ix_["P1"])
        push!(icH,ix_["P1"])
        push!(valH,Float64(400.0))
        push!(irH,ix_["P2"])
        push!(icH,ix_["P2"])
        push!(valH,Float64(350))
        push!(irH,ix_["P3"])
        push!(icH,ix_["P3"])
        push!(valH,Float64(500.0))
        push!(irH,ix_["P4"])
        push!(icH,ix_["P4"])
        push!(valH,Float64(1250.0))
        push!(irH,ix_["P5"])
        push!(icH,ix_["P5"])
        push!(valH,Float64(500.0))
        push!(irH,ix_["P6"])
        push!(icH,ix_["P6"])
        push!(valH,Float64(166.8))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
