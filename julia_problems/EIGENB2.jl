function EIGENB2(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling EIGENB2.")
    end
        ...
        for J = Int64(v_["1"]):Int64(v_["N"])
            ...
            for I = Int64(v_["1"]):Int64(v_["N"])
                for K = Int64(v_["1"]):Int64(v_["N"])
                    ...
                    arrset(gtype,ig,"<>")
                    push!(irA,ig)
                    push!(icA,ix_["Q"*string(J)*","*string(K)])
                    push!(valA,Float64(v_["-AIK"]))
                end
            end
        end
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
