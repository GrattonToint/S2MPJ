...
# IE N                   16384         $-PARAMETER
        if nargin<2
            v_["BETA"] = Float64(0.005);  #  SIF file default value
        else
        ...
        for I = Int64(v_["0"]):Int64(v_["N"])
            for J = Int64(v_["0"]):Int64(v_["N"])
                iv,ix_,_ = s2x_ii("F"*string(I)*","*string(J),ix_)
        ...
        for I = Int64(v_["1"]):Int64(v_["N-1"])
            for J = Int64(v_["1"]):Int64(v_["N-1"])
                pb.xupper[ix_["U"*string(I)*","*string(J)]] = 0.01
            end
        end
        for I = Int64(v_["1"]):Int64(v_["N-1"])
            v_["RI"] = Float64(I)
            ...
            for J = Int64(v_["1"]):Int64(v_["N-1"])
                ...
                pb.xlower[ix_["F"*string(I)*","*string(J)]] = v_["UA"]
            end
            for J = Int64(v_["1"]):Int64(v_["N/2"])
                pb.xupper[ix_["F"*string(I)*","*string(J)]] = 0.6
            end
            for J = Int64(v_["N/2+1"]):Int64(v_["N-1"])
                pb.xupper[ix_["F"*string(I)*","*string(J)]] = 0.9
            end
        end
        #%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
        ...
        loaset(elftv,it,3,"U3")
        loaset(elftv,it,4,"U4")
        it,iet_,_ = s2x_ii( "eD", iet_)
        loaset(elftv,it,1,"U1")
        loaset(elftv,it,2,"U2")
        loaset(elftv,it,3,"U3")
        loaset(elftv,it,4,"U4")
        it,iet_,_ = s2x_ii( "eP", iet_)
        loaset(elftv,it,1,"F1")
        loaset(elftv,it,2,"F2")
        loaset(elftv,it,3,"F3")
        loaset(elftv,it,4,"F4")
        it,iet_,_ = s2x_ii( "eQ", iet_)
        loaset(elftv,it,1,"F1")
        loaset(elftv,it,2,"F2")
        loaset(elftv,it,3,"F3")
        loaset(elftv,it,4,"F4")
        it,iet_,_ = s2x_ii( "eR", iet_)
        loaset(elftv,it,1,"F1")
        loaset(elftv,it,2,"F2")
        loaset(elftv,it,3,"F3")
        loaset(elftv,it,4,"F4")
