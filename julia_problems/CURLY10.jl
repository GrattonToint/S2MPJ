function CURLY10(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling CURLY10.")
    end
    ...
    if action == "setup"
        ...
        ig_ = Dict{String,Int}();
        if nargin<1
            v_["N"] = Int64(15);  #  SIF file default value
        else
            v_["N"] = Int64(args[1]);
        end
        v_["K"] = 10
