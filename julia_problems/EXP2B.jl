function EXP2B(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling EXP2B.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["0"]):Int64(v_["M-1"])
            ...
            vname = "X1"
            iv,ix_,pb = s2mpj_nlx(vname,ix_,pb,1,Float64(0.0),Float64(20.0),nothing)
