function TRUSPYR1(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling TRUSPYR1.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["NDIM"])
            ...
            arrset(gtype,ig,"<=")
            arrset(pb.cnames,ig,"STREN")
            push!(irA,ig)
            push!(icA,ix_["DISPL"*string(I)])
            push!(valA,Float64(v_["Q"*string(I)]))
        end
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = length(ix_)
        ngrp   = length(ig_)
        ...
        pbm.gconst[ig_["STREN"]] = Float64(v_["ALPHA"])
        #%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
