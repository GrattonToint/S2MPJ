function LMINSURF(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling LMINSURF.")
    end
...
# IE P                   125            $-PARAMETER n = 15625
        ...
        for J = Int64(v_["1"]):Int64(v_["P"])
            ...
            v_["TL"] = v_["TH"]+v_["H00"]
            v_["TU"] = v_["TH"]+v_["H10"]
            pb.xlower[ix_["X"*string(Int64(v_["1"]))*","*string(J)]] = v_["TL"]
            pb.xupper[ix_["X"*string(Int64(v_["1"]))*","*string(J)]] = v_["TL"]
            pb.xlower[ix_["X"*string(Int64(v_["P"]))*","*string(J)]] = v_["TU"]
            pb.xupper[ix_["X"*string(Int64(v_["P"]))*","*string(J)]] = v_["TU"]
        end
        for I = Int64(v_["2"]):Int64(v_["P-1"])
            ...
            v_["TR"] = v_["TV"]+v_["H00"]
            v_["TL"] = v_["TV"]+v_["H01"]
            pb.xlower[ix_["X"*string(I)*","*string(Int64(v_["P"]))]] = v_["TL"]
            pb.xupper[ix_["X"*string(I)*","*string(Int64(v_["P"]))]] = v_["TL"]
            pb.xlower[ix_["X"*string(I)*","*string(Int64(v_["1"]))]] = v_["TR"]
            pb.xupper[ix_["X"*string(I)*","*string(Int64(v_["1"]))]] = v_["TR"]
        end
        #%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
