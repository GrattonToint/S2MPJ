function PORTFL2(action::String,args::Union{Any}...)
# 
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 
# 
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if ( !isdefined(@__MODULE__, :s2mpj_ii) )
        error( "Please include(\"s2mpjlib.jl\") using \"s2mpjlib.jl\" from the S2MPJ distribution before calling PORTFL2.")
    end
    ...
    if action == "setup"
        ...
        for I = Int64(v_["1"]):Int64(v_["NR"])
            for J = Int64(v_["1"]):Int64(v_["NS"])
                ...
                arrset(gtype,ig,"<>")
                push!(irA,ig)
                push!(icA,ix_["S"*string(J)])
                push!(valA,Float64(v_["F"*string(J)*","*string(I)]))
            end
        end
        for I = Int64(v_["1"]):Int64(v_["NS"])
