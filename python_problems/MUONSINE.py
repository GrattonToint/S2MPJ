...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('B' in ix_):
            pb.x0[ix_['B']] = float(5.2)
        else:
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['B']),float(5.2))
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        ...
        for I in range(int(v_['1']),int(v_['M'])+1):
            ...
            pbm.grelt = loaset(pbm.grelt,ig,posel,ie_['G'+str(I)])
    ...
    def eSINE(pbm,nargout,*args):
        ...
        if nargout>1:
            try:
                ...
                dim = len(EV_)
            g_ = np.zeros(dim)
            g_[0] = pbm.elpar[iel_][0]*C
            if nargout>2:
                H_ = np.zeros((1,1))
                H_[0,0] = -pbm.elpar[iel_][0]*pbm.elpar[iel_][0]*S
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
