...
# IE N                   100000         $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['N/2'])+1):
            ...
            iv = ix_['X'+str(int(v_['2I']))]
            pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['1'])),ig_)
        gtype = arrset(gtype,ig,'<=')
        ...
        pbm.A[ig,iv] = float(1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['2'])),ig_)
        gtype = arrset(gtype,ig,'<=')
        ...
        pbm.A[ig,iv] = float(1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['3'])),ig_)
        gtype = arrset(gtype,ig,'<=')
        ...
        iv = ix_['X'+str(int(v_['1']))]
        pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['4'])),ig_)
        gtype = arrset(gtype,ig,'<=')
        ...
        pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['5'])),ig_)
        gtype = arrset(gtype,ig,'<=')
        ...
        iv = ix_['X'+str(int(v_['N-4']))]
        pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        [ig,ig_,_] = s2x_ii('C'+str(int(v_['6'])),ig_)
        gtype = arrset(gtype,ig,'<=')
