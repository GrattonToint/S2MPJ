...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['N'])+1):
            pb.x0[ix_['P'+str(I)]] = float(965.0)
        pb.x0[ix_['Q1']] = float(100.0)
        pb.x0[ix_['Q2']] = float(100.0)
        pb.x0[ix_['Q3']] = float(-100.0)
        pb.x0[ix_['Q4']] = float(-100.0)
        pb.x0[ix_['F1']] = float(1000.0)
        pb.x0[ix_['F2']] = float(1000.0)
        pb.x0[ix_['F3']] = float(1000.0)
        pb.x0[ix_['F4']] = float(1000.0)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
