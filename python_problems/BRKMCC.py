...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        gtype = arrset(gtype,ig,'<>')
        pbm.gscale = arrset(pbm.gscale,ig,float(25.0))
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['G4'],float(-1.0))
        ...
        ig = ig_['G3']
        pbm.grftype = arrset(pbm.grftype,ig,'gINV')
