...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['G1'],float(0.032))
        pbm.gconst = arrset(pbm.gconst,ig_['G2'],float(0.056))
        pbm.gconst = arrset(pbm.gconst,ig_['G3'],float(0.099))
        ...
        pb.x0[ix_['X2']] = float(-1.2)
        pb.x0[ix_['X3']] = float(0.98)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
    ...
    def eXPEXP(pbm,nargout,*args):
        ...
        if nargout>1:
            ...
            g_ = np.zeros(dim)
            g_[0] = EX
            g_[1] = pbm.elpar[iel_][0]*EV_[0]*EV_[1]**(IT-1)
            if nargout>2:
                H_ = np.zeros((2,2))
                H_[0,1] = pbm.elpar[iel_][0]*EV_[1]**(IT-1)
                H_[1,0] = H_[0,1]
                H_[1,1] = pbm.elpar[iel_][0]*(pbm.elpar[iel_][0]-1.0)*EV_[0]*EV_[1]**(IT-2)
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
