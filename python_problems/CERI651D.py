...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('I' in ix_):
            ...
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['I']),15.1595)
        if('S' in ix_):
            pb.x0[ix_['S']] = 8.0
        else:
        ...
        if('X0' in ix_):
            ...
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['X0']),13072.9)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
