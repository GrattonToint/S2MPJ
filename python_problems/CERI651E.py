...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('I' in ix_):
            ...
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['I']),17.06794)
        if('S' in ix_):
            pb.x0[ix_['S']] = 8.0
        else:
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['S']),8.0)
        if('X0' in ix_):
            pb.x0[ix_['X0']] = 13642.3
        else:
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['X0']),13642.3)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
