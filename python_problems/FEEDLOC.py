...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            ...
            pbm.A[ig,iv] = float(v_['RI'])+pbm.A[ig,iv]
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            [ig,ig_,_] = s2x_ii('LASTX'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
            ...
            pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            [ig,ig_,_] = s2x_ii('ZNOT'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
            ...
            for K in range(int(I),int(v_['NMAX'])+1):
                ...
                pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            [ig,ig_,_] = s2x_ii('FEEDX'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
        ...
        for I in range(int(v_['2']),int(v_['NMAX'])+1):
            v_['I-1'] = -1+I
            [ig,ig_,_] = s2x_ii('WNES1u'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
            ...
            iv = ix_['S'+str(I)]
            pbm.A[ig,iv] = float(1.0)+pbm.A[ig,iv]
            [ig,ig_,_] = s2x_ii('WNES2u'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
        ...
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            ...
            pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
            for J in range(int(v_['1']),int(v_['M'])+1):
                [ig,ig_,_] = s2x_ii('XNOT'+str(I)+','+str(J),ig_)
                gtype = arrset(gtype,ig,'<=')
                ...
                iv = ix_['Z'+str(I)]
                pbm.A[ig,iv] = float(-1.0)+pbm.A[ig,iv]
                [ig,ig_,_] = s2x_ii('YNOT'+str(I)+','+str(J),ig_)
                gtype = arrset(gtype,ig,'<=')
        ...
        for I in range(int(v_['1']),int(v_['NMAX'])+1):
            v_['TEMP'] = -1.0*v_['AL1']
            [ig,ig_,_] = s2x_ii('PHEE'+str(I),ig_)
            gtype = arrset(gtype,ig,'==')
        ...
        for J in range(int(v_['1']),int(v_['M'])+1):
            v_['TEMP'] = -1.0*v_['F']
            [ig,ig_,_] = s2x_ii('CMB1u'+str(J),ig_)
            gtype = arrset(gtype,ig,'==')
        ...
        for I in range(int(v_['2']),int(v_['NMAX-1'])+1):
            ...
            [ig,ig_,_] = s2x_ii('CMB1'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
            ...
            [ig,ig_,_] = s2x_ii('CMB2'+str(I),ig_)
            gtype = arrset(gtype,ig,'>=')
        ...
        for I in range(int(v_['3']),int(v_['NMAX'])+1):
            [ig,ig_,_] = s2x_ii('RECR'+str(I),ig_)
            gtype = arrset(gtype,ig,'<=')
