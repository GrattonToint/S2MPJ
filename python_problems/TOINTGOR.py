...
# ********************
    ...
    def g_globs(pbm):
        ...
        pbm.gfpar = np.array([]);
        pbm.gfpar = arrset( pbm.gfpar,0,1.0e0)    # this is ONE
        pbm.gfpar = arrset( pbm.gfpar,1,0.0e0)    # this is ZERO
        return pbm
    ...
    def gBBT(pbm,nargout,*args):
        ...
        LAT = np.log(AT1)
        AA = AT/AT1
        TPOS = max(np.sign(GVAR_)*(pbm.gfpar[0]),pbm.gfpar[1])
        TNEG = pbm.gfpar[0]-TPOS
