...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['C1'],float(3.0))
        ...
        if('X2' in ix_):
            pb.x0[ix_['X2']] = float(0.7)
        else:
            pb.y0  = (
                  arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['X2']),float(0.7)))
        if('X3' in ix_):
            pb.x0[ix_['X3']] = float(0.2)
        else:
            pb.y0  = (
                  arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['X3']),float(0.2)))
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        [it,iet_,_] = s2x_ii( 'eI3SQ', iet_)
        ...
        pbm.elftype = arrset(pbm.elftype,ie,'eI3SQ')
