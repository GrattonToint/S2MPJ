...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pb.x0[ix_['B2']] = float(-0.1)
        pb.x0[ix_['B3']] = float(0.003)
        pb.x0[ix_['B4']] = float(-0.001)
        pb.x0[ix_['B5']] = float(0.00001)
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
        [it,iet_,_] = s2x_ii( 'eE18', iet_)
        ...
        for I in range(int(v_['1']),int(v_['M'])+1):
            ...
            pbm.elftype = arrset(pbm.elftype,ie,'eE18')
    ...
    @staticmethod
    def eE18(pbm,nargout,*args):

        import numpy as np
        EV_  = args[0]
        iel_ = args[1]
        X2 = pbm.elpar[iel_][0]*pbm.elpar[iel_][0]
        X3 = pbm.elpar[iel_][0]*X2
        X4 = pbm.elpar[iel_][0]*X3
        T = EV_[0]+EV_[1]*pbm.elpar[iel_][0]+EV_[2]*X2
        B = 1.0+EV_[3]*pbm.elpar[iel_][0]+EV_[4]*X2
        B2 = B*B
        B3 = B*B2
        f_   = T/B
        ...
        if nargout>1:
            ...
            g_[2] = X2/B
            g_[3] = -T*pbm.elpar[iel_][0]/B2
            g_[4] = -T*X2/B2
            if nargout>2:
                H_ = np.zeros((5,5))
                H_[0,3] = -pbm.elpar[iel_][0]/B2
                H_[3,0] = H_[0,3]
                H_[0,4] = -X2/B2
                H_[4,0] = H_[0,4]
                H_[1,3] = -X2/B2
