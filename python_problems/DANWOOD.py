...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('B2' in ix_):
            pb.x0[ix_['B2']] = float(5.0)
        else:
            pb.y0  = (
                  arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['B2']),float(5.0)))
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
...
# **********************
    ...
    def eE1(pbm,nargout,*args):
        ...
        if nargout>1:
            ...
            if nargout>2:
                H_ = np.zeros((2,2))
                H_[0,0] = EV_[1]*(EV_[1]-1.0)*pbm.elpar[iel_][0]**2*V1X**(EV_[1]-2.0)
                H_[0,1] = pbm.elpar[iel_][0]*V1XV21+V2X*LOGV1X*V1XV21
                H_[1,0] = H_[0,1]
