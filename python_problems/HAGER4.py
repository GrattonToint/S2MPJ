...
# **********************
    ...
    def eELT(self, nargout,*args):
        ...
        iel_ = args[1]
        f_    = (
              self.elpar[iel_][0]*EV_[0,0]*EV_[0,0]+self.elpar[iel_][1]*EV_[0,0]*(EV_[1,0]-EV_[0,0])+self.elpar[iel_][2]*(EV_[1,0]-EV_[0,0])**2)
        if nargout>1:
            try:
                dim = len(IV_)
            except:
            ...
            g_ = np.zeros(dim)
            g_[0]  = (
                  2.0*self.elpar[iel_][0]*EV_[0,0]+self.elpar[iel_][1]*(EV_[1,0]-2.0*EV_[0,0])-2.0*self.elpar[iel_][2]*(EV_[1,0]-EV_[0,0]))
            g_[1]  = (
                  self.elpar[iel_][1]*EV_[0,0]+2.0*self.elpar[iel_][2]*(EV_[1,0]-EV_[0,0]))
            if nargout>2:
                H_ = np.zeros((2,2))
