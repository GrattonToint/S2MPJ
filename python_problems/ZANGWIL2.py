...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        iv = ix_['X1']
        pbm.A[ig,iv] = float(-56.0)+pbm.A[ig,iv]
        iv = ix_['X2']
        pbm.A[ig,iv] = float(-256.0)+pbm.A[ig,iv]
        pbm.gscale = arrset(pbm.gscale,ig,float(15.0))
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = len(ix_)
        ngrp   = len(ig_)
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['G1'],float(-991))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        pbm.grelw = loaset(pbm.grelw,ig,posel,float(16.0))
        posel = posel+1
