...
# IE N                   99998          $-PARAMETER
        ...
        for I in range(int(v_['1']),int(v_['(N-2)/3'])+1):
            pbm.gconst = arrset(pbm.gconst,ig_['OBJ1'+str(I)],float(1.0))
        for K in range(int(v_['1']),int(v_['NC'])+1,int(v_['2'])):
            v_['K+1'] = 1+K
            pbm.gconst = arrset(pbm.gconst,ig_['C'+str(K)],float(5.0))
            pbm.gconst = arrset(pbm.gconst,ig_['C'+str(int(v_['K+1']))],float(3.0))
        ...
        for K in range(int(v_['1']),int(v_['NC'])+1,int(v_['2'])):
            ...
            pbm.grelt = loaset(pbm.grelt,ig,posel,ie_['E'+str(K)])
