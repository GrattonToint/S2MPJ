...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        if('I' in ix_):
            ...
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['I']),3527.31)
        if('S' in ix_):
            pb.x0[ix_['S']] = 29.4219
        else:
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['S']),29.4219)
        if('X0' in ix_):
            pb.x0[ix_['X0']] = 26185.9
        else:
            pb.y0 = arrset(pb.y0,findfirst(pbm.congrps,lambda x:x==ig_['X0']),26185.9)
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
