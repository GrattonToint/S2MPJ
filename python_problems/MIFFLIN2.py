...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['F1'],float(3.75))
        pbm.gconst = arrset(pbm.gconst,ig_['F2'],float(0.25))
        #%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        pbm.grelw = loaset(pbm.grelw,ig,posel,float(3.75))
        posel = posel+1
