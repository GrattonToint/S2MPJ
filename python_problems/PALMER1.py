...
# **********************
    ...
    def eQUOT(self, nargout,*args):
        ...
        EV_  = args[0]
        iel_ = args[1]
        DENOM = 1.0/(EV_[1,0]+self.elpar[iel_][0]/EV_[2,0])
        f_   = EV_[0,0]*DENOM
        if nargout>1:
            try:
                dim = len(IV_)
            ...
            g_[2] = EV_[0,0]*self.elpar[iel_][0]*(DENOM/EV_[2,0])**2
            if nargout>2:
                H_ = np.zeros((3,3))
                H_[0,1] = -DENOM*DENOM
                H_[1,0] = H_[0,1]
                H_[0,2] = self.elpar[iel_][0]*(DENOM/EV_[2,0])**2
                H_[2,0] = H_[0,2]
                H_[1,1] = 2.0*EV_[0,0]*DENOM**3
                H_[1,2] = -2.0*EV_[0,0]*self.elpar[iel_][0]*DENOM*(DENOM/EV_[2,0])**2
                H_[2,1] = H_[1,2]
                H_[2,2] = (2.0*EV_[0,0]*DENOM**3*(self.elpar[iel_][0]/EV_[2,0]**2)**2-
                     2.0*EV_[0,0]*DENOM**2*self.elpar[iel_][0]/EV_[2,0]**3)
        if nargout == 1:
            return f_
        elif nargout == 2:
            return f_,g_
