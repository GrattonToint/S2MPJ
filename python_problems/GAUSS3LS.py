...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pb.x0[ix_['B1']] = float(94.9)
        pb.x0[ix_['B2']] = float(0.009)
        pb.x0[ix_['B3']] = float(90.1)
        pb.x0[ix_['B4']] = float(113.0)
        pb.x0[ix_['B5']] = float(20.0)
        pb.x0[ix_['B6']] = float(73.8)
        pb.x0[ix_['B7']] = float(140.0)
        pb.x0[ix_['B8']] = float(20.0)
        pass
        #%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
        iet_  = {}
        elftv = []
