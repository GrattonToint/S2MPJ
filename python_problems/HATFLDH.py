...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    def __init__(self, *args): 
        ...
        pbm.gconst = arrset(pbm.gconst,ig_['C1'],float(2.5))
        pbm.gconst = arrset(pbm.gconst,ig_['C2'],float(2.5))
        pbm.gconst = arrset(pbm.gconst,ig_['C3'],float(2.5))
        pbm.gconst = arrset(pbm.gconst,ig_['C4'],float(2.0))
        pbm.gconst = arrset(pbm.gconst,ig_['C5'],float(2.0))
        pbm.gconst = arrset(pbm.gconst,ig_['C6'],float(1.5))
        pbm.gconst = arrset(pbm.gconst,ig_['C7'],float(5.0))
        #%%%%%%%%%%%%%%%%%%%%  RANGES %%%%%%%%%%%%%%%%%%%%%%
        ...
        vname = 'X1'
        [iv,ix_,pb] = s2mpj_nlx(vname,ix_,pb,1,None,5.0,None)
        ...
        pbm.grelt = loaset(pbm.grelt,ig,posel,ie_['A1'])
        nlc = np.union1d(nlc,np.array([ig]))
        pbm.grelw = loaset(pbm.grelw,ig,posel,float(-1.0))
        posel = posel+1
        pbm.grelt = loaset(pbm.grelt,ig,posel,ie_['A2'])
        pbm.grelw = loaset(pbm.grelw,ig,posel,float(-1.0))
        #%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
#    Solution
# LO SOLTN               -24.4999998
