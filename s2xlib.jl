...
function s2x_ii( name, dict::Dict{String,Int} )
    if haskey( dict, name )
        new = 0
        idx = dict[name]
    else
...
function s2x_nlx( name, dict::Dict{String,Int}, pb=nothing, getxnames=nothing,
                  xlowdef=nothing, xuppdef=nothing, x0def=nothing )

    iv, dict, newvar = s2x_ii( name, dict )
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#
#   Perform the main high-level action requested from a S2X problem file, using information computed
#   during the 'setup' call and passed to this function in the pbm struct.  The nonlinear functions
#   are evaluated at x = args[2]. See the documentation of S2X for details.
#
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function s2x_eval( action, args... )
