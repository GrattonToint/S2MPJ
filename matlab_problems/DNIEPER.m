...
switch(action)
    ...
    pbm.name     = 'DNIEPER';
        ...
        [iv,ix_] = s2xlib('ii','X0F',ix_);
        pb.xnames{iv} = 'X0F';
        [iv,ix_] = s2xlib('ii','X24F',ix_);
        pb.xnames{iv} = 'X24F';
        [iv,ix_] = s2xlib('ii','X12F',ix_);
        pb.xnames{iv} = 'X12F';
        [iv,ix_] = s2xlib('ii','X36F',ix_);
        pb.xnames{iv} = 'X36F';
        [iv,ix_] = s2xlib('ii','AC',ix_);
        pb.xnames{iv} = 'AC';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        for I=v_('1'):v_('12')
        ...
        for I=v_('1'):v_('4')
            v_('I0') = 24+I;
            [ig,ig_] = s2xlib('ii',['CC',int2str(I)],ig_);
            gtype{ig}  = '==';
        ...
        [it,iet_] = s2xlib( 'ii', 'eWJ',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'eWK',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
