...
switch(action)
    ...
    pbm.name     = 'HS70';
        ...
        [it,iet_] = s2xlib( 'ii', 'eY1',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        elftv{it}{3} = 'V3';
        elftp{it}{1} = 'C';
        [it,iet_] = s2xlib( 'ii', 'eY2',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        elftv{it}{3} = 'V3';
        elftp{it}{1} = 'C';
        ...
        for I=v_('1'):v_('19')
            ...
            [ie,ie_] = s2xlib('ii',ename,ie_);
            vname = 'X2';
            [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,0.00001,100.0,[]);
    ...
    case 'e_globs'
        ...
        pbm = varargin{1};
        pbm.efpar = [];
        pbm.efpar(1) = sqrt(1.0e0/6.2832e0);
        varargout{1} = pbm;
