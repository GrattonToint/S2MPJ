...
switch(action)
    ...
    pbm.name     = 'GOULDQP1';
        ...
        for K=v_('1'):v_('4')
            [iv,ix_] = s2xlib('ii',['AS',int2str(K)],ix_);
            pb.xnames{iv} = ['AS',int2str(K)];
        end
        for K=v_('1'):v_('4')
            [iv,ix_] = s2xlib('ii',['CS',int2str(K)],ix_);
            pb.xnames{iv} = ['CS',int2str(K)];
        end
        for K=v_('1'):v_('4')
            [iv,ix_] = s2xlib('ii',['BS',int2str(K)],ix_);
            pb.xnames{iv} = ['BS',int2str(K)];
        end
        for K=v_('1'):v_('5')
            [iv,ix_] = s2xlib('ii',['DS',int2str(K)],ix_);
        ...
        for K=v_('1'):v_('4')
            ...
            v_('3K-2') = -2+v_('3K');
            v_('3K-1') = -1+v_('3K');
            [ig,ig_] = s2xlib('ii',['A',int2str(K)],ig_);
            gtype{ig}  = '==';
            ...
            [ig,ig_] = s2xlib('ii',['B',int2str(K)],ig_);
            gtype{ig}  = '==';
