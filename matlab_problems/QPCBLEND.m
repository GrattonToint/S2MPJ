...
switch(action)
    ...
    pbm.name     = 'QPCBLEND';
        ...
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','1',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '1';
        [ig,ig_] = s2xlib('ii','2',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '2';
        [ig,ig_] = s2xlib('ii','3',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '3';
        [ig,ig_] = s2xlib('ii','4',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '4';
        [ig,ig_] = s2xlib('ii','5',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5';
        [ig,ig_] = s2xlib('ii','6',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '6';
        [ig,ig_] = s2xlib('ii','7',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '7';
        [ig,ig_] = s2xlib('ii','8',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '8';
        [ig,ig_] = s2xlib('ii','9',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '9';
        [ig,ig_] = s2xlib('ii','10',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '10';
        [ig,ig_] = s2xlib('ii','11',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '11';
        [ig,ig_] = s2xlib('ii','12',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '12';
        [ig,ig_] = s2xlib('ii','13',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '13';
        [ig,ig_] = s2xlib('ii','14',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '14';
        [ig,ig_] = s2xlib('ii','15',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '15';
        [ig,ig_] = s2xlib('ii','16',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '16';
        [ig,ig_] = s2xlib('ii','17',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '17';
        [ig,ig_] = s2xlib('ii','18',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '18';
        [ig,ig_] = s2xlib('ii','19',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '19';
        [ig,ig_] = s2xlib('ii','20',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '20';
        [ig,ig_] = s2xlib('ii','21',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '21';
        [ig,ig_] = s2xlib('ii','22',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '22';
        [ig,ig_] = s2xlib('ii','23',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '23';
        [ig,ig_] = s2xlib('ii','24',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '24';
        [ig,ig_] = s2xlib('ii','25',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '25';
        [ig,ig_] = s2xlib('ii','26',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '26';
        [ig,ig_] = s2xlib('ii','27',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '27';
        [ig,ig_] = s2xlib('ii','28',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '28';
        [ig,ig_] = s2xlib('ii','29',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '29';
        [ig,ig_] = s2xlib('ii','30',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '30';
        [ig,ig_] = s2xlib('ii','31',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '31';
        [ig,ig_] = s2xlib('ii','32',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '32';
        [ig,ig_] = s2xlib('ii','33',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '33';
        [ig,ig_] = s2xlib('ii','34',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '34';
        [ig,ig_] = s2xlib('ii','35',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '35';
        [ig,ig_] = s2xlib('ii','36',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '36';
        [ig,ig_] = s2xlib('ii','37',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '37';
        [ig,ig_] = s2xlib('ii','38',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '38';
        [ig,ig_] = s2xlib('ii','39',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '39';
        [ig,ig_] = s2xlib('ii','40',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '40';
        [ig,ig_] = s2xlib('ii','41',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '41';
        [ig,ig_] = s2xlib('ii','42',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '42';
        [ig,ig_] = s2xlib('ii','43',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '43';
        [ig,ig_] = s2xlib('ii','44',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '44';
        [ig,ig_] = s2xlib('ii','45',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '45';
        [ig,ig_] = s2xlib('ii','46',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '46';
        [ig,ig_] = s2xlib('ii','47',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '47';
        [ig,ig_] = s2xlib('ii','48',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '48';
        [ig,ig_] = s2xlib('ii','49',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '49';
        [ig,ig_] = s2xlib('ii','50',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '50';
        [ig,ig_] = s2xlib('ii','51',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '51';
        [ig,ig_] = s2xlib('ii','52',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '52';
        [ig,ig_] = s2xlib('ii','53',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '53';
        [ig,ig_] = s2xlib('ii','54',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '54';
        [ig,ig_] = s2xlib('ii','55',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '55';
        [ig,ig_] = s2xlib('ii','56',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '56';
        [ig,ig_] = s2xlib('ii','57',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '57';
        [ig,ig_] = s2xlib('ii','58',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '58';
        [ig,ig_] = s2xlib('ii','59',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '59';
        [ig,ig_] = s2xlib('ii','60',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '60';
        [ig,ig_] = s2xlib('ii','61',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '61';
        [ig,ig_] = s2xlib('ii','62',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '62';
        [ig,ig_] = s2xlib('ii','63',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '63';
        [ig,ig_] = s2xlib('ii','64',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '64';
        [ig,ig_] = s2xlib('ii','65',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '65';
        [ig,ig_] = s2xlib('ii','66',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '66';
        [ig,ig_] = s2xlib('ii','67',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '67';
        [ig,ig_] = s2xlib('ii','68',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '68';
        [ig,ig_] = s2xlib('ii','69',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '69';
        [ig,ig_] = s2xlib('ii','70',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '70';
        [ig,ig_] = s2xlib('ii','71',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '71';
        [ig,ig_] = s2xlib('ii','72',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '72';
        [ig,ig_] = s2xlib('ii','73',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '73';
        [ig,ig_] = s2xlib('ii','74',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = '74';
