...
switch(action)
    ...
    pbm.name     = 'CRESC50';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','V1',ix_);
        pb.xnames{iv} = 'V1';
        [iv,ix_] = s2xlib('ii','W1',ix_);
        pb.xnames{iv} = 'W1';
        ...
        gtype{ig} = '<>';
        for I=v_('1'):v_('NP')
            [ig,ig_] = s2xlib('ii',['IS2',int2str(I)],ig_);
            gtype{ig}  = '<=';
            cnames{ig} = ['IS2',int2str(I)];
            [ig,ig_] = s2xlib('ii',['OS1',int2str(I)],ig_);
            gtype{ig}  = '>=';
        ...
        elftv{it}{1} = 'D';
        elftv{it}{2} = 'R';
        [it,iet_] = s2xlib( 'ii', 'eSC',iet_);
        elftv{it}{1} = 'AZ';
        elftv{it}{2} = 'BZ';
        elftv{it}{3} = 'DZ';
        [it,iet_] = s2xlib( 'ii', 'eDIST',iet_);
        elftv{it}{1} = 'X';
        elftp{it}{1} = 'P';
        [it,iet_] = s2xlib( 'ii', 'eDISTX',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'T';
        elftv{it}{3} = 'A';
        elftv{it}{4} = 'D';
        elftp{it}{1} = 'P';
        [it,iet_] = s2xlib( 'ii', 'eDISTY',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'T';
        elftv{it}{3} = 'A';
        elftv{it}{4} = 'D';
