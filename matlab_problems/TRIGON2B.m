...
% IE N                   1000           $-PARAMETER
        ...
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','FA',ig_);
        gtype{ig} = '<>';
        for I=v_('1'):v_('N')
            [ig,ig_] = s2xlib('ii',['FB',int2str(I)],ig_);
            gtype{ig} = '<>';
            [ig,ig_] = s2xlib('ii',['FC',int2str(I)],ig_);
            gtype{ig} = '<>';
            [ig,ig_] = s2xlib('ii',['FD',int2str(I)],ig_);
            gtype{ig} = '<>';
            iv = ix_(['X',int2str(I)]);
        ...
        for I=v_('1'):v_('N')
            ...
            vname = ['X',int2str(I)];
            [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,-500.0,500.0,[]);
