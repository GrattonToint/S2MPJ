...
switch(action)
    ...
    pbm.name     = 'OPTPRLOC';
        ...
        for I=v_('1'):v_('N')
            [ig,ig_] = s2xlib('ii',['ELLI',int2str(I)],ig_);
            gtype{ig}  = '<=';
