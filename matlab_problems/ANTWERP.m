...
switch(action)
    ...
    pbm.name     = 'ANTWERP';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','P1F',ix_);
        pb.xnames{iv} = 'P1F';
        [iv,ix_] = s2xlib('ii','P2F',ix_);
        pb.xnames{iv} = 'P2F';
        [iv,ix_] = s2xlib('ii','P3F',ix_);
        pb.xnames{iv} = 'P3F';
        [iv,ix_] = s2xlib('ii','P4F',ix_);
        pb.xnames{iv} = 'P4F';
        [iv,ix_] = s2xlib('ii','P5F',ix_);
        pb.xnames{iv} = 'P5F';
        [iv,ix_] = s2xlib('ii','P1W',ix_);
        pb.xnames{iv} = 'P1W';
        [iv,ix_] = s2xlib('ii','P2W',ix_);
        pb.xnames{iv} = 'P2W';
        [iv,ix_] = s2xlib('ii','P3W',ix_);
        pb.xnames{iv} = 'P3W';
        [iv,ix_] = s2xlib('ii','P1M',ix_);
        pb.xnames{iv} = 'P1M';
        [iv,ix_] = s2xlib('ii','P2M',ix_);
        pb.xnames{iv} = 'P2M';
        [iv,ix_] = s2xlib('ii','P3M',ix_);
        pb.xnames{iv} = 'P3M';
        [iv,ix_] = s2xlib('ii','Q0F',ix_);
        pb.xnames{iv} = 'Q0F';
        [iv,ix_] = s2xlib('ii','Q1F',ix_);
        pb.xnames{iv} = 'Q1F';
        [iv,ix_] = s2xlib('ii','Q2F',ix_);
        pb.xnames{iv} = 'Q2F';
        [iv,ix_] = s2xlib('ii','Q0W',ix_);
        pb.xnames{iv} = 'Q0W';
        [iv,ix_] = s2xlib('ii','Q1W',ix_);
        pb.xnames{iv} = 'Q1W';
        [iv,ix_] = s2xlib('ii','Q2W',ix_);
        pb.xnames{iv} = 'Q2W';
        [iv,ix_] = s2xlib('ii','Q0M',ix_);
        pb.xnames{iv} = 'Q0M';
        [iv,ix_] = s2xlib('ii','Q1M',ix_);
        pb.xnames{iv} = 'Q1M';
        [iv,ix_] = s2xlib('ii','Q2M',ix_);
        pb.xnames{iv} = 'Q2M';
        [iv,ix_] = s2xlib('ii','NF',ix_);
        pb.xnames{iv} = 'NF';
        [iv,ix_] = s2xlib('ii','NW',ix_);
        pb.xnames{iv} = 'NW';
        [iv,ix_] = s2xlib('ii','NM',ix_);
        pb.xnames{iv} = 'NM';
        [iv,ix_] = s2xlib('ii','NC2',ix_);
        pb.xnames{iv} = 'NC2';
        [iv,ix_] = s2xlib('ii','NA2',ix_);
        pb.xnames{iv} = 'NA2';
        [iv,ix_] = s2xlib('ii','NC3',ix_);
        pb.xnames{iv} = 'NC3';
        [iv,ix_] = s2xlib('ii','NA3',ix_);
        pb.xnames{iv} = 'NA3';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','HSZ3',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M3');
        [ig,ig_] = s2xlib('ii','HSZ4',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M4');
        [ig,ig_] = s2xlib('ii','HSZ5',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M5');
        [ig,ig_] = s2xlib('ii','HSZ6',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M6');
        [ig,ig_] = s2xlib('ii','HSZ7',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M7');
        [ig,ig_] = s2xlib('ii','HSZ8',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M8');
        [ig,ig_] = s2xlib('ii','HST1F',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M1F');
        [ig,ig_] = s2xlib('ii','HST2F',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M2F');
        [ig,ig_] = s2xlib('ii','HST3F',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M3F');
        [ig,ig_] = s2xlib('ii','HST1W',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M1W');
        [ig,ig_] = s2xlib('ii','HST2W',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M2W');
        [ig,ig_] = s2xlib('ii','HST3W',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M3W');
        [ig,ig_] = s2xlib('ii','HST1M',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M1M');
        [ig,ig_] = s2xlib('ii','HST2M',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M2M');
        [ig,ig_] = s2xlib('ii','HST3M',ig_);
        gtype{ig} = '<>';
        pbm.gscale(ig,1) = v_('M3M');
        v_('WHCH') = 100.0*v_('N0123');
        [ig,ig_] = s2xlib('ii','HCH',ig_);
        gtype{ig} = '<>';
        ...
        [ig,ig_] = s2xlib('ii','HINF',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','HINN',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','PSF',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'PSF';
        iv = ix_('P1F');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
