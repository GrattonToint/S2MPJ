...
switch(action)
    ...
    pbm.name     = 'HIMMELBJ';
        ...
        [it,iet_] = s2xlib( 'ii', 'eXLOGX',iet_);
        elftv{it}{1} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGX2',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGX3',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        elftv{it}{4} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGX4',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        elftv{it}{4} = 'Y4';
        elftv{it}{5} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGX13',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        elftv{it}{4} = 'Y4';
        ...
        elftv{it}{13} = 'Y13';
        elftv{it}{14} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGX18',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        elftv{it}{4} = 'Y4';
        ...
        for K=v_('1'):v_('NSETS')
            ...
            for J=v_('1'):v_('NSK')
                ...
                [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,1.e-12,[],0.1);
