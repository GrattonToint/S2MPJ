...
switch(action)
    ...
    pbm.name     = 'HONG';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','T1',ix_);
        pb.xnames{iv} = 'T1';
        [iv,ix_] = s2xlib('ii','T2',ix_);
        pb.xnames{iv} = 'T2';
        [iv,ix_] = s2xlib('ii','T3',ix_);
        pb.xnames{iv} = 'T3';
        [iv,ix_] = s2xlib('ii','T4',ix_);
        pb.xnames{iv} = 'T4';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','OBJ',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','SUM1',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'SUM1';
        iv = ix_('T1');
        ...
        vname = 'T1';
        [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,0.0,1.0,0.5);
