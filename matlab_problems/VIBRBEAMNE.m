...
switch(action)
    ...
    pbm.name     = 'VIBRBEAMNE';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','c0',ix_);
        pb.xnames{iv} = 'c0';
        [iv,ix_] = s2xlib('ii','c1',ix_);
        pb.xnames{iv} = 'c1';
        [iv,ix_] = s2xlib('ii','c2',ix_);
        pb.xnames{iv} = 'c2';
        [iv,ix_] = s2xlib('ii','c3',ix_);
        pb.xnames{iv} = 'c3';
        [iv,ix_] = s2xlib('ii','d0',ix_);
        pb.xnames{iv} = 'd0';
        [iv,ix_] = s2xlib('ii','d1',ix_);
        pb.xnames{iv} = 'd1';
        [iv,ix_] = s2xlib('ii','d2',ix_);
        pb.xnames{iv} = 'd2';
        [iv,ix_] = s2xlib('ii','d3',ix_);
        pb.xnames{iv} = 'd3';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        for i=v_('1'):v_('m')
