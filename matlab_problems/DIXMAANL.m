...
% IE M                   3000           $-PARAMETER n = 9000
        ...
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','GA',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','GB',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','GC',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','GD',ig_);
        gtype{ig} = '<>';
        %%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = numEntries(ix_);
        ngrp   = numEntries(ig_);
        ...
        elftv{it}{1} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eSQB',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'eSQC',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
