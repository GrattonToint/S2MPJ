...
% IE N                   16384         $-PARAMETER
        ...
        for I=v_('0'):v_('N')
            for J=v_('0'):v_('N')
                [iv,ix_] = s2xlib('ii',['F',int2str(I),',',int2str(J)],ix_);
        ...
        for I=v_('1'):v_('N-1')
            for J=v_('1'):v_('N-1')
                [ig,ig_] = s2xlib('ii',['L',int2str(I),',',int2str(J)],ig_);
                gtype{ig}  = '==';
        ...
        elftp{it}{3} = 'V3';
        elftp{it}{4} = 'V4';
        [it,iet_] = s2xlib( 'ii', 'eM0',iet_);
        elftv{it}{1} = 'F1';
        elftv{it}{2} = 'F2';
        elftv{it}{3} = 'F3';
        elftv{it}{4} = 'F4';
        [it,iet_] = s2xlib( 'ii', 'eA',iet_);
        elftv{it}{1} = 'U1';
        elftv{it}{2} = 'U2';
        elftv{it}{3} = 'U3';
        elftv{it}{4} = 'U4';
        [it,iet_] = s2xlib( 'ii', 'eB',iet_);
        elftv{it}{1} = 'U1';
        elftv{it}{2} = 'U2';
        elftv{it}{3} = 'U3';
        elftv{it}{4} = 'U4';
        [it,iet_] = s2xlib( 'ii', 'eC',iet_);
        elftv{it}{1} = 'U1';
        elftv{it}{2} = 'U2';
        elftv{it}{3} = 'U3';
        elftv{it}{4} = 'U4';
        [it,iet_] = s2xlib( 'ii', 'eD',iet_);
        elftv{it}{1} = 'U1';
        elftv{it}{2} = 'U2';
        elftv{it}{3} = 'U3';
        elftv{it}{4} = 'U4';
        [it,iet_] = s2xlib( 'ii', 'eP',iet_);
        elftv{it}{1} = 'F1';
        elftv{it}{2} = 'F2';
        elftv{it}{3} = 'F3';
        elftv{it}{4} = 'F4';
        [it,iet_] = s2xlib( 'ii', 'eQ',iet_);
        elftv{it}{1} = 'F1';
        elftv{it}{2} = 'F2';
        elftv{it}{3} = 'F3';
        elftv{it}{4} = 'F4';
        [it,iet_] = s2xlib( 'ii', 'eR',iet_);
        elftv{it}{1} = 'F1';
        elftv{it}{2} = 'F2';
        elftv{it}{3} = 'F3';
        elftv{it}{4} = 'F4';
