...
switch(action)
    ...
    pbm.name     = 'HIMMELBI';
        ...
        pbm.A = sparse(0,0);
        for J=v_('1'):v_('NT')
            [ig,ig_] = s2xlib('ii',['P',int2str(J)],ig_);
            gtype{ig} = '<>';
        ...
        v_('J') = 1;
        for I=v_('1'):v_('5')
            [ig,ig_] = s2xlib('ii',['CB',int2str(round(v_('J')))],ig_);
            gtype{ig}  = '>=';
        ...
        [it,iet_] = s2xlib( 'ii', 'en5PEXP',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        elftv{it}{4} = 'Y4';
        ...
        for J=v_('1'):v_('NT')
            ...
            [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,[],v_('NW'),[]);
