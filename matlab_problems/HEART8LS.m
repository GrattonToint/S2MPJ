...
switch(action)
    ...
    pbm.name     = 'HEART8LS';
        ...
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','G4',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','G5',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','G6',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','G7',ig_);
        gtype{ig} = '<>';
        ...
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        [it,iet_] = s2xlib( 'ii', 'eVPV',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftp{it}{1} = 'ALPHA';
        [it,iet_] = s2xlib( 'ii', 'eADFSQ',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        [it,iet_] = s2xlib( 'ii', 'ePDFSQ',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        elftp{it}{1} = 'ALPHA';
        [it,iet_] = s2xlib( 'ii', 'eP3PRD',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        elftp{it}{1} = 'ALPHA';
        [it,iet_] = s2xlib( 'ii', 'en3DPRD',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        [it,iet_] = s2xlib( 'ii', 'eD3PRD',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        elftp{it}{1} = 'ALPHA';
