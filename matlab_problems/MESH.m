...
switch(action)
    ...
    pbm.name     = 'MESH';
        ...
        for i=v_('1'):v_('nk')
            [iv,ix_] = s2xlib('ii',['l',int2str(i)],ix_);
            pb.xnames{iv} = ['l',int2str(i)];
        end
        for i=v_('1'):v_('nd')
            [iv,ix_] = s2xlib('ii',['alpha',int2str(i)],ix_);
            pb.xnames{iv} = ['alpha',int2str(i)];
            [iv,ix_] = s2xlib('ii',['beta',int2str(i)],ix_);
            pb.xnames{iv} = ['beta',int2str(i)];
            [iv,ix_] = s2xlib('ii',['gamma',int2str(i)],ix_);
            pb.xnames{iv} = ['gamma',int2str(i)];
            [iv,ix_] = s2xlib('ii',['delta',int2str(i)],ix_);
            pb.xnames{iv} = ['delta',int2str(i)];
            [iv,ix_] = s2xlib('ii',['f',int2str(i)],ix_);
            pb.xnames{iv} = ['f',int2str(i)];
        end
        [iv,ix_] = s2xlib('ii','deltamin',ix_);
        pb.xnames{iv} = 'deltamin';
        [iv,ix_] = s2xlib('ii','fmin',ix_);
        pb.xnames{iv} = 'fmin';
        [iv,ix_] = s2xlib('ii','fmax',ix_);
        pb.xnames{iv} = 'fmax';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        ...
        for i=v_('1'):v_('nk')
            [ig,ig_] = s2xlib('ii',['seit',int2str(i)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['seit',int2str(i)];
        end
        for i=v_('1'):v_('nd')
            [ig,ig_] = s2xlib('ii',['skal',int2str(i)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['skal',int2str(i)];
            [ig,ig_] = s2xlib('ii',['skbe',int2str(i)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['skbe',int2str(i)];
        end
        for i=v_('1'):v_('nd')
            [ig,ig_] = s2xlib('ii',['doppf',int2str(i)],ig_);
            gtype{ig}  = '==';
        ...
        for i=v_('1'):v_('nd')
            [ig,ig_] = s2xlib('ii',['wisum',int2str(i)],ig_);
            gtype{ig}  = '==';
        ...
        for i=v_('1'):v_('nd')
            [ig,ig_] = s2xlib('ii',['alphd',int2str(i)],ig_);
            gtype{ig}  = '>=';
            ...
            [ig,ig_] = s2xlib('ii',['betad',int2str(i)],ig_);
            gtype{ig}  = '>=';
            ...
            [ig,ig_] = s2xlib('ii',['gammd',int2str(i)],ig_);
            gtype{ig}  = '>=';
            ...
            [ig,ig_] = s2xlib('ii',['deltd',int2str(i)],ig_);
            gtype{ig}  = '>=';
        ...
        for i=v_('1'):v_('nd')
            [ig,ig_] = s2xlib('ii',['fmind',int2str(i)],ig_);
            gtype{ig}  = '>=';
            ...
            [ig,ig_] = s2xlib('ii',['fmaxd',int2str(i)],ig_);
            gtype{ig}  = '>=';
        ...
        [it,iet_] = s2xlib( 'ii', 'ediffsq',iet_);
        elftv{it}{1} = 'winkel';
        elftv{it}{2} = 'minwi';
        [it,iet_] = s2xlib( 'ii', 'elaenge',iet_);
        elftv{it}{1} = 'lp1x';
        elftv{it}{2} = 'lp1y';
        elftv{it}{3} = 'lp2x';
        elftv{it}{4} = 'lp2y';
        elftv{it}{5} = 'llaenge';
        [it,iet_] = s2xlib( 'ii', 'evekprod',iet_);
        elftv{it}{1} = 'vp1x';
        elftv{it}{2} = 'vp1y';
        elftv{it}{3} = 'vp2x';
        elftv{it}{4} = 'vp2y';
        elftv{it}{5} = 'vp3x';
        elftv{it}{6} = 'vp3y';
        [it,iet_] = s2xlib( 'ii', 'esklprod',iet_);
        elftv{it}{1} = 'sp1x';
        elftv{it}{2} = 'sp1y';
        elftv{it}{3} = 'sp2x';
        elftv{it}{4} = 'sp2y';
        elftv{it}{5} = 'sp3x';
        elftv{it}{6} = 'sp3y';
        [it,iet_] = s2xlib( 'ii', 'ecosprod',iet_);
        elftv{it}{1} = 'cl1';
        elftv{it}{2} = 'cl2';
        elftv{it}{3} = 'cw';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
