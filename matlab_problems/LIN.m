...
switch(action)
    ...
    pbm.name     = 'LIN';
        ...
        for I=v_('1'):v_('C')
            for K=v_('1'):v_('P')
                [iv,ix_] = s2xlib('ii',['X',int2str(I),',',int2str(K)],ix_);
        ...
        for I=v_('1'):v_('C')
            for K=v_('1'):v_('P')
                [ig,ig_] = s2xlib('ii',['MB',int2str(I)],ig_);
                gtype{ig}  = '==';
        ...
        [it,iet_] = s2xlib( 'ii', 'eXTAUG1',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftp{it}{1} = 'G11';
        elftp{it}{2} = 'G12';
        ...
        elftp{it}{7} = 'M21';
        elftp{it}{8} = 'M22';
        [it,iet_] = s2xlib( 'ii', 'eXTAUG2',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftp{it}{1} = 'G11';
        elftp{it}{2} = 'G12';
        ...
        elftv{it}{1} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eXLOGXC',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y1';
        elftv{it}{3} = 'Y2';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ...
        for K=v_('1'):v_('P')
            ...
            [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,1.e-12,[],[]);
