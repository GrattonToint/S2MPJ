...
% IE N                   2000           $-PARAMETER n=20000, m=14000
        ...
        for I=v_('1'):v_('7')
            for T=v_('0'):v_('N')
                [iv,ix_] = s2xlib('ii',['Y',int2str(I),',',int2str(T)],ix_);
        ...
        for I=v_('1'):v_('3')
            ...
            for T=v_('1'):v_('N')
                v_('T-1') = -1+T;
                [ig,ig_] = s2xlib('ii',['S',int2str(I),',',int2str(T)],ig_);
                gtype{ig}  = '==';
        ...
        for I=v_('1'):v_('3')
            ...
            for T=v_('1'):v_('N')
                v_('T-1') = -1+T;
                [ig,ig_] = s2xlib('ii',['S',int2str(round(v_('I+3'))),',',int2str(T)],ig_);
                gtype{ig}  = '==';
        ...
        for T=v_('1'):v_('N')
            v_('T-1') = -1+T;
            [ig,ig_] = s2xlib('ii',['S',int2str(round(v_('7'))),',',int2str(T)],ig_);
            gtype{ig}  = '==';
