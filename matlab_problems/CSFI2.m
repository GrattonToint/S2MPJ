...
switch(action)
    ...
    pbm.name     = 'CSFI2';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','THICK',ix_);
        pb.xnames{iv} = 'THICK';
        [iv,ix_] = s2xlib('ii','WID',ix_);
        pb.xnames{iv} = 'WID';
        [iv,ix_] = s2xlib('ii','LEN',ix_);
        pb.xnames{iv} = 'LEN';
        [iv,ix_] = s2xlib('ii','TPH',ix_);
        pb.xnames{iv} = 'TPH';
        [iv,ix_] = s2xlib('ii','IPM',ix_);
        pb.xnames{iv} = 'IPM';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        ...
        [ig,ig_] = s2xlib('ii','WOT',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = 'WOT';
        [ig,ig_] = s2xlib('ii','TTW',ig_);
        gtype{ig}  = '>=';
        cnames{ig} = 'TTW';
        %%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = numEntries(ix_);
        ...
        [it,iet_] = s2xlib( 'ii', 'eCMPLQ',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        elftv{it}{3} = 'V3';
        [it,iet_] = s2xlib( 'ii', 'eSQQUT',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        [it,iet_] = s2xlib( 'ii', 'ePROD',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        [it,iet_] = s2xlib( 'ii', 'eQUOTN',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
