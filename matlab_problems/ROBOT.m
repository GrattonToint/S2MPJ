...
switch(action)
    ...
    pbm.name     = 'ROBOT';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','TH1',ix_);
        pb.xnames{iv} = 'TH1';
        [iv,ix_] = s2xlib('ii','TH2',ix_);
        pb.xnames{iv} = 'TH2';
        [iv,ix_] = s2xlib('ii','TH3',ix_);
        pb.xnames{iv} = 'TH3';
        [iv,ix_] = s2xlib('ii','TH4',ix_);
        pb.xnames{iv} = 'TH4';
        [iv,ix_] = s2xlib('ii','TH5',ix_);
        pb.xnames{iv} = 'TH5';
        [iv,ix_] = s2xlib('ii','TH6',ix_);
        pb.xnames{iv} = 'TH6';
        [iv,ix_] = s2xlib('ii','TH7',ix_);
        pb.xnames{iv} = 'TH7';
        [iv,ix_] = s2xlib('ii','TH1I',ix_);
        pb.xnames{iv} = 'TH1I';
        [iv,ix_] = s2xlib('ii','TH2I',ix_);
        pb.xnames{iv} = 'TH2I';
        [iv,ix_] = s2xlib('ii','TH3I',ix_);
        pb.xnames{iv} = 'TH3I';
        [iv,ix_] = s2xlib('ii','TH4I',ix_);
        pb.xnames{iv} = 'TH4I';
        [iv,ix_] = s2xlib('ii','TH5I',ix_);
        pb.xnames{iv} = 'TH5I';
        [iv,ix_] = s2xlib('ii','TH6I',ix_);
        pb.xnames{iv} = 'TH6I';
        [iv,ix_] = s2xlib('ii','TH7I',ix_);
        pb.xnames{iv} = 'TH7I';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        [ig,ig_] = s2xlib('ii','OBJ',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','CONSTR1',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'CONSTR1';
        [ig,ig_] = s2xlib('ii','CONSTR2',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'CONSTR2';
        %%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = numEntries(ix_);
        ...
        elftv{it}{1} = 'V';
        elftv{it}{2} = 'W';
        [it,iet_] = s2xlib( 'ii', 'eCOSTH',iet_);
        elftv{it}{1} = 'THETAC';
        [it,iet_] = s2xlib( 'ii', 'eSINTH',iet_);
        elftv{it}{1} = 'THETAS';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
