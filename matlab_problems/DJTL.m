...
switch(action)
    ...
    pbm.name     = 'DJTL';
        ...
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','CONU1',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','CONL1',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','CONU2',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','CONL2',ig_);
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii','BNDU1',ig_);
        gtype{ig} = '<>';
        iv = ix_('X1');
        ...
        [it,iet_] = s2xlib( 'ii', 'eCBm10',iet_);
        elftv{it}{1} = 'V1';
        [it,iet_] = s2xlib( 'ii', 'eCBm20',iet_);
        elftv{it}{1} = 'V1';
        [it,iet_] = s2xlib( 'ii', 'eSQm5',iet_);
        elftv{it}{1} = 'V1';
        [it,iet_] = s2xlib( 'ii', 'eSQm6',iet_);
        elftv{it}{1} = 'V1';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
