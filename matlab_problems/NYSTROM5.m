...
switch(action)
    ...
    pbm.name     = 'NYSTROM5';
        ...
        [ig,ig_] = s2xlib('ii','3B',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '3B';
        [ig,ig_] = s2xlib('ii','3C',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '3C';
        [ig,ig_] = s2xlib('ii','3D',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '3D';
        [ig,ig_] = s2xlib('ii','4A',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '4A';
        [ig,ig_] = s2xlib('ii','4B',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '4B';
        [ig,ig_] = s2xlib('ii','4C',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '4C';
        [ig,ig_] = s2xlib('ii','5A',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5A';
        iv = ix_('B1');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
        ...
        [ig,ig_] = s2xlib('ii','5B',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5B';
        [ig,ig_] = s2xlib('ii','5C',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5C';
        [ig,ig_] = s2xlib('ii','5D',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5D';
        [ig,ig_] = s2xlib('ii','5E',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '5E';
        [ig,ig_] = s2xlib('ii','6A',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '6A';
        [ig,ig_] = s2xlib('ii','6B',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '6B';
        [ig,ig_] = s2xlib('ii','6C',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '6C';
        [ig,ig_] = s2xlib('ii','7',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '7';
        [ig,ig_] = s2xlib('ii','8A',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '8A';
        [ig,ig_] = s2xlib('ii','8B',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '8B';
        [ig,ig_] = s2xlib('ii','8C',ig_);
        gtype{ig}  = '==';
        cnames{ig} = '8C';
        ...
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'en2PRI2',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y1';
        elftv{it}{3} = 'Y2';
        [it,iet_] = s2xlib( 'ii', 'en2PRI3',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y1';
        elftv{it}{3} = 'Y2';
        elftv{it}{4} = 'Y3';
        [it,iet_] = s2xlib( 'ii', 'en4PR',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        elftv{it}{4} = 'W';
        [it,iet_] = s2xlib( 'ii', 'eXY2',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'eXY2I2',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y1';
        elftv{it}{3} = 'Y2';
        [it,iet_] = s2xlib( 'ii', 'eXY2I3',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y1';
        elftv{it}{3} = 'Y2';
        elftv{it}{4} = 'Y3';
        [it,iet_] = s2xlib( 'ii', 'eXY3',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'eXY4',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        ...
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        [it,iet_] = s2xlib( 'ii', 'en3PRI2',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z1';
        elftv{it}{4} = 'Z2';
        [it,iet_] = s2xlib( 'ii', 'en3PRI3',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z1';
        elftv{it}{4} = 'Z2';
        elftv{it}{5} = 'Z3';
        [it,iet_] = s2xlib( 'ii', 'eXY2Z',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z';
        [it,iet_] = s2xlib( 'ii', 'eXY2ZI2',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z1';
        elftv{it}{4} = 'Z2';
        [it,iet_] = s2xlib( 'ii', 'eXY2ZI3',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        elftv{it}{3} = 'Z1';
        elftv{it}{4} = 'Z2';
