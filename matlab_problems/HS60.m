...
switch(action)
    ...
    pbm.name     = 'HS60';
        ...
        [it,iet_] = s2xlib( 'ii', 'eS2V',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'eP2V',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        [it,iet_] = s2xlib( 'ii', 'ePS1VP',iet_);
        elftv{it}{1} = 'X';
        elftp{it}{1} = 'A';
        [it,iet_] = s2xlib( 'ii', 'eXF',iet_);
        elftv{it}{1} = 'X';
        [it,iet_] = s2xlib( 'ii', 'ePXY',iet_);
        elftv{it}{1} = 'X';
        elftv{it}{2} = 'Y';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ...
        vname = 'X1';
        [iv,ix_,pb] = s2xlib('nlx',vname,ix_,pb,1,-10.0,10.0,2.0);
