...
switch(action)
    ...
    pbm.name     = 'MRIBASIS';
        ...
        for j=v_('1'):v_('2')
            for k=v_('1'):v_('xm')
                [iv,ix_] = s2xlib('ii',['X',int2str(j),',',int2str(k)],ix_);
        ...
        for i=v_('1'):v_('3')
            for j=v_('1'):v_('2')
                for k=v_('1'):v_('Lm')
                    [iv,ix_] = s2xlib('ii',['L',int2str(i),',',int2str(j),',',int2str(k)],ix_);
        ...
        for j=v_('1'):v_('2')
            for k=v_('2'):v_('xm-2')
                v_('k+') = 1+k;
                [ig,ig_] = s2xlib('ii',['PS',int2str(j),',',int2str(k)],ig_);
                gtype{ig}  = '>=';
        ...
        for i=v_('1'):v_('3')
            for j=v_('1'):v_('2')
                for k=v_('1'):v_('Lm-')
                    ...
                    v_('2k-') = -1+v_('2k');
                    [ig,ig_] =...
                          s2xlib('ii',['SU',int2str(i),',',int2str(j),',',int2str(k)],ig_);
                    gtype{ig}  = '<=';
                    ...
                    [ig,ig_] =...
                          s2xlib('ii',['SL',int2str(i),',',int2str(j),',',int2str(k)],ig_);
                    gtype{ig}  = '>=';
        ...
        for i=v_('1'):v_('3')
            [ig,ig_] = s2xlib('ii',['c2const',int2str(i)],ig_);
            gtype{ig}  = '==';
        ...
        [ig,ig_] = s2xlib('ii','c3con1',ig_);
        gtype{ig}  = '>=';
        cnames{ig} = 'c3con1';
        [ig,ig_] = s2xlib('ii','c3con2',ig_);
        gtype{ig}  = '<=';
        cnames{ig} = 'c3con2';
        [ig,ig_] = s2xlib('ii','c4const',ig_);
        gtype{ig}  = '>=';
        cnames{ig} = 'c4const';
        for i=v_('1'):v_('3')
            [ig,ig_] = s2xlib('ii',['c5con',int2str(i)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['c5con',int2str(i)];
        end
        for i=v_('1'):v_('2')
            [ig,ig_] = s2xlib('ii',['c6cn',int2str(i)],ig_);
            gtype{ig}  = '==';
        ...
        [it,iet_] = s2xlib( 'ii', 'euv1',iet_);
        elftv{it}{1} = 'v1';
        elftv{it}{2} = 'v2';
        elftv{it}{3} = 'v3';
        elftv{it}{4} = 'v4';
        [it,iet_] = s2xlib( 'ii', 'euv2',iet_);
        elftv{it}{1} = 'v1';
        elftv{it}{2} = 'v2';
        elftv{it}{3} = 'v3';
        [it,iet_] = s2xlib( 'ii', 'euvw1',iet_);
        elftv{it}{1} = 'v1';
        elftv{it}{2} = 'v2';
        elftv{it}{3} = 'v3';
        elftp{it}{1} = 'p1';
        [it,iet_] = s2xlib( 'ii', 'emo',iet_);
        elftv{it}{1} = 's1';
        elftv{it}{2} = 's2';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
