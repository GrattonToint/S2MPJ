...
switch(action)
    ...
    pbm.name     = 'HS56';
        ...
        gtype{ig} = '<>';
        [ig,ig_] = s2xlib('ii',['CON',int2str(round(v_('1')))],ig_);
        gtype{ig}  = '==';
        ...
        [ig,ig_] = s2xlib('ii',['CON',int2str(round(v_('2')))],ig_);
        gtype{ig}  = '==';
        ...
        [ig,ig_] = s2xlib('ii',['CON',int2str(round(v_('3')))],ig_);
        gtype{ig}  = '==';
        ...
        [ig,ig_] = s2xlib('ii',['CON',int2str(round(v_('4')))],ig_);
        gtype{ig}  = '==';
