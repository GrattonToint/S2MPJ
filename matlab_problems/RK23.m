...
switch(action)
    ...
    pbm.name     = 'RK23';
        ...
        %%%%%%%%%%%%%%%%%%%%  VARIABLES %%%%%%%%%%%%%%%%%%%%
        pb.xnames = {};
        [iv,ix_] = s2xlib('ii','C2',ix_);
        pb.xnames{iv} = 'C2';
        [iv,ix_] = s2xlib('ii','A21',ix_);
        pb.xnames{iv} = 'A21';
        [iv,ix_] = s2xlib('ii','C3',ix_);
        pb.xnames{iv} = 'C3';
        [iv,ix_] = s2xlib('ii','A31',ix_);
        pb.xnames{iv} = 'A31';
        [iv,ix_] = s2xlib('ii','A32',ix_);
        pb.xnames{iv} = 'A32';
        [iv,ix_] = s2xlib('ii','B1',ix_);
        pb.xnames{iv} = 'B1';
        [iv,ix_] = s2xlib('ii','B2',ix_);
        pb.xnames{iv} = 'B2';
        [iv,ix_] = s2xlib('ii','B3',ix_);
        pb.xnames{iv} = 'B3';
        [iv,ix_] = s2xlib('ii','BB1',ix_);
        pb.xnames{iv} = 'BB1';
        [iv,ix_] = s2xlib('ii','BB2',ix_);
        pb.xnames{iv} = 'BB2';
        [iv,ix_] = s2xlib('ii','BB3',ix_);
        pb.xnames{iv} = 'BB3';
        [iv,ix_] = s2xlib('ii','TP1',ix_);
        pb.xnames{iv} = 'TP1';
        [iv,ix_] = s2xlib('ii','TM1',ix_);
        pb.xnames{iv} = 'TM1';
        [iv,ix_] = s2xlib('ii','TP2',ix_);
        pb.xnames{iv} = 'TP2';
        [iv,ix_] = s2xlib('ii','TM2',ix_);
        pb.xnames{iv} = 'TM2';
        [iv,ix_] = s2xlib('ii','TP3',ix_);
        pb.xnames{iv} = 'TP3';
        [iv,ix_] = s2xlib('ii','TM3',ix_);
        pb.xnames{iv} = 'TM3';
        %%%%%%%%%%%%%%%%%%%  DATA GROUPS %%%%%%%%%%%%%%%%%%%
        pbm.A = sparse(0,0);
        ...
        [ig,ig_] = s2xlib('ii','SECND2',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'SECND2';
        [ig,ig_] = s2xlib('ii','SECND3',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'SECND3';
        [ig,ig_] = s2xlib('ii','THIRD31',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'THIRD31';
        [ig,ig_] = s2xlib('ii','THIRD32',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'THIRD32';
        [ig,ig_] = s2xlib('ii','ART1',ig_);
        gtype{ig}  = '==';
        cnames{ig} = 'ART1';
        iv = ix_('TP1');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
        ...
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        [it,iet_] = s2xlib( 'ii', 'ePRODS',iet_);
        elftv{it}{1} = 'W1';
        elftv{it}{2} = 'W2';
        [it,iet_] = s2xlib( 'ii', 'ePRODQ',iet_);
        elftv{it}{1} = 'X1';
        elftv{it}{2} = 'X2';
        [it,iet_] = s2xlib( 'ii', 'eTPROD',iet_);
        elftv{it}{1} = 'Y1';
        elftv{it}{2} = 'Y2';
        elftv{it}{3} = 'Y3';
        [it,iet_] = s2xlib( 'ii', 'eQPROD',iet_);
        elftv{it}{1} = 'Z1';
        elftv{it}{2} = 'Z2';
        elftv{it}{3} = 'Z3';
        elftv{it}{4} = 'Z4';
        [it,iet_] = s2xlib( 'ii', 'eTPRODS',iet_);
        elftv{it}{1} = 'U1';
        elftv{it}{2} = 'U2';
        elftv{it}{3} = 'U3';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
