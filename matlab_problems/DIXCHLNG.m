...
switch(action)
    ...
    pbm.name     = 'DIXCHLNG';
        ...
        for I=v_('2'):v_('2'):v_('10')
            [ig,ig_] = s2xlib('ii',['P',int2str(I)],ig_);
            gtype{ig}  = '==';
        ...
        elftv{it}{1} = 'V';
        [it,iet_] = s2xlib( 'ii', 'eS2PR',iet_);
        elftv{it}{1} = 'V';
        elftv{it}{2} = 'W';
        [it,iet_] = s2xlib( 'ii', 'ePR2',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        [it,iet_] = s2xlib( 'ii', 'ePR4',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        elftv{it}{3} = 'V3';
        elftv{it}{4} = 'V4';
        [it,iet_] = s2xlib( 'ii', 'ePR6',iet_);
        elftv{it}{1} = 'V1';
        elftv{it}{2} = 'V2';
        elftv{it}{3} = 'V3';
        elftv{it}{4} = 'V4';
