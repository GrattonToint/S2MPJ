...
switch(action)
    ...
    pbm.name     = 'HS99EXP';
        ...
        [iv,ix_] = s2xlib('ii',['R',int2str(round(v_('8')))],ix_);
        pb.xnames{iv} = ['R',int2str(round(v_('8')))];
        [iv,ix_] = s2xlib('ii',['Q',int2str(round(v_('8')))],ix_);
        pb.xnames{iv} = ['Q',int2str(round(v_('8')))];
        [iv,ix_] = s2xlib('ii',['S',int2str(round(v_('8')))],ix_);
        ...
        [it,iet_] = s2xlib( 'ii', 'eSN',iet_);
        elftv{it}{1} = 'X';
        [it,iet_] = s2xlib( 'ii', 'eCS',iet_);
        elftv{it}{1} = 'X';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
