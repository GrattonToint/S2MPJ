...
case 'select'
   ...
   classif = varargin{1};
      ...
      disp( ' The second character in the after the first hyphen defines the type of constraints of the' )
      ...
      disp( ' The third character after the irst hyphen indicates the smoothness of the problem.' )
      ...
      disp( '  ' )
      disp( ' The problem selection tool may then by used in Matlab by calling s2mpjlib' )
      disp( ' with action = ''select''. The second argument in such a call is a string' )
      disp( ' specifying the class of problems of interest.  This string is constructed' )
      disp( ' by replacing by a dot each character in the classification string for which' )
      disp( ' all possible values are acceptable (the dot is a wildcard character).' )
      disp( ' For instance' )
      disp( '    s2mpjlib(''select'', ''C-SU..-..-2-0'' ) ')
      disp( ' lists all CUTEst unconstrained sum-of-squares problems in two variables, while' )
      disp( '    s2mpjlib(''select'', ''C-....-..-V-V'' ) ' )
      disp( ' lists all CUTEstproblems with variable number of variables and variable' )
      ...
      disp( '       selection can also be achieved by s2mpjlib(''select'', ''C-.*V_V'' ) ')
      ...
      disp( '    s2mpjlib( ''select'', ''C-....-..-V-V'', filename )' )
