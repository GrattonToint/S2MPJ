...
%
%   Programming: Ph Toint, this version 4 IX 2024
%
%   Example: compare_data( 'python', 'matlab', 'julia' )
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
v0file  = [ 'test_', v0, '.data' ];
vs{1}   = v0;
fidv0   = fopen( v0file, 'r' );
line    = fgetl( fidv0 );
fields  = split( line );
