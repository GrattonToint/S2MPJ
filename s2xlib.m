...
function varargout = s2xlib( action, varargin )
...
%  [ iv, ix_, pb ] <== ( vname, ix_, pb, getxnames, xlowdef, xuppdef, x0def )
   ...
   [ iv, ix_, newvar] = s2xlib( 'ii', varargin{1} ,varargin{2} );
   pb   = varargin{3};
   if( newvar )
      pb.n = pb.n + 1;
      if ( varargin{4} )
...
%   are evaluated at x = varargin{2}. See the documentation of S2X for details.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
